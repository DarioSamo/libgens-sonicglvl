...
//
    ...
    lrp_pp r0.x, v4.z, c2.z, r1.x
    lrp_pp r0.y, v4.z, c2.z, r2.x
    rcp r0.z, v2.w
    ...
    mad_pp r2.xzw, r5.x, r3.xyyw, r2
    mov r6.xyz, c81
    add r3.xyw, -r6.xyzz, c82.xyzz
    mad r3.xyz, r3.z, r3.xyww, c81
    mad_pp r2.xzw, r5.z, r3.xyyz, r2
...
// approximately 140 instruction slots used (3 texture, 137 arithmetic)
