...
//
    ...
    mul_sat_pp r0.yzw, r0, c2.z
    mul_pp r6.xyz, r0.w, c36
    mul_pp r8.xyz, r0.z, c43
    mul_pp r8.xyz, r4.w, r8
    mad_pp r5.xyz, r2.w, r5, r8
    mad_pp r2.xzw, r2.z, r4.xyyz, r5.xyyz
    mad_pp r2.xyz, r2.y, r3.yzww, r2.xzww
