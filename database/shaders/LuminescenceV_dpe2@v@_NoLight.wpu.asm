...
//
    ...
    max r6.x, v4.z, c3.x
    add r6.y, r6.x, -v4.w
    cmp r6.z, r6.y, c3.x, r6.x
    mov r6.xyw, v4
    texldp_pp r6, r6, s13
    lrp_pp r7.x, v5.z, c3.y, r6.x
    lrp_pp r6.x, r5.w, c3.y, r7.x
    texld_pp r7, v0.zwzw, s10
    mul r5.w, r6.x, r7.w
    mad_pp r6.yzw, r4, r3.w, -c10.xxyz
    mul r4.yzw, r3.w, r4
    nrm_pp r8.xyz, r6.yzww
    dp3_sat_pp r3.w, r8, r5
    pow r6.y, r3.w, r4.x
    mul_pp r2.yzw, r2, r6.y
    mad_pp r2.yzw, r2, r5.w, r3.xxyz
    dp3 r3.x, -r4.yzww, r5
    add r3.x, r3.x, r3.x
    mad_pp r3.xyz, r5, -r3.x, -r4.yzww
    texld_pp r3, r3, s5
    mul r4.xyz, r3, c63.x
