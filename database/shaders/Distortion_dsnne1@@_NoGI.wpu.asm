...
//
    ...
    frc r2.zw, c27.xyxy
    cmp r6.xy, -r2.zwzw, c3.x, c3.y
    add r2.zw, -r2, c27.xyxy
    cmp r6.xy, c27, r2.x, r6
    add r2.zw, r2, r6.xyxy
    add r6, r2.z, -c3
    add r7, r2.w, -c3
    ...
    mad_pp r2.zw, r6.xyxy, c0.x, c0.y
    dp2add_pp r4.w, r2.zwzw, -r2.zwzw, c3.y
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    nrm_pp r6.xyz, v8
    mul_pp r8.xyz, r2.w, r6
    nrm_pp r9.xyz, v7
    ...
    texld_pp r7, r2.zwzw, s4
    mul_pp r7.x, r7.w, r7.x
    mad_pp r2.zw, r7.xyxy, c0.x, c0.y
    mul_pp r6.xyz, r6, r2.w
    mad_pp r6.xyz, r2.z, r9, r6
    ...
    dp3_pp r2.z, r6, r6
    rsq_pp r2.z, r2.z
    mad_pp r8.xyz, r6, r2.z, -r5
    dp3_pp r2.w, r7, -r5
    nrm_pp r5.xyz, r8
    dp3_sat_pp r4.w, r5, r7
    mov_pp r5.xy, c1
    mul_pp r5.xy, r5, c20.yzzw
    max_pp r6.w, r5.x, c3.y
    min r5.x, r6.w, c1.z
    pow r6.w, r4.w, r5.x
    mul_pp r8.xyz, r5.y, c43
    mul_pp r8.xyz, r6.w, r8
    mul_pp r8.xyz, r1.w, r8
    mad_pp r9.xyz, r6, r2.z, -r4
    dp3_pp r4.x, r7, -r4
    nrm_pp r10.xyz, r9
    dp3_sat_pp r4.y, r10, r7
    pow r6.w, r4.y, r5.x
    mul_pp r4.yzw, r5.y, c39.xxyz
    mul_pp r4.yzw, r6.w, r4
    mad_pp r4.yzw, r1.z, r4, r8.xxyz
    mad_pp r8.xyz, r6, r2.z, -r3.xzww
    dp3_pp r3.x, r7, -r3.xzww
    nrm_pp r9.xyz, r8
    dp3_sat_pp r3.z, r9, r7
    pow r6.w, r3.z, r5.x
    mul_pp r8.xyz, r5.y, c47
    mul_pp r8.xyz, r6.w, r8
    mad_pp r4.yzw, r1.y, r8.xxyz, r4
    ...
    mad_pp r9.xyz, r6, r2.z, -r8
    dp3_pp r3.w, r7, -r8
    nrm_pp r8.xyz, r9
    dp3_sat_pp r5.z, r8, r7
    pow r6.w, r5.z, r5.x
    mul_pp r8.xyz, r5.y, c51
    mul_pp r8.xyz, r6.w, r8
    mad_pp r4.yzw, r3.z, r8.xxyz, r4
    mad_pp r8.xyz, r6, r2.z, -c10
    mad_pp r6.xyz, r6, r2.z, -r0.yzww
    ...
    mul_pp r5.xzw, r6.x, r5
    mad_pp r4.yzw, r5.xxzw, r1.x, r4
    ...
    mad_pp r5.zw, r5, c2.xyxy, c2.x
    texld_pp r6, r5.zwzw, s5
    mul r8.xyz, r6, c63.x
    mad_pp r6.xyz, r8, r6.w, r6
    frc r5.zw, c26.xyxz
    cmp r8.xy, -r5.zwzw, c3.x, c3.y
    add r5.zw, -r5, c26.xyxz
    cmp r2.xz, c26, r2.x, r8.xyyw
    add r2.xz, r2, r5.zyww
    add r8, r2.z, -c3
    add r9, r2.x, -c3
    cmp r2.xz, -r8_abs.x, v0.xyyw, c3.x
    ...
    cmp_pp r2.xzw, r2.w, r6.xyyz, c3.x
    mul_pp r2.xzw, r1.w, r2
    mul_pp r6.xyz, r4.x, c39
    cmp_pp r6.xyz, r4.x, r6, c3.x
    mad_pp r2.xzw, r1.z, r6.xyyz, r2
    mul_pp r6.xyz, r3.x, c47
    cmp_pp r6.xyz, r3.x, r6, c3.x
    mad_pp r1.yzw, r1.y, r6.xxyz, r2.xxzw
    mul_pp r2.xzw, r3.w, c51.xyyz
    cmp_pp r2.xzw, r3.w, r2, c3.x
    mad_pp r1.yzw, r3.z, r2.xxzw, r1
    dp3_pp r0.z, r7, -c10
    ...
    cmp_pp r0.yzw, r0.y, r2.xxzw, c3.x
...
// approximately 309 instruction slots used (8 texture, 301 arithmetic)
