...
//
    ...
    lrp_pp r1.x, v5.z, c4.x, r2.x
    lrp_pp r1.y, v5.z, c4.x, r3.x
    rcp r1.z, v3.w
    mul r1.zw, r1.z, v3.xyxy
    mad r1.zw, r1, c4.y, c4.z
    abs_sat r1.zw, r1
    add_sat r1.zw, r1, -c65.x
    mul r1.zw, r1, c65.y
    max r2.x, r1.z, r1.w
    lrp_pp r3.x, r2.x, c4.x, r1.y
    lrp_pp r3.y, r2.x, c4.x, r1.x
    ...
    max_pp r5.w, r7.x, c4.x
    min r6.w, r5.w, c1.z
    add_pp r9, c22.xyzx, -v1.xyzx
    dp3_pp r5.w, r9.yzww, r9.yzww
    rsq_pp r5.w, r5.w
    mad_pp r7.xzw, r9.xyyz, r5.w, -r6.xyyz
    nrm_pp r10.xyz, r7.xzww
    nrm r11, v2.xyzx
    dp3_sat_pp r7.x, r10, r11
    pow r8.w, r7.x, r6.w
    mul_pp r7.xzw, r8.w, r8.xyyz
    mul_pp r7.xzw, r3.w, r7
    mul_pp r8.xyz, r7.y, c39
    mad_pp r10.xyz, r9, r5.w, -r5
    dp3_pp r5.x, r11.wyzw, -r5
    nrm_pp r12.xyz, r10
    dp3_sat_pp r5.y, r12, r11
    pow r8.w, r5.y, r6.w
    mul_pp r8.xyz, r8.w, r8
    mad_pp r7.xzw, r3.z, r8.xyyz, r7
    ...
    mad_pp r10.xyz, r9, r5.w, -r2.yzww
    dp3_pp r2.y, r11.wyzw, -r2.yzww
    nrm_pp r12.xyz, r10
    dp3_sat_pp r2.z, r12, r11
    pow r4.y, r2.z, r6.w
    mul_pp r8.xyz, r4.y, r8
    mad_pp r7.xzw, r2.x, r8.xyyz, r7
    mul_pp r8.xyz, r7.y, c37
    mad_pp r10.xyz, r9, r5.w, -c10
    nrm_pp r12.xyz, r10
    dp3_sat_pp r2.z, r12, r11
    pow r4.y, r2.z, r6.w
    mul_pp r8.xyz, r4.y, r8
    mad_pp r7.xzw, r8.xyyz, r1.w, r7
    mul_pp r8.xyz, c59.w, c59
    mul_pp r8.xyz, r7.y, r8
    mad_pp r10.xyz, r9, r5.w, -r0.yzww
    dp3_pp r0.y, r11.wyzw, -r0.yzww
    mul r9, r5.w, r9
    nrm_pp r12.xyz, r10
    dp3_sat_pp r0.z, r12, r11
    pow r2.z, r0.z, r6.w
    mul_pp r5.yzw, r2.z, r8.xxyz
    mad_pp r5.yzw, r0.x, r5, r7.xxzw
    dp3 r0.z, r9.yzww, r11.yzww
    add r0.z, r0.z, r0.z
    mad r7, r0.z, r11, -r9
    mad r8, r7.wyzw, c2.xxyz, c2.zzzw
    mul r9, r7, c2.yxxz
    cmp r7, r7.z, r8, r9
    add r0.z, r7.z, c4.x
    rcp r0.z, r0.z
    mad r0.zw, r7.xyyx, r0.z, c4.x
    mad_pp r7.x, r0.w, c3.x, r7.w
    mul_pp r7.y, r0.z, c1.w
    texld_pp r7, r7, s5
    mul r8.xyz, r7, c63.x
