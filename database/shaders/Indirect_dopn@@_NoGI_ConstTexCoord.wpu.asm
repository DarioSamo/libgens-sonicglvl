...
//
    ...
    nrm_pp r4.xyz, v7
    texld_pp r5, v0, s3
    mad r5.xy, r5.wxzw, c1.x, c1.y
    mul_pp r5.xy, r5, c150
    mad r5.xy, r5, c1.z, v0
    texld_pp r6, r5, s2
    mul_pp r6.x, r6.w, r6.x
    mad_pp r5.zw, r6.xyxy, c1.x, c1.y
    mul_pp r4.xyz, r4, r5.w
    nrm_pp r6.xyz, v6
    mad_pp r4.xyz, r5.z, r6, r4
    dp2add_pp r4.w, r5.zwzw, -r5.zwzw, c1.w
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    nrm_pp r6.xyz, v2
    ...
    rsq r5.z, r5.z
    rcp r5.w, r5.z
    mul_pp r7.xyz, r5.z, r7
    add r5.z, r5.w, -c52.z
    mul_sat r4.w, r4.w, r5.z
    add_pp r4.w, -r4.w, c1.w
    dp3_pp r5.z, r4, -r7
    mul_pp r8.xyz, r5.z, c51
    cmp_pp r8.xyz, r5.z, r8, c0.y
    mad_pp r6.xyz, r4.w, r8, r6
    max r5.z, v3.z, c0.y
    add r5.w, r5.z, -v3.w
    cmp r8.z, r5.w, c0.y, r5.z
    mov r8.xyw, v3
    texldp_pp r8, r8, s13
    max r5.z, v4.z, c0.y
    add r5.w, r5.z, -v4.w
    cmp r9.z, r5.w, c0.y, r5.z
    mov r9.xyw, v4
    texldp_pp r9, r9, s7
    min_pp r5.z, r9.x, r8.x
    lrp_pp r5.w, v5.z, c1.w, r9.x
    lrp_pp r6.w, v5.z, c1.w, r5.z
    rcp r5.z, v3.w
    mul r8.xy, r5.z, v3
    ...
    mul r8.xy, r8, c65.y
    max r5.z, r8.x, r8.y
    lrp_pp r7.w, r5.z, c1.w, r6.w
    lrp_pp r6.w, r5.z, c1.w, r5.w
    mul_pp r5.z, r7.w, c77.w
    dp3_pp r5.w, r4, -c10
    mul r8.xyz, r5.w, c36
    ...
    texld_pp r8, r5, s0
    texld_pp r9, r5, s1
    mul_pp r5.xy, r9.x, c20.yzzw
    mul_pp r5.xy, r5, c2
    mul_pp r6.xyz, r6, r8
    mul_pp r5.w, r8.w, c16.w
    mul_pp r5.w, r5.w, v8.w
    mul_pp r8.w, r5.w, c21.x
    mul_pp r9.xyz, r5.y, c43
    add_pp r10.xyz, c22, -v1
    dp3_pp r5.w, r10, r10
    rsq_pp r5.w, r5.w
    mad_pp r3.yzw, r10.xxyz, r5.w, -r3
    nrm_pp r11.xyz, r3.yzww
    dp3_sat_pp r3.y, r11, r4
    max_pp r3.z, r5.x, c1.w
    min r5.x, r3.z, c2.z
    pow r6.w, r3.y, r5.x
    mul_pp r3.yzw, r6.w, r9.xxyz
    mul_pp r3.xyz, r3.yzww, r3.x
    mul_pp r9.xyz, r5.y, c39
    ...
    mad_pp r2.xyz, r10, r5.w, -r7
    nrm_pp r3.xyz, r2
    dp3_sat_pp r1.w, r3, r4
    pow r2.x, r1.w, r5.x
    mul_pp r2.yzw, r5.y, c51.xxyz
    mul_pp r2.xyz, r2.x, r2.yzww
    mad_pp r1.xyz, r4.w, r2, r1
    mad_pp r2.xyz, r10, r5.w, -c10
...
// approximately 246 instruction slots used (6 texture, 240 arithmetic)
