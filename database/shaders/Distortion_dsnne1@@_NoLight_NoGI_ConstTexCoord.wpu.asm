...
//
    ...
    nrm_pp r7.xyz, v6
    mad_pp r2.xzw, r0.z, r7.xyyz, r2
    nrm_pp r8.xyz, v2
    mad_pp r2.xzw, r1.w, r8.xyyz, r2
    texld_pp r9, v0, s4
    mul_pp r9.x, r9.w, r9.x
    mad_pp r0.zw, r9.xyxy, c0.x, c0.y
    mul_pp r3.xzw, r6.xyyz, r0.w
    mad_pp r3.xzw, r0.z, r7.xyyz, r3
    dp2add_pp r0.z, r0.zwzw, -r0.zwzw, c0.z
    rsq_pp r0.z, r0.z
    rcp_pp r0.z, r0.z
    mad_pp r3.xzw, r0.z, r8.xyyz, r3
    add_pp r2.xzw, r2, r3
    nrm_pp r6.xyz, r2.xzww
    ...
    dp3_sat_pp r0.z, r4, r6
    pow r3.x, r0.z, r1.w
    mul_pp r3.xzw, r3.x, r5.xyyz
    mad_pp r2.xzw, r3, r0.x, r2
    ...
    mad_pp r1.xyw, r3.x, r1, r5.xyzz
    mov r5.xyz, c81
    add r5.xyz, -r5, c82
    mad r5.xyz, r1.z, r5, c81
    mad_pp r1.xyz, r3.w, r5, r1.xyww
    mul_pp r3.xzw, r1.xyyz, c17.xyyz
    mul r3.xzw, r3, c70.w
    mad r1.xyz, r1, c17, -r3.xzww
    mad_pp r1.xyz, r2.y, r1, r3.xzww
    add_pp r0.xyz, r0, r1
