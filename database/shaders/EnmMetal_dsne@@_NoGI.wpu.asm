...
//
    ...
    mad_pp r4.xyz, r8, r2.x, -r0.yzww
    dp3_pp r0.y, r7, -r0.yzww
    add_pp r0.y, r0.y, c1.w
    mul_pp r5.xyz, r2.x, r8
    nrm_pp r8.xyz, r4
    ...
    mad_pp r2.xyz, r3.xzww, r1.x, r2.yzww
    ...
    mad_pp r2.xyw, r2.x, r10.xyzz, r8.xyzz
    mov r8.xyz, c81
    add r8.xyz, -r8, c82
    mad r3.xzw, r3.w, r8.xyyz, c81.xyyz
...
// approximately 300 instruction slots used (6 texture, 294 arithmetic)
