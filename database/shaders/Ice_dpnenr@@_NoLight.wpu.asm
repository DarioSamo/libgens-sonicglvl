...
//
    ...
    dp3_pp r2.y, r8.yzww, r8.yzww
    rsq_pp r2.y, r2.y
    mad_pp r0.yzw, r8.xxyz, r2.y, -r0
    nrm_pp r9.xyz, r0.yzww
    dp3_sat_pp r0.y, r9, r5
    frc r0.zw, c26.xyxw
    cmp r2.zw, -r0, c4.x, c4.y
    add r0.zw, -r0, c26.xyxw
    cmp r2.xz, c26.xyww, r2.x, r2.zyww
    ...
    texld_pp r9, r0.zwzw, s2
    mul_pp r0.zw, r9.x, c20.xyyz
    mul_pp r0.zw, r0, c5.xyxy
    max_pp r2.x, r0.z, c4.y
    min r0.z, r2.x, c1.w
    pow r2.x, r0.y, r0.z
    mul_pp r9.yzw, c59.w, c59.xxyz
    mul_pp r9.yzw, r0.w, r9
    mul_pp r11.xyz, r0.w, c37
    mul_pp r2.xzw, r2.x, r9.yyzw
    mul_pp r0.xyw, r0.x, r2.xzzw
    mad_pp r2.xzw, r8.xyyz, r2.y, -c10.xyyz
    mul_pp r8, r2.y, r8
    nrm_pp r12.xyz, r2.xzww
    dp3_sat_pp r2.x, r12, r5
    pow r9.y, r2.x, r0.z
    mul_pp r2.xyz, r9.y, r11
    mad_pp r0.xyz, r2, r1.w, r0.xyww
