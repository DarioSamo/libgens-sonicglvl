...
//
    ...
    max r0.w, v4.z, c2.x
    add r1.z, r0.w, -v4.w
    cmp r3.z, r1.z, c2.x, r0.w
    mov r3.xyw, v4
    texldp_pp r3, r3, s13
    max r0.w, v5.z, c2.x
    add r1.z, r0.w, -v5.w
    cmp r4.z, r1.z, c2.x, r0.w
    mov r4.xyw, v5
    texldp_pp r4, r4, s7
    min_pp r0.w, r4.x, r3.x
    lrp_pp r1.z, v6.z, c2.y, r4.x
    lrp_pp r1.w, v6.z, c2.y, r0.w
    rcp r0.w, v4.w
    mul r3.xy, r0.w, v4
    ...
    mul r3.xy, r3, c65.y
    max r0.w, r3.x, r3.y
    lrp_pp r2.w, r0.w, c2.y, r1.w
    lrp_pp r3.x, r0.w, c2.y, r1.z
    mul_pp r0.w, r2.w, c77.w
    dp3_pp r1.z, r0, -c10
    mul r3.yzw, r1.z, c36.xxyz
    mul_pp r3.yzw, r0.w, r3
    cmp_pp r3.yzw, r1.z, r3, c2.x
    add_pp r2.xyz, r2, r3.yzww
    ...
    rcp r1.z, r1.z
    add r1.z, r1.z, -c60.z
    dp3_pp r1.w, r3.yzww, c23
    dp3_pp r2.w, r0, -r3.yzww
    add_pp r1.w, r1.w, -c61.z
    mul_sat_pp r0.w, r0.w, r1.w
    mad_pp r1.w, r0.w, -c0.y, -c0.w
