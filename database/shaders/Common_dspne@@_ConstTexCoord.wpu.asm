...
//
    ...
    dp2add_pp r6.x, r6, -r6, c2.w
    rsq_pp r6.x, r6.x
    rcp_pp r6.x, r6.x
    nrm_pp r7, v2.xyzx
    mad r5, r6.x, r7, r5
    add_pp r6, c22.xyzx, -v1.xyzx
    dp3_pp r7.x, r6.yzww, r6.yzww
    rsq_pp r7.x, r7.x
    mad_pp r7.yzw, r6.xxyz, r7.x, -r4
    dp3_pp r4.y, r5.wyzw, -r4.yzww
    nrm_pp r8.xyz, r7.yzww
    dp3_sat_pp r4.z, r8, r5
    texld_pp r8, v0, s2
    mul_pp r7.yz, r8.x, c20
    mul_pp r7.yz, r7, c1.xzww
    max_pp r4.w, r7.y, c2.w
    min r7.y, r4.w, c3.x
    pow r8.y, r4.z, r7.y
    mul_pp r9.xyz, r7.z, c43
    mul_pp r8.yzw, r8.y, r9.xxyz
    mul_pp r8.yzw, r4.x, r8
    mad_pp r9.xyz, r6, r7.x, -r3.yzww
    dp3_pp r3.y, r5.wyzw, -r3.yzww
    nrm_pp r10.xyz, r9
    dp3_sat_pp r3.z, r10, r5
    pow r4.z, r3.z, r7.y
    mul_pp r9.xyz, r7.z, c39
    mul_pp r9.xyz, r4.z, r9
    mad_pp r8.yzw, r3.x, r9.xxyz, r8
    mad_pp r9.xyz, r6, r7.x, -r2.yzww
    dp3_pp r2.y, r5.wyzw, -r2.yzww
    nrm_pp r10.xyz, r9
    dp3_sat_pp r2.z, r10, r5
    pow r3.z, r2.z, r7.y
    mul_pp r9.xyz, r7.z, c47
    mul_pp r9.xyz, r3.z, r9
    mad_pp r8.yzw, r2.x, r9.xxyz, r8
    mad_pp r9.xyz, r6, r7.x, -r1.yzww
    ...
    mul r1.z, r3.z, r9.w
    mad_pp r10.xyz, r6, r7.x, -c10
    nrm_pp r11.xyz, r10
    dp3_sat_pp r1.w, r11, r5
    pow r2.z, r1.w, r7.y
    mul_pp r10.xyz, r7.z, c37
    mul_pp r10.xyz, r2.z, r10
    mad_pp r8.yzw, r10.xxyz, r1.z, r8
    mul_pp r10.xyz, c59.w, c59
    mul_pp r10.xyz, r7.z, r10
    mad_pp r11.xyz, r6, r7.x, -r0.yzww
    dp3_pp r0.y, r5.wyzw, -r0.yzww
    mul r6, r6, r7.x
    nrm_pp r12.xyz, r11
    dp3_sat_pp r0.z, r12, r5
    pow r1.w, r0.z, r7.y
    mul_pp r7.xyz, r1.w, r10
    mad_pp r7.xyz, r0.x, r7, r8.yzww
    dp3 r0.z, r6.yzww, r5.yzww
    add r0.z, r0.z, r0.z
    mad r6, r0.z, r5, -r6
    dp3_pp r0.z, r5.wyzw, -c10
    mad r5, r6.wyzw, c5.xxyz, c5.zzzw
    mul r10, r6, c3.yzzw
    cmp r5, r6.z, r5, r10
    add r0.w, r5.z, c2.w
    rcp r0.w, r0.w
    mad r2.zw, r5.xyyx, r0.w, c2.w
    mad_pp r5.x, r2.w, c4.x, r5.w
    mul_pp r5.y, r2.z, c2.x
    texld_pp r5, r5, s5
    mul r6.xyz, r5, c63.x
    mad_pp r5.xyz, r6, r5.w, r5
    mul_pp r5.xyz, r8.x, r5
...
// approximately 255 instruction slots used (7 texture, 248 arithmetic)
