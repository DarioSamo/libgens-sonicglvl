...
//
    ...
    max r5.w, v8.z, c2.x
    add r6.w, r5.w, -v8.w
    cmp r7.z, r6.w, c2.x, r5.w
    mov r7.xyw, v8
    texldp_pp r7, r7, s13
    max r5.w, v9.z, c2.x
    add r6.w, r5.w, -v9.w
    cmp r8.z, r6.w, c2.x, r5.w
    mov r8.xyw, v9
    texldp_pp r8, r8, s7
    ...
    dp4 r3.y, r14, r14
    rsq r3.y, r3.y
    mul r3.yz, r3.y, r14.xxyw
    mad_pp r3.yz, r3, c1.xzww, c1.z
    texld_pp r14, r3.yzzw, s3
    ...
    dp3_sat_pp r3.y, r8, r15
    pow r4.y, r3.y, r9.z
    mul_pp r3.yzw, r9.w, c43.xxyz
    mul_pp r3.yzw, r4.y, r3
    mul_pp r3.yzw, r3, r4.x
    dp3_sat_pp r4.x, r10, r15
    pow r5.x, r4.x, r9.z
    mul_pp r4.xyz, r9.w, c39
    mul_pp r4.xyz, r5.x, r4
    mad_pp r3.xyz, r3.x, r4, r3.yzww
    dp3_sat_pp r3.w, r11, r15
    pow r4.x, r3.w, r9.z
...
// approximately 328 instruction slots used (6 texture, 322 arithmetic)
