...
//
    ...
    mul_pp r12.yzw, r6.y, r12
    mul_pp r12.yzw, r3.x, r12
    ...
    mad_pp r2.xyz, r2.x, r2.yzww, r12.yzww
    ...
    mul_pp r3, r5, r1.y
    mad_pp r3, r1.x, r7, r3
    dp2add_pp r0.w, r1, -r1, c4.z
    rsq_pp r0.w, r0.w
    rcp_pp r0.w, r0.w
    mad r1, r0.w, r8, r3
    dp3_pp r0.w, r2.yzww, r1.yzww
    mad_pp r3.x, r0.w, -r0.w, c4.z
    mad_pp r3.x, r3.x, -c5.x, c5.y
    rsq_pp r3.x, r3.x
    rcp_pp r3.x, r3.x
    mad r0.w, r0.w, c5.z, -r3.x
    mul_pp r3, r2.wyzw, c5.z
    mad r1, r1, r0.w, -r3
...
// approximately 280 instruction slots used (9 texture, 271 arithmetic)
