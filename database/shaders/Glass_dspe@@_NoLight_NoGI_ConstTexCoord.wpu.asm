...
//
    ...
    max r0.x, v3.z, c4.y
    add r0.y, r0.x, -v3.w
    cmp r0.z, r0.y, c4.y, r0.x
    mov r0.xyw, v3
    texldp_pp r0, r0, s13
    max r0.y, v4.z, c4.y
    add r0.z, r0.y, -v4.w
    cmp r1.z, r0.z, c4.y, r0.y
    mov r1.xyw, v4
    texldp_pp r1, r1, s7
    min_pp r2.x, r1.x, r0.x
    lrp_pp r0.x, v5.z, c4.z, r1.x
    lrp_pp r0.y, v5.z, c4.z, r2.x
    rcp r0.z, v3.w
    mul r0.zw, r0.z, v3.xyxy
    mad r0.zw, r0, -c4.w, -c4.z
    abs_sat r0.zw, r0
    add_sat r0.zw, r0, -c65.x
    mul r0.zw, r0, c65.y
    max r1.x, r0.z, r0.w
    lrp_pp r2.x, r1.x, c4.z, r0.y
    lrp_pp r2.y, r1.x, c4.z, r0.x
    mul r0.x, r2.x, c77.w
    ...
    mad r5, r1.w, r6, -r5
    mad r7, r5.wyzw, c0.xxyz, c0.zzzw
    mul r8, r5, c2.yzzw
    cmp r5, r5.z, r7, r8
    add r1.w, r5.z, c4.z
    rcp r1.w, r1.w
    mad r2.xw, r5.yyzx, r1.w, c4.z
    mad_pp r5.x, r2.w, c3.x, r5.w
    mul_pp r5.y, r2.x, c4.x
    texld_pp r5, r5, s5
