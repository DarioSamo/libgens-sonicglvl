...
//
    ...
    texld_pp r6, v0, s3
    mad r6.xy, r6.wxzw, c1.x, c1.y
    mul_pp r6.xy, r6, c150
    texld r8, v0, s5
    mul_pp r6.xy, r6, r8.x
    mul_pp r6.xy, r6, v5.w
    mad r6.xy, r6, c1.x, v0
    texld_pp r8, r6, s1
    texld_pp r6, r6, s0
    mul_pp r8.xy, r8.x, c20.yzzw
    mul_pp r8.xy, r8, c2.zwzw
    mul_pp r9.xyz, r8.y, c43
    max_pp r7.w, r8.x, c1.w
    min r8.x, r7.w, c0.w
    add_pp r10.xyz, c22, -v1
    dp3_pp r7.w, r10, r10
    rsq_pp r7.w, r7.w
    mad_pp r4.yzw, r10.xxyz, r7.w, -r4
    ...
    mad_pp r3.yzw, r10.xxyz, r7.w, -r3
    ...
    mad_pp r2.yzw, r10.xxyz, r7.w, -r2
    ...
    mad_pp r4.xyz, r10, r7.w, -r7
    nrm_pp r7.xyz, r4
    dp3_sat_pp r2.w, r7, r5
    pow r3.w, r2.w, r8.x
    mul_pp r3.xyz, r3.w, r3
    mad_pp r2.xyz, r5.w, r3, r2
    mul_pp r3.xyz, r8.y, c37
    mad_pp r4.xyz, r10, r7.w, -c10
    mad_pp r1.yzw, r10.xxyz, r7.w, -r1
