...
//
    ...
    mad_pp r9.xyz, r4, r3.w, -c10
    mul_pp r4.xyz, r3.w, r4
    nrm_pp r10.xyz, r9
    dp3_sat_pp r3.w, r10, r2
    pow r4.w, r3.w, r6.x
    ...
    dp3_pp r3.w, v5, v5
    rsq_pp r3.w, r3.w
    mad_pp r11.xyz, v5, r3.w, r4
    nrm_pp r12.xyz, r11
    texld r11, v0, s2
    mad_pp r11, r11, c1.x, c1.y
    dp2add_pp r3.w, r11, -r11, c1.z
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    nrm_pp r13.xyz, v1
    nrm_pp r14.xyz, v2
    ...
    dp2add_pp r4.w, r11.zwzw, -r11.zwzw, c1.z
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    mad_pp r11.xyz, r4.w, r2, r14
    mad_pp r2.xyz, r3.w, r2, r13
    dp3_sat_pp r2.x, r12, r2
    pow r3.w, r2.x, r6.x
    mul_pp r2.xyz, r3.w, r8
    mad_pp r2.xyz, r7, c18, r2
