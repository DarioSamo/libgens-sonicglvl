...
//
    ...
    mul r6.xyz, r1.w, r5.yzww
    mul r5.yzw, r2.w, r5
    dp3_pp r1.w, r3, -c10
    mov_sat_pp r3.w, r1.w
    mov_sat_pp r1.w, -r1.w
    mad_pp r6.xyz, r1, r1.w, r6
    mad_pp r1.xyz, r1, r3.w, r5.yzww
    mul r2.xyz, r2, r3.w
    ...
    cmp r5.xw, c26.xyzz, r5.x, r6.xyzy
    add r5.xy, r5.xwzw, r5.yzzw
    add r6, r5.x, -c3
    add r5, r5.y, -c3
    ...
    mul_pp r5.xy, r5, c1
    mul_pp r5.yzw, r5.y, c18.xxyz
    max_pp r3.w, r5.x, c3.y
    min r4.w, r3.w, c0.w
    ...
    dp3_pp r0.x, r7, r7
    rsq_pp r0.x, r0.x
    mad_pp r4.xyz, r7, r0.x, -r4
    mad_pp r7.xyz, r7, r0.x, -c10
    nrm_pp r8.xyz, r7
    dp3_sat_pp r0.x, r8, r3
    pow_pp r2.w, r0.x, r4.w
    nrm_pp r7.xyz, r4
    dp3_sat_pp r0.x, r7, r3
    pow_pp r3.x, r0.x, r4.w
    mul r3.xyz, r3.x, r6
    mad_pp r2.xyz, r2, r2.w, r3
    mul_pp r2.xyz, r5.yzww, r2
    mad_pp r1.xyz, r2, v3.w, r0.yzww
    mul_pp r0, r1, c89
    min_pp r1, r0, c2.x
