...
//
    ...
    mul_pp r8.xzw, r7.w, r8
    mul_pp r8.xzw, r4.w, r8
    mad_pp r9.xyz, r7, r5.w, -r4
    dp3_pp r4.x, r6, -r4
    nrm_pp r10.xyz, r9
    ...
    dp3_sat_pp r0.z, r7, r6
    pow r2.w, r0.z, r6.w
    mul_pp r5.yzw, r8.y, c37.xxyz
    mul_pp r5.yzw, r2.w, r5
    mad_pp r5.yzw, r5, r1.x, r8.xxzw
    mul_pp r7.xyz, c59.w, c59
    mul_pp r7.xyz, r8.y, r7
...
// approximately 287 instruction slots used (6 texture, 281 arithmetic)
