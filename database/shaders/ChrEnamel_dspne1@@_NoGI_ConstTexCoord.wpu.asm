...
//
    ...
    mul_pp r9.xzw, r2.w, r9
    mad_pp r10.xyz, r6, r4.w, -r4
    dp3_pp r4.x, r7, -r4
    nrm_pp r11.xyz, r10
    ...
    mad_pp r10.xyz, r6, r4.w, -r3.xzww
    ...
    dp3_sat_pp r0.z, r6, r7
    pow r2.z, r0.z, r7.w
    mul_pp r4.yzw, r9.y, c37.xxyz
    mul_pp r4.yzw, r2.z, r4
    mad_pp r4.yzw, r4, r1.x, r9.xxzw
    mul_pp r6.xyz, c59.w, c59
    mul_pp r6.xyz, r9.y, r6
    ...
    texld_pp r6, r2.yzzw, s3
    mul r9.xyz, r6, c63.x
    mad_pp r6.xyz, r9, r6.w, r6
    mul_pp r6.xyz, r8.w, r6
    mul_pp r6.xyz, r0.z, r6
    mad_pp r4.yzw, r4, r8.xxyz, r6.xxyz
...
// approximately 255 instruction slots used (6 texture, 249 arithmetic)
