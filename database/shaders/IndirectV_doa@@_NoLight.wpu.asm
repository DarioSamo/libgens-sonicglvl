...
//
    ...
    mad r3.xw, r3.yyzz, v6.w, r3
    texld_pp r4, r3.xwzw, s1
    mul_pp r3.xw, r4.x, c20.yyzz
    mul_pp r3.xw, r3, c2.xyzy
    ...
    dp3_pp r2.w, r7, r7
    rsq_pp r2.w, r2.w
    mad_pp r1.yzw, r7.xxyz, r2.w, -r1
    mad_pp r7.xyz, r7, r2.w, -c10
    nrm_pp r8.xyz, r7
    dp3_sat_pp r2.w, r8, r2
    pow r4.w, r2.w, r3.x
