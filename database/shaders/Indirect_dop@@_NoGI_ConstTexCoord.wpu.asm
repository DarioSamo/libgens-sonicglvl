...
//
    ...
    max r5.w, v3.z, c0.w
    add r6.w, r5.w, -v3.w
    cmp r7.z, r6.w, c0.w, r5.w
    mov r7.xyw, v3
    texldp_pp r7, r7, s13
    max r5.w, v4.z, c0.w
    add r6.w, r5.w, -v4.w
    cmp r8.z, r6.w, c0.w, r5.w
    mov r8.xyw, v4
    texldp_pp r8, r8, s7
    min_pp r5.w, r8.x, r7.x
    lrp_pp r6.w, v5.z, -c0.y, r8.x
    lrp_pp r7.x, v5.z, -c0.y, r5.w
    rcp r5.w, v3.w
    ...
    mul r7.yz, r7, c65.y
    max r5.w, r7.y, r7.z
    lrp_pp r8.x, r5.w, -c0.y, r7.x
    lrp_pp r7.x, r5.w, -c0.y, r6.w
    mul_pp r5.w, r8.x, c77.w
    dp3_pp r6.w, r5, -c10
    mul r7.yzw, r6.w, c36.xxyz
    mul_pp r7.yzw, r5.w, r7
    cmp_pp r7.yzw, r6.w, r7, c0.w
    ...
    texld_pp r7, v0, s3
    mad r7.xy, r7.wxzw, c0.x, c0.y
    mul_pp r7.xy, r7, c150
    mad r7.xy, r7, c0.x, v0
    texld_pp r8, r7, s0
    texld_pp r7, r7, s1
    mul_pp r7.xy, r7.x, c20.yzzw
    mul_pp r7.xy, r7, c1.zwzw
    mul_pp r6.xyz, r6, r8
    mul_pp r6.w, r8.w, c16.w
    mul_pp r6.w, r6.w, v6.w
    mul_pp r8.w, r6.w, c21.x
    mul_pp r9.xyz, r7.y, c43
    max_pp r6.w, r7.x, -c0.y
    min r7.x, r6.w, c2.x
