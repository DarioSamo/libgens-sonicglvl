...
//
    ...
    min r3.w, r2.w, c1.w
    frc r6.yw, c27.xxzy
    cmp r8.xy, -r6.ywzw, c3.x, c3.y
    add r6.yw, -r6, c27.xxzy
    cmp r2.xw, c27.xyzy, r2.x, r8.xyzy
    add r2.xw, r2, r6.yyzw
    add r8, r2.x, -c3
    add r9, r2.w, -c3
    ...
    mad_pp r11.xyz, r10, r2.x, -r1.yzww
    ...
    max r3.y, v4.z, c3.x
    add r3.z, r3.y, -v4.w
    cmp r7.z, r3.z, c3.x, r3.y
    mov r7.xyw, v4
    texldp_pp r7, r7, s13
    lrp_pp r3.y, v5.z, c3.y, r7.x
    lrp_pp r6.y, r4.w, c3.y, r3.y
    texld_pp r7, v0.zwzw, s10
    mul r3.y, r6.y, r7.w
    mul_pp r11.xyz, r6.z, c37
    mad_pp r12.xyz, r10, r2.x, -c10
    nrm_pp r13.xyz, r12
    ...
    mul_pp r11.xyz, r6.z, r11
    mad_pp r12.xyz, r10, r2.x, -r0.yzww
    dp3_pp r0.y, r8, -r0.yzww
    mul r10.xyz, r2.x, r10
    nrm_pp r13.xyz, r12
    dp3_sat_pp r0.z, r13, r8
    pow r2.x, r0.z, r3.w
    mul_pp r11.xyz, r2.x, r11
    mad_pp r4.xyz, r0.x, r11, r4
    dp3 r0.z, -r10, r8
    add r0.z, r0.z, r0.z
    mad_pp r10.xyz, r8, -r0.z, -r10
    dp3_pp r0.z, r8, -c10
    texld_pp r8, r10, s5
    ...
    cmp_pp r6.xzw, r2.w, r6, c3.x
    mul_pp r2.xzw, r2.z, r6
    mul_pp r6.xzw, r3.x, c39.xyyz
    cmp_pp r3.xzw, r3.x, r6, c3.x
