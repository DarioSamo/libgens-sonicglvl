...
//
    ...
    mov r1.xyw, v3
    texldp_pp r1, r1, s13
    lrp_pp r2.y, v4.z, c1.z, r1.x
    lrp_pp r1.x, r2.x, c1.z, r2.y
    texld_pp r2, v0.zwzw, s10
    mul_pp r1.y, r1.x, r2.w
    nrm_pp r3.xyz, v6
    texld_pp r4, v0, s3
    mul_pp r4.x, r4.w, r4.x
    mad_pp r1.zw, r4.xyxy, c1.x, c1.y
    mul_pp r3.xyz, r3, r1.w
    nrm_pp r4.xyz, v5
    mad_pp r3.xyz, r1.z, r4, r3
    dp2add_pp r1.z, r1.zwzw, -r1.zwzw, c1.z
    rsq_pp r1.z, r1.z
    rcp_pp r1.z, r1.z
    nrm_pp r4.xyz, v2
    mad_pp r3.xyz, r1.z, r4, r3
    ...
    cmp_pp r1.yzw, r1.z, r3.xxyz, c1.w
