...
//
    ...
    add_pp r1.yzw, -r1, c1.x
    nrm_pp r5.xyz, v2
    dp3_pp r3.w, r5, -r4
    mul_pp r6.xyz, r3.w, c43
    cmp_pp r6.xyz, r3.w, r6, c0.w
    mul_pp r6.xyz, r1.w, r6
    dp3_pp r3.w, r5, -r3
    mul_pp r7.xyz, r3.w, c39
    cmp_pp r7.xyz, r3.w, r7, c0.w
    ...
    cmp_pp r8.xyz, r4.w, r8, c0.w
    mad_pp r6.xyz, r3.w, r8, r6
    max r4.w, v3.z, c0.w
    add r5.w, r4.w, -v3.w
    cmp r8.z, r5.w, c0.w, r4.w
    mov r8.xyw, v3
    texldp_pp r8, r8, s13
    min_pp r4.w, r0.x, r8.x
    lrp_pp r0.x, v5.z, c1.x, r4.w
    lrp_pp r4.w, r1.x, c1.x, r0.x
    mul_pp r0.x, r2.w, r4.w
    dp3_pp r1.x, r5, -c10
    mul r8.xyz, r1.x, c36
    mul_pp r8.xyz, r0.x, r8
    cmp_pp r8.xyz, r1.x, r8, c0.w
    add_pp r6.xyz, r6, r8
    ...
    texld_pp r9, v0, s3
    texld_pp r10, v0, s6
    lrp_pp r2.w, r10.x, r9.x, r6.x
    mul_pp r6.xy, r2.w, c20.yzzw
    mul_pp r6.xy, r6, c2
    mul_pp r9.xyz, r6.y, c43
    add_pp r10.yzw, c22.xxyz, -v1.xxyz
    dp3_pp r2.w, r10.yzww, r10.yzww
    rsq_pp r2.w, r2.w
    mad_pp r4.xyz, r10.yzww, r2.w, -r4
    nrm_pp r11.xyz, r4
    dp3_sat_pp r4.x, r11, r5
    max_pp r4.y, r6.x, c1.x
    min r5.w, r4.y, c2.z
    pow r6.x, r4.x, r5.w
    mul_pp r4.xyz, r6.x, r9
    mul_pp r4.xyz, r1.w, r4
    mul_pp r6.xzw, r6.y, c39.xyyz
    mad_pp r3.xyz, r10.yzww, r2.w, -r3
    nrm_pp r9.xyz, r3
    dp3_sat_pp r1.w, r9, r5
    pow r3.x, r1.w, r5.w
    mul_pp r3.xyz, r3.x, r6.xzww
    mad_pp r3.xyz, r1.z, r3, r4
    mul_pp r4.xyz, r6.y, c47
    mad_pp r2.xyz, r10.yzww, r2.w, -r2
    nrm_pp r9.xyz, r2
    dp3_sat_pp r1.z, r9, r5
    pow r2.x, r1.z, r5.w
    mul_pp r2.xyz, r2.x, r4
    mad_pp r1.yzw, r1.y, r2.xxyz, r3.xxyz
    mul_pp r2.xyz, r6.y, c51
    mad_pp r3.xyz, r10.yzww, r2.w, -r7
    nrm_pp r4.xyz, r3
    dp3_sat_pp r3.x, r4, r5
    pow r4.x, r3.x, r5.w
    mul_pp r2.xyz, r2, r4.x
    mad_pp r1.yzw, r3.w, r2.xxyz, r1
    mad_pp r2.xyz, r10.yzww, r2.w, -c10
    mad_pp r3.xyz, r10.yzww, r2.w, -r8
    nrm_pp r4.xyz, r3
...
// approximately 219 instruction slots used (8 texture, 211 arithmetic)
