...
//
    ...
    add r8, r8, r9
    add r9, r8.z, -c3
    cmp r7.xy, -r9_abs.x, v0, c3.x
    cmp r7.xy, -r9_abs.y, v0.zwzw, r7
    cmp r7.xy, -r9_abs.z, v1, r7
    cmp r7.xy, -r9_abs.w, v1.zwzw, r7
    texld_pp r9, r7, s2
    add r10, r8.w, -c3
    cmp r7.xy, -r10_abs.x, v0, c3.x
    cmp r7.xy, -r10_abs.y, v0.zwzw, r7
    cmp r7.xy, -r10_abs.z, v1, r7
    cmp r7.xy, -r10_abs.w, v1.zwzw, r7
    texld_pp r10, r7, s3
    lrp_pp r2.x, v9.x, r10.x, r9.x
    mul_pp r7.xy, r2.x, c20.yzzw
    mul_pp r7.xy, r7, c2
    mul_pp r9.xyz, r7.y, c43
    add_pp r10.xyz, c22, -v2
    dp3_pp r2.x, r10, r10
    rsq_pp r2.x, r2.x
    mad_pp r2.yzw, r10.xxyz, r2.x, -r2
    nrm_pp r11.xyz, r2.yzww
    dp3_sat_pp r2.y, r11, r1
    max_pp r2.z, r7.x, c3.y
    min r6.w, r2.z, c1.w
    pow r7.x, r2.y, r6.w
    mul_pp r2.yzw, r7.x, r9.xxyz
    mul_pp r2.yzw, r1.w, r2
    mul_pp r9.xyz, r7.y, c39
    ...
    mad_pp r4.xyz, r10, r2.x, -r5
    nrm_pp r5.xyz, r4
    dp3_sat_pp r1.w, r5, r1
    pow r3.w, r1.w, r6.w
    mul_pp r4.xyz, r7.y, c47
    mul_pp r4.xyz, r3.w, r4
    mad_pp r2.yzw, r4.w, r4.xxyz, r2
    mad_pp r4.xyz, r10, r2.x, -r6
    nrm_pp r5.xyz, r4
    dp3_sat_pp r1.w, r5, r1
    pow r3.w, r1.w, r6.w
    mul_pp r4.xyz, r7.y, c51
    mul_pp r4.xyz, r3.w, r4
    mad_pp r2.yzw, r5.w, r4.xxyz, r2
    mad_pp r4.xyz, r10, r2.x, -c10
    ...
    dp3_sat_pp r0.y, r5, r1
    pow r1.x, r0.y, r6.w
    mul_pp r0.yzw, r7.y, c37.xxyz
    mul_pp r0.yzw, r1.x, r0
    mad_pp r0.yzw, r0, r7.w, r2
...
// approximately 278 instruction slots used (9 texture, 269 arithmetic)
