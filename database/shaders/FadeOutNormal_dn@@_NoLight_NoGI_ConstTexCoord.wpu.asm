...
//
    ...
    dp3 r1.z, v2, v2
    rsq r1.z, r1.z
    mul r3.xzw, r1.z, v2.xyyz
    mad_pp r2.xyz, r1.y, r3.xzww, r2
    mad r1.yzw, v2.xxyz, r1.z, -r2.xxyz
    mad r1.yzw, v8.x, r1, r2.xxyz
    ...
    mad_pp r3.xzw, r2.xyyz, c0.w, c0.w
    mov r4.xyz, c79
    add r4.xyz, -r4, c80
...
// approximately 142 instruction slots used (4 texture, 138 arithmetic)
