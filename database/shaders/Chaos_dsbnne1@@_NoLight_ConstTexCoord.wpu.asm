...
//
    ...
    mul_pp r2.w, r2.w, v8.w
    mul_pp r6.w, r2.w, c21.x
    texld_pp r9, v0, s6
    mad_pp r1.xyz, r9.x, r1, r2
    ...
    mad_pp r9.xyz, r2, r2.w, -c10
    mul_pp r2.xyz, r2.w, r2
    nrm_pp r11.xyz, r9
    dp3_sat_pp r2.w, r11, r3
    pow r3.w, r2.w, r0.z
    ...
    mad_pp r1.xyz, r2, c2.w, c2.w
    mul_pp r2.xyz, r2, r2
    mad r3.xyz, r1.y, r5, c79
    mul r3.xyz, r2.y, r3
    mad r1.xyw, r1.x, r7.xyzz, c77.xyzz
    mad r4.xyz, r1.z, r8, c81
...
// approximately 203 instruction slots used (9 texture, 194 arithmetic)
