...
//
    ...
    max r0.z, v4.z, c4.x
    add r0.w, r0.z, -v4.w
    cmp r4.z, r0.w, c4.x, r0.z
    mov r4.xyw, v4
    texldp_pp r4, r4, s13
    lrp_pp r0.z, v5.z, c4.y, r4.x
    lrp_pp r3.w, r1.w, c4.y, r0.z
    texld_pp r4, v0.zwzw, s10
    mul r0.z, r3.w, r4.w
    mad_pp r2.yzw, r2, r0.z, r3.xxyz
    mul r5, r1.y, c91
    mad r5, r1.x, c90, r5
    mad r5, r1.z, c92, r5
    dp3_pp r0.w, r1, -c10
    ...
    frc r3.xy, c26.xzzw
    cmp r5.xy, -r3, c4.x, c4.y
    add r3.xy, -r3, c26.xzzw
    cmp r5.xy, c26.xzzw, r2.x, r5
    add r3.xy, r3, r5
    add r5, r3.y, -c4
    add r6, r3.x, -c4
    cmp r3.xy, -r5_abs.x, v0, c4.x
