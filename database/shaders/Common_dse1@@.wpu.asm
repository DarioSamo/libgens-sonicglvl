...
//
    ...
    mad_pp r9.xzw, r3.w, r10.xyyz, r9
    ...
    mad_pp r11.xyz, r7, r5.w, -r2.yzww
    ...
    mad_pp r5.yzw, r5, r1.y, r9.xxzw
    mul_pp r7.xyz, c59.w, c59
    mul_pp r7.xyz, r9.y, r7
    ...
    cmp r0.zw, -r10_abs.x, v0.xyxy, c3.x
    ...
    mul_pp r9.w, r0.z, c21.x
    add r0.z, c0.x, vPos.y
    mov r10.x, c86.x
    mad r0.z, r0.z, c24.w, -r10.x
    mul_sat_pp r0.z, r0.z, c86.y
    lrp_pp r5.yzw, r0.z, r7.xxyz, c3.y
    dp3_pp r0.z, r8, -r6
    dp3_pp r0.w, r8, -c10
    ...
    mad_pp r0.xyz, r0, r5.yzww, r2.xzww
    mul_pp r9.xyz, r0, v6
    mul_pp r0, r9, c89
    min_pp r1, r0, c1.w
...
// approximately 246 instruction slots used (5 texture, 241 arithmetic)
