...
//
    ...
    mad r3.xz, r4.xyyw, c2.xyyw, r5.xyyw
    add_pp r3.xz, r5.zyww, r3
    mul r2.w, c150.x, c150.x
    mul_pp r4.xyz, r2.y, c91
    mad_pp r4.xyz, r2.x, c90, r4
    mad_pp r4.xyz, r2.z, c92, r4
    mad r3.w, r4.z, -r4.z, c0.y
    ...
    mad_pp r3.xz, r4.xyyw, c3.z, r3
    mad r3.xz, r3, c4.xyyw, c4.x
    texld_pp r4, r3.xzzw, s11
    texld_pp r5, v0, s0
    mad r0.xyz, r0, r5, -r4
    mul_pp r2.w, r5.w, c16.w
    mad_pp r3.x, c16.w, -r5.w, r3.y
