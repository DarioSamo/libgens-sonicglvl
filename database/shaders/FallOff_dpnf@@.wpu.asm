...
//
    ...
    mad_pp r2.xw, r8.xyzy, c0.x, c0.y
    nrm_pp r8.xyz, v7
    ...
    nrm_pp r12.xyz, r9
    dp3_sat_pp r0.z, r12, r6.xzww
    pow r2.x, r0.z, r3.w
    nrm_pp r9.xyz, r11
    dp3_sat_pp r0.z, r9, r6.xzww
    dp3_pp r0.w, r6.xzww, -c10
    pow r4.w, r0.z, r3.w
    mul_pp r6.xzw, r4.w, r7.yyzw
    mad_pp r4.xyz, r6.xzww, r3.y, r4
    ...
    dp3_pp r0.z, r6, c1
    mad_pp r6.xyz, r10, r10, -r0.z
    mad_sat_pp r6.xyz, r6, c71.w, r0.z
    mul_pp r6.xyz, r6, c70
    mul_pp r7.yzw, r6.xxyz, c17.xxyz
    mul r7.yzw, r7, c70.w
    mad r6.xyz, r6, c17, -r7.yzww
    mad_pp r6.xyz, r7.x, r6, r7.yzww
    ...
    mul_pp r2.xy, r8.y, c91
    mad_pp r2.xy, r8.x, c90, r2
    mad_pp r2.xy, r8.z, c92, r2
    mad_pp r2.xy, r2, c2.zwzw, c2.z
    texld_pp r2, r2, s5
    mul r0.w, c64.w, c64.y
    mov r4.yw, c64
    mad r2.w, r4.y, -r4.w, r4.w
