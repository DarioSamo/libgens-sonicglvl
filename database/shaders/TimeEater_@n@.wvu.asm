...
//
    ...
    def c15, 3, 1, 0, 1.44269502
    def c16, 0.699999988, 0.300000012, 0, 0
    def c17, 1.5, 0.5, -0.5, 0
    dcl_position v0
    dcl_texcoord v1
    dcl_texcoord1 v2
    dcl_texcoord2 v3
    ...
    mov o3.xyz, r2
    mul r3.xyz, r1.x, c9
    mad r3.xyz, r3.w, c8, r3
    mad r3.xyz, r4.w, c10, r3
    dp3 r0.z, r3, r3
    rsq r0.z, r0.z
    mul o8.xyz, r0.z, r3
    max r0.z, r0_abs.x, r0_abs.y
    rcp r0.z, r0.z
    min r1.x, r0_abs.x, r0_abs.y
    mul r0.z, r0.z, r1.x
    mul r1.x, r0.z, r0.z
    mad r1.z, r1.x, c12.x, c12.y
    mad r1.z, r1.x, r1.z, c12.z
    mad r1.z, r1.x, r1.z, c12.w
    mad r1.x, r1.x, r1.z, c13.x
    mul r0.z, r0.z, r1.x
    slt r1.x, r0_abs.x, r0_abs.y
    mad r1.z, r0.z, c13.y, c13.z
    mad r0.z, r1.z, r1.x, r0.z
    slt r1.x, r0.x, -r0.x
    mad r0.z, r1.x, c13.w, r0.z
    min r1.x, r0.x, r0.y
    slt r1.x, r1.x, -r1.x
    max r0.x, r0.x, r0.y
    sge r0.x, r0.x, -r0.x
    ...
    slt r0.y, r3.y, -r3.y
    add r0.x, -r0.y, r0.x
    pow r0.y, r3_abs.y, c249.y
    mul r0.x, r0.y, r0.x
    mul r0.x, r0.x, c249.z
    mul r0.yzw, r0.w, c9.xxyz
    mad r0.yzw, r1.w, c8.xxyz, r0
    mad r0.yzw, r1.y, c10.xxyz, r0
    dp3 r1.x, r0.yzww, r0.yzww
    rsq r1.x, r1.x
    add r1.yzw, -r2.xxyz, c178.xxyz
    nrm r3.xyz, r1.yzww
    mul r1.yzw, r0, r1.x
    dp3 r3.w, r1.yzww, r3
    add r3.w, -r3_abs.w, c15.y
    max r3.w, r3.w, c15.z
    pow r4.x, r3.w, c250.z
    mad r3.w, c250.y, r4.x, c250.x
    mul r0.x, r0.x, r3.w
    mad r0.x, r0.x, c14.x, c14.y
    frc r0.x, r0.x
    mad r0.x, r0.x, c14.z, c14.w
    mul r4.xyz, r3.yzxw, r1.wyzw
    mad r4.xyz, r1.zwyw, r3.zxyw, -r4
    nrm r5.xyz, r4
    dp3 r1.y, r5, r1.yzww
    ...
    pow r3.x, r1_abs.y, c17.x
    rcp r1.y, r3.x
    mul r1.y, r1.y, c198.x
    mul r1.y, r1.y, c197.w
    mad r1.x, r1.x, r1.x, c15.y
