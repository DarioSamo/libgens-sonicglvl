...
//
    ...
    texld_pp r8, r8, s6
    frc r9, c26
    cmp r10, -r9, c2.x, c2.y
    add r9, -r9, c26
    cmp r10, c26, r2.x, r10
    add r9, r9, r10
    add r10, r9.z, -c2
    cmp r8.yz, -r10_abs.x, v0.xxyw, c2.x
    cmp r8.yz, -r10_abs.y, v0.xzww, r8
    cmp r8.yz, -r10_abs.z, v1.xxyw, r8
    cmp r8.yz, -r10_abs.w, v1.xzww, r8
    texld_pp r10, r8.yzzw, s2
    add r11, r9.w, -c2
    cmp r8.yz, -r11_abs.x, v0.xxyw, c2.x
    cmp r8.yz, -r11_abs.y, v0.xzww, r8
    cmp r8.yz, -r11_abs.z, v1.xxyw, r8
    cmp r8.yz, -r11_abs.w, v1.xzww, r8
    texld_pp r11, r8.yzzw, s3
    lrp_pp r2.x, r8.x, r11.x, r10.x
    mul_pp r8.yz, r2.x, c20
    mul_pp r8.yz, r8, c1.xxyw
    mul_pp r10.xyz, r8.z, c43
    max_pp r2.x, r8.y, c2.y
    min r4.w, r2.x, c1.z
    add_pp r11.xyz, c22, -v2
    dp3_pp r2.x, r11, r11
    rsq_pp r2.x, r2.x
    mad_pp r5.xyz, r11, r2.x, -r5
    nrm_pp r12.xyz, r5
    dp3_sat_pp r5.x, r12, r6
    pow r6.w, r5.x, r4.w
    ...
    mul_pp r2.yzw, r8.z, c37.xxyz
    mad_pp r3.xyz, r11, r2.x, -c10
