...
//
    ...
    mad r2.zw, r2, c1.xyxy, c1.x
    texld_pp r4, r2.zwzw, s11
    mad r2.xy, r2, c0.z, c0.z
    texld_pp r2, r2, s14
    mul_pp r2.xyz, r1.x, r2
    mad r3.xy, r3, c1, c1.x
    texld r5, r3, s12
    texld_pp r3, r3, s11
    rcp r1.x, v1.w
    mad r1.x, v1.z, -r1.x, r5.x
    cmp_pp r3.xyz, r1.x, r3, r4
    cmp r4.xy, -r0_abs.x, v5, c4.x
...
// approximately 132 instruction slots used (7 texture, 125 arithmetic)
