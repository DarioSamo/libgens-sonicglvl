...
//
    ...
    texld_pp r9, v0, s1
    mul_pp r11.xy, r9.w, c20.yzzw
    mul_pp r11.xy, r11, c2
    mul_pp r13.xyz, r11.y, c43
    add_pp r14.xyz, c22, -v1
    dp3_pp r3.y, r14, r14
    rsq_pp r3.y, r3.y
    mad_pp r5.xyz, r14, r3.y, -r5
    nrm_pp r15.xyz, r5
    dp3_sat_pp r4.w, r15, r6
    max_pp r5.x, r11.x, c0.z
    min r6.w, r5.x, c2.z
    pow r5.x, r4.w, r6.w
    mul_pp r5.xyz, r5.x, r13
    mul_pp r5.xyz, r2.w, r5
    mul_pp r11.xzw, r11.y, c39.xyyz
    mad_pp r4.xyz, r14, r3.y, -r4
    nrm_pp r13.xyz, r4
    dp3_sat_pp r2.w, r13, r6
    pow r4.x, r2.w, r6.w
    mul_pp r4.xyz, r4.x, r11.xzww
    mad_pp r4.xyz, r1.w, r4, r5
    mul_pp r5.xyz, r11.y, c47
    mad_pp r3.xzw, r14.xyyz, r3.y, -r3
    nrm_pp r13.xyz, r3.xzww
    dp3_sat_pp r1.w, r13, r6
    pow r2.w, r1.w, r6.w
    mul_pp r3.xzw, r2.w, r5.xyyz
    mad_pp r3.xzw, r1.z, r3, r4.xyyz
    mul_pp r4.xyz, r11.y, c51
    mad_pp r2.xyz, r14, r3.y, -r2
    nrm_pp r5.xyz, r2
    dp3_sat_pp r1.z, r5, r6
    pow r2.x, r1.z, r6.w
    mul_pp r2.xyz, r2.x, r4
    mad_pp r1.yzw, r1.y, r2.xxyz, r3.xxzw
    mul_pp r2.xyz, r11.y, c37
    mad_pp r3.xzw, r14.xyyz, r3.y, -c10.xyyz
    ...
    mad_pp r0.yzw, r14.xxyz, r3.y, -r0
    mul_pp r2.xyz, r3.y, r14
    nrm_pp r3.xyz, r0.yzww
    dp3_sat_pp r0.y, r3, r6
    pow r2.w, r0.y, r6.w
    mul_pp r0.yzw, c59.w, c59.xxyz
    mul_pp r0.yzw, r11.y, r0
