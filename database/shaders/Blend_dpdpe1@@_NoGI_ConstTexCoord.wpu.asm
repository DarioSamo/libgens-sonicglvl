...
//
    ...
    mul_pp r6.xy, r6, c0.zwzw
    mul_pp r7.xyz, r6.y, c43
    max_pp r5.w, r6.x, c1.z
    min r6.x, r5.w, c2.x
...
// approximately 242 instruction slots used (7 texture, 235 arithmetic)
