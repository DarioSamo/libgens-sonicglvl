...
//
    ...
    mul_pp r3.xyz, r0.z, r3
    mad_pp r2.xzw, r2, r0.z, r3.xyyz
    mul_pp r2.xzw, r2, v2.w
    dp3_pp r0.w, r5, -c10
    mul r3.xyz, r0.w, c36
    mul_pp r3.xyz, r0.x, r3
    cmp_pp r3.xyz, r0.w, r3, c1.y
    dp3_pp r0.x, r5, -r1
    mul_pp r1.xyz, c58.w, c58
    mul_pp r1.xyz, r0.x, r1
    cmp_pp r1.xyz, r0.x, r1, c1.y
    mad_pp r0.xyw, r0.y, r1.xyzz, r3.xyzz
    mov r1.xyz, c79
    add r1.xyz, -r1, c80
    mad_pp r3.xyz, r5, c1.x, c1.x
    mul_pp r4.xyz, r5, r5
    ...
    texld_pp r1, v0, s0
    lrp_pp r3, r0.z, r1, c1.z
    mad_pp r0.xyz, r0.xyww, r3, r2.xzww
