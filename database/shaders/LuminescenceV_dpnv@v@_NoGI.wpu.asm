...
//
    ...
    mul r9.xy, r9, c65.y
    max r3.w, r9.x, r9.y
    lrp_pp r7.w, r3.w, c2.y, r6.w
    lrp_pp r6.w, r3.w, c2.y, r4.w
    mul_pp r3.w, r7.w, c77.w
    dp3_pp r4.w, r4, -c10
    mul r9.xyz, r4.w, c36
    ...
    frc r3.yz, c26.xxzw
    cmp r10.xy, -r3.yzzw, c2.x, c2.y
    add r3.yz, -r3, c26.xxzw
    cmp r10.xy, c26.xzzw, r2.x, r10
    add r3.yz, r3, r10.xxyw
    add r10, r3.z, -c2
    add r11, r3.y, -c2
    cmp r3.yz, -r10_abs.x, v0.xxyw, c2.x
    cmp r3.yz, -r10_abs.y, v0.xzww, r3
    cmp r3.yz, -r10_abs.z, v1.xxyw, r3
    cmp r3.yz, -r10_abs.w, v1.xzww, r3
    texld_pp r10, r3.yzzw, s2
    mul_pp r3.yz, r10.x, c20
    mul_pp r3.yz, r3, c1.xxyw
    max_pp r2.x, r3.y, c2.y
    min r3.y, r2.x, c1.z
    pow r2.x, r3.x, r3.y
    mul_pp r10.xyz, r3.z, c43
    mul_pp r10.xyz, r2.x, r10
    mul_pp r10.xyz, r2.y, r10
    mul_pp r12.xyz, r3.z, c39
    mad_pp r1.yzw, r9.xxyz, r4.w, -r1
    nrm_pp r13.xyz, r1.yzww
    dp3_sat_pp r1.y, r13, r4
    pow r2.x, r1.y, r3.y
    mul_pp r1.yzw, r2.x, r12.xxyz
    mad_pp r1.xyz, r1.x, r1.yzww, r10
    mul_pp r10.xyz, r3.z, c47
    mad_pp r7.xyz, r9, r4.w, -r7
    nrm_pp r12.xyz, r7
    dp3_sat_pp r1.w, r12, r4
    pow r2.x, r1.w, r3.y
    mul_pp r7.xyz, r2.x, r10
    mad_pp r1.xyz, r2.z, r7, r1
    mul_pp r2.xyz, r3.z, c51
    mad_pp r7.xyz, r9, r4.w, -r8
    nrm_pp r8.xyz, r7
    dp3_sat_pp r1.w, r8, r4
    pow r6.w, r1.w, r3.y
    mul_pp r2.xyz, r2, r6.w
    mad_pp r1.xyz, r2.w, r2, r1
    mad_pp r2.xyz, r9, r4.w, -c10
    mad_pp r0.yzw, r9.xxyz, r4.w, -r0
    ...
    cmp r1.xy, -r11_abs.x, v0, c2.x
    cmp r1.xy, -r11_abs.y, v0.zwzw, r1
    cmp r1.xy, -r11_abs.z, v1, r1
    cmp r1.xy, -r11_abs.w, v1.zwzw, r1
    texld_pp r1, r1, s0
