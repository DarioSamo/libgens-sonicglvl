...
//
    ...
    mov_pp r7.zw, c1
    mul_pp r7.yz, r7.xzww, c20
    max_pp r4.w, r7.y, c2.w
    min r7.y, r4.w, c3.x
    pow r8.x, r4.z, r7.y
    mul_pp r8.yzw, r7.z, c43.xxyz
    mul_pp r8.xyz, r8.x, r8.yzww
    ...
    mad_pp r11.xyz, r6, r7.x, -c10
    nrm_pp r12.xyz, r11
    dp3_sat_pp r1.w, r12, r5
    pow r2.z, r1.w, r7.y
    mul_pp r10.xyz, r2.z, r10
    mad_pp r8.xyz, r10, r1.z, r8
...
// approximately 254 instruction slots used (6 texture, 248 arithmetic)
