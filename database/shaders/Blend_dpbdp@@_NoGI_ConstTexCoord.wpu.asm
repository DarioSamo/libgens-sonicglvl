...
//
    ...
    texld_pp r8, v0, s3
    texld_pp r9, v0, s6
    lrp_pp r6.w, r9.x, r8.x, r7.x
    mul_pp r7.xy, r6.w, c20.yzzw
    mul_pp r7.xy, r7, c1.zwzw
    mul_pp r8.xyz, r7.y, c43
    add_pp r9.yzw, c22.xxyz, -v1.xxyz
    dp3_pp r6.w, r9.yzww, r9.yzww
    rsq_pp r6.w, r6.w
    mad_pp r4.yzw, r9, r6.w, -r4
