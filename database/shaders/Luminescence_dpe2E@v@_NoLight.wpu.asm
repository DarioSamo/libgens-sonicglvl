...
//
    ...
    max r5.y, v4.z, c3.x
    add r5.z, r5.y, -v4.w
    cmp r8.z, r5.z, c3.x, r5.y
    mov r8.xyw, v4
    texldp_pp r8, r8, s13
    lrp_pp r5.y, v5.z, c3.y, r8.x
    lrp_pp r7.w, r6.x, c3.y, r5.y
    texld_pp r6, v0.zwzw, s10
    mul r5.y, r6.w, r7.w
    mad_pp r8.xyz, r4, r4.w, -c10
    mul r4.xyz, r4.w, r4
    nrm_pp r9.xyz, r8
    dp3_sat_pp r4.w, r9, r7
    pow r6.w, r4.w, r5.x
    mul_pp r2.yzw, r2, r6.w
    mad_pp r2.yzw, r2, r5.y, r3
    dp3 r3.y, -r4, r7
    add r3.y, r3.y, r3.y
    mad_pp r3.yzw, r7.xxyz, -r3.y, -r4.xxyz
    texld_pp r4, r3.yzww, s5
