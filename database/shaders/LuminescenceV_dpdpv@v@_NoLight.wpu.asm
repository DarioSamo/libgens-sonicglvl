...
//
    ...
    add r6, r4.w, -c3
    cmp r1.zw, -r6_abs.x, v0.xyxy, c3.x
    cmp r1.zw, -r6_abs.y, v0, r1
    cmp r1.zw, -r6_abs.z, v1.xyxy, r1
    cmp r1.zw, -r6_abs.w, v1, r1
    texld_pp r6, r1.zwzw, s3
    lrp_pp r1.z, v6.w, r6.x, r5.x
    ...
    lrp_pp r3.yzw, r0.w, r5.xxyz, c3.y
    mad_pp r0.xyz, r0, r3.yzww, r1
    frc r1.x, c27.z
    cmp r1.y, -r1.x, c3.x, c3.y
    add r1.x, -r1.x, c27.z
    cmp r1.y, c27.z, r3.x, r1.y
    add r1.x, r1.y, r1.x
    add r1, r1.x, -c3
