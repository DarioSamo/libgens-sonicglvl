...
//
    ...
    dp3_pp r9.x, r8.yzww, r8.yzww
    rsq_pp r9.x, r9.x
    mad_pp r0.yzw, r8.xxyz, r9.x, -r0
    nrm_pp r10.xyz, r0.yzww
    dp3_sat_pp r0.y, r10, r5
    mov_pp r10.xy, c0
    mul_pp r0.zw, r10.xyxy, c20.xyyz
    max_pp r9.y, r0.z, c4.y
    min r0.z, r9.y, c0.z
    pow r9.y, r0.y, r0.z
    ...
    mul_pp r0.xyw, r0.x, r9.yzzw
    mad_pp r9.yzw, r8.xxyz, r9.x, -c10.xxyz
    mul_pp r8, r8, r9.x
    nrm_pp r10.xyz, r9.yzww
    dp3_sat_pp r9.x, r10, r5
    pow r10.x, r9.x, r0.z
    mul_pp r9.xyz, r10.x, r11
...
// approximately 208 instruction slots used (7 texture, 201 arithmetic)
