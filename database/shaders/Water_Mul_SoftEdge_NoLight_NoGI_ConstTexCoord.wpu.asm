...
//
    ...
    pow r3.w, r1.w, r2.z
    mul_pp r5.xyz, r2.z, c18
    mul_pp r4.xyz, r3.w, r4
    mul_pp r4.xyz, r5, r4
    dp3_pp r1.w, r6.wyzw, r1
    add_pp r2.z, -r1_abs.w, c9.y
    add_pp r1.w, r1.w, r1.w
    mad r1, r1.w, r1.xyzx, -r6
    mul_pp r2.z, r2.z, r2.z
    mad r2.w, r2.z, -r2.z, c9.y
    mul_pp r2.z, r2.z, r2.z
    mul r3.xyz, r2.w, r3
    mad_pp r3.xyz, r4, c77.w, r3
    mul r4.xy, c24.zwzw, vPos
    mov r5.xyz, c8
    mad r5, c24.zzww, r5.xyyz, r5.yxzy
    mad r4.xy, r4, c0.xwzw, r5
    add r4.xy, r5.zwzw, r4
    mad r2.xy, r2, c8.w, r4
    mad r2.xy, r2, c1, c1.x
    texld r5, r2, s12
    texld_pp r6, r2, s11
    rcp r2.x, v1.w
    mad r2.x, v1.z, -r2.x, r5.x
    mad r2.yw, r4.xxzy, c1.xxzy, c1.x
    texld_pp r5, r2.ywzw, s11
    texld r7, r2.ywzw, s12
    cmp_pp r2.xyw, r2.x, r6.xyzz, r5.xyzz
    cmp r4.zw, -r0_abs.x, v5.xyxy, c9.x
    cmp r0.xy, -r0_abs.y, v5.zwzw, r4.zwzw
    ...
    mad r3, r1.wyzw, c11.xxyz, c11.zzzw
    mul r5, r1, c8.xzzy
    cmp_pp r1, r1.z, r3, r5
    add_pp r1.z, r1.z, c9.y
    rcp r1.z, r1.z
    mad_pp r1.xy, r1.yxzw, r1.z, c9.y
    mad_pp r3.x, r1.y, c2.y, r1.w
    mul_pp r3.y, r1.x, c0.z
    texld_pp r1, r3, s3
    mul_pp r1.xyz, r2.z, r1
    mad_pp r1.xyz, r1, r2.x, r0
    mul r0.xy, r4.y, c5.zwzw
    mad r0.xy, r4.x, c4.zwzw, r0
    mad r0.xy, r7.x, c6.zwzw, r0
