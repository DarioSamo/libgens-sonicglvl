...
//
    ...
    add r5, r3.z, -c3
    add r6, r3.y, -c3
    cmp r3.yz, -r5_abs.x, v0.xxyw, c3.x
    cmp r3.yz, -r5_abs.y, v0.xzww, r3
    cmp r3.yz, -r5_abs.z, v1.xxyw, r3
    cmp r3.yz, -r5_abs.w, v1.xzww, r3
    texld_pp r5, r3.yzzw, s1
    mul_pp r2.xzw, r2, r5.w
    mul_pp r2.xzw, r0.x, r2
    mad_pp r0.xyz, r0.yzww, r5, r2.xzww
