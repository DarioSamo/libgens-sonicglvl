...
//
    ...
    max r3.x, v4.z, c2.x
    add r3.y, r3.x, -v4.w
    cmp r3.z, r3.y, c2.x, r3.x
    mov r3.xyw, v4
    texldp_pp r3, r3, s13
    lrp_pp r4.y, v5.z, c2.y, r3.x
    lrp_pp r3.x, r4.x, c2.y, r4.y
    texld_pp r4, v0.zwzw, s10
    mul r3.y, r3.x, r4.w
    mul_pp r2.yzw, r2, r3.y
    cmp_pp r2.yzw, r1.w, r2, c2.x
    ...
    add r0.w, r0.w, r1.w
    add r2, r0.w, -c2
    cmp r3.xz, -r2_abs.x, v0.xyyw, c2.x
    ...
    lrp_pp r3.xzw, r0.w, r2.xyyz, c2.y
