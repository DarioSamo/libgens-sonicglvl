...
//
    ...
    def c3, 1, 0, -1, 1024
    def c8, 0.212500006, 0.715399981, 0.0720999986, 4
    def c9, 0, 1, 2, 3
    dcl_texcoord v0.xyz
    dcl_texcoord1 v1
    ...
    mul r3.xyz, r2.z, r3
    mad r2.z, r1.w, -r1.w, c9.y
    mul_pp r1.w, r1.w, r1.w
    mul r3.xyz, r2.z, r3
    mad_pp r1.xyz, r1, r3.w, r3
    dp3_sat r2.z, r1, c8
    add r2.z, -r2.z, c9.y
    cmp r3.xy, -r0_abs.x, v5, c9.x
    ...
    mad r3.zw, r2.xyxy, c1.w, r3.xyxy
    mad r2.xy, r2, -c1.w, r3
    mad r2.xy, r2, c0.z, c0.z
    texld_pp r4, r2, s14
    mul_pp r2.xyw, r1.w, r4.xyzz
    mad r3.zw, r3, c2.xyxy, c2.x
    texld r4, r3.zwzw, s12
    texld_pp r5, r3.zwzw, s11
    rcp r1.w, v1.w
    mad r1.w, v1.z, -r1.w, r4.x
    mad r3.zw, r3.xyxy, c2.xyxy, c2.x
    texld_pp r4, r3.zwzw, s11
    texld r6, r3.zwzw, s12
    cmp_pp r4.xyz, r1.w, r5, r4
...
// approximately 132 instruction slots used (9 texture, 123 arithmetic)
