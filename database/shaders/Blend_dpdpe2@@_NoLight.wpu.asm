...
//
    ...
    mul r6.xy, r6, c65.y
    max r3.w, r6.x, r6.y
    lrp_pp r6.x, r3.w, c3.y, r5.w
    lrp_pp r5.w, r3.w, c3.y, r4.w
    texld_pp r7, v0.zwzw, s10
    mul r3.w, r6.x, r7.w
    mad_pp r6.xyz, r4, r1.w, -c10
    mul r4.xyz, r1.w, r4
    nrm_pp r8.xyz, r6
...
// approximately 157 instruction slots used (8 texture, 149 arithmetic)
