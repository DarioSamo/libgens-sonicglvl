...
//
    ...
    mad_pp r8.xyz, r7, r3.w, -c10
    mul_pp r7.xyz, r3.w, r7
    nrm_pp r10.xyz, r8
    dp3_sat_pp r3.w, r10, r1.yzww
    pow r5.w, r3.w, r0.z
    mul_pp r8.xyz, r5.w, r9
    mad_pp r0.xyz, r8, r1.x, r0.xyww
    mul_pp r0.xyz, r0, c18
    mad_pp r0.xyz, r0, v3.w, r2
    cmp r8.xy, -r4_abs.x, v0, c3.x
