...
//
    ...
    frc r3.w, c26.x
    cmp r5.x, -r3.w, c4.x, c4.y
    add r3.w, -r3.w, c26.x
    cmp r2.x, c26.x, r2.x, r5.x
    add r2.x, r2.x, r3.w
    add r5, r2.x, -c4
    cmp r8.xy, -r5_abs.x, v0, c4.x
    cmp r5.xy, -r5_abs.y, v0.zwzw, r8
    cmp r5.xy, -r5_abs.z, v1, r5
    cmp r5.xy, -r5_abs.w, v1.zwzw, r5
    texld_pp r5, r5, s0
    mul_pp r8.xyz, r1, r5
    mul_pp r8.w, r5.w, c16.w
    mul_pp r5, r8, v9
    ...
    mad_pp r8.xyz, r1, r2.x, -c10
    mul_pp r1.xyz, r1, r2.x
    nrm_pp r10.xyz, r8
    dp3_sat_pp r2.x, r10, r2.yzww
    pow r3.w, r2.x, r0.z
    mul_pp r8.xyz, r3.w, r9
    mad_pp r0.xyz, r8, r1.w, r0.xyww
    mul_pp r0.xyz, r0, c18
    mad_pp r0.xyz, r0, v3.w, r5
    cmp r8.xy, -r4_abs.x, v0, c4.x
    cmp r4.xy, -r4_abs.y, v0.zwzw, r8
    ...
    mad_pp r3.xyz, r4.x, r6, r3
    dp2add_pp r0.w, r4, -r4, c4.y
    rsq_pp r0.w, r0.w
    rcp_pp r0.w, r0.w
    mad_pp r3.xyz, r0.w, r7, r3
    dp3_pp r0.w, -r1, r3
    mad_pp r2.x, r0.w, -r0.w, c4.y
    mad_pp r2.x, r2.x, -c2.z, c2.w
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    mad_pp r0.w, r0.w, c3.x, r2.x
    mul_pp r3.xyz, r3, r0.w
    mad_pp r3.xyz, r1, c3.y, -r3
    texld_pp r3, r3, s6
    mul r4.xyz, r3, c63.x
    mad_pp r3.xyz, r4, r3.w, r3
    mul r0.w, c64.z, c64.x
    mov r4.xz, c64
    mad r2.x, r4.x, -r4.z, r4.z
...
// approximately 185 instruction slots used (8 texture, 177 arithmetic)
