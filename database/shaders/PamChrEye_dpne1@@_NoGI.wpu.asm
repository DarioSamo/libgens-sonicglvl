...
//
    ...
    mad_pp r3.yzw, r7.xxyz, r6.w, -c10.xxyz
    ...
    dp2add_pp r3.w, r15.zwzw, -r15.zwzw, c0.z
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    mad_pp r15.xyz, r3.w, r5, r17
    mad_pp r4.yzw, r3.z, r5.xxyz, r4
    ...
    dp4 r3.z, r14, r14
    rsq r3.z, r3.z
    mul r3.zw, r3.z, r14.xyxy
    mad_pp r3.zw, r3, c3.xyxy, c3.x
    texld_pp r14, r3.zwzw, s3
    mul r4.yzw, r14.xxyz, c63.x
    mad_pp r4.yzw, r4, r14.w, r14.xxyz
    mul_pp r4.yzw, r4, v7.w
    mul r3.z, c64.z, c64.x
    mov r5.xz, c64
    mad r3.w, r5.x, -r5.z, r5.z
    mad_pp r3.z, r5.w, r3.w, r3.z
    mul_pp r4.yzw, r3.z, r4
    mad_pp r1.yzw, r4, r3.y, r1
    mul_pp r1.yzw, r1, v3.w
    texld_pp r14, v0, s6
    texld_pp r16, v0, s0
    lrp_pp r17, r3.y, r16, r14
    mad_pp r1.yzw, r6.xxyz, r17.xxyz, r1
    dp3_sat_pp r3.z, r8, r15
    pow r4.y, r3.z, r9.z
    mul_pp r5.xyz, r9.w, c43
    mul_pp r4.yzw, r4.y, r5.xxyz
    mul_pp r4.xyz, r4.yzww, r4.x
    dp3_sat_pp r3.z, r10, r15
    pow r4.w, r3.z, r9.z
    mul_pp r5.xyz, r9.w, c39
    mul_pp r5.xyz, r4.w, r5
    mad_pp r3.xzw, r3.x, r5.xyyz, r4.xyyz
    dp3_sat_pp r4.x, r11, r15
    pow r5.x, r4.x, r9.z
    mul_pp r4.xyz, r9.w, c47
    mul_pp r4.xyz, r5.x, r4
    mad_pp r3.xzw, r2.x, r4.xyyz, r3
    dp3_sat_pp r2.x, r12, r15
    pow r4.x, r2.x, r9.z
    mul_pp r4.yzw, r9.w, c51.xxyz
    mul_pp r5.xyz, r9.w, c37
    mul_pp r4.xyz, r4.x, r4.yzww
    mad_pp r3.xzw, r1.x, r4.xyyz, r3
    dp3_sat_pp r1.x, r13, r15
    pow r2.x, r1.x, r9.z
    mul_pp r4.xyz, r2.x, r5
    mad_pp r3.xzw, r4.xyyz, r5.w, r3
    dp3_sat_pp r1.x, r7, r15
    dp3_sat_pp r2.x, r15, r2.yzww
    add_pp r2.x, -r2.x, c0.z
    pow r2.y, r1.x, r9.z
    mul_pp r0.yzw, r0, r2.y
    mad_pp r0.xyz, r0.x, r0.yzww, r3.xzww
    mul_pp r0.xyz, r0, c18
    mul_pp r0.xyz, r3.y, r0
    mul_pp r0.xyz, r17, r0
    mul_pp r0.w, r17.w, c16.w
...
// approximately 336 instruction slots used (7 texture, 329 arithmetic)
