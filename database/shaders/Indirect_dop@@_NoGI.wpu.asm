...
//
    ...
    frc r4.w, c27.x
    cmp r5.w, -r4.w, c2.x, c2.y
    add r4.w, -r4.w, c27.x
    cmp r5.w, c27.x, r2.x, r5.w
    add r4.w, r4.w, r5.w
    add r8, r4.w, -c2
    ...
    texld_pp r8, r8, s3
    mad r8.xy, r8.wxzw, c0.x, c0.y
    frc r8.zw, c26.xyxz
    cmp r9.xy, -r8.zwzw, c2.x, c2.y
    add r8.zw, -r8, c26.xyxz
    ...
    mad r8.zw, r8.xyxy, c150.xyxy, r8
    texld_pp r9, r8.zwzw, s0
    mul_pp r7.xyz, r7, r9
...
// approximately 253 instruction slots used (5 texture, 248 arithmetic)
