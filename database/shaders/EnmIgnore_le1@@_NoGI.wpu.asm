...
//
    ...
    mad_pp r2.yzw, r1.w, r2, r4.xxyz
    mul_pp r3.xzw, r9.y, c51.xyyz
    ...
    mov r1.xyz, c79
    add r1.xyz, -r1, c80
    mad_pp r3.xzw, r6.xyyz, c0.x, c0.x
    mul_pp r4.xyz, r6, r6
...
// approximately 210 instruction slots used (4 texture, 206 arithmetic)
