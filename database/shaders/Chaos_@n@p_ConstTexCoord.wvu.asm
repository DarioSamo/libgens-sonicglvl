...
//
    ...
    mul r0.w, r0.w, r1.x
    mul r1.x, r0.w, r0.w
    mad r1.y, r1.x, c225.x, c225.y
    mad r1.y, r1.x, r1.y, c225.z
    mad r1.y, r1.x, r1.y, c225.w
    mad r1.x, r1.x, r1.y, c226.x
    mul r0.w, r0.w, r1.x
    slt r1.x, r0_abs.x, r0_abs.z
    mad r1.y, r0.w, c226.y, c226.z
    mad r0.w, r1.y, r1.x, r0.w
    slt r1.x, r0.x, -r0.x
    mad r0.w, r1.x, c226.w, r0.w
    min r1.x, r0.x, r0.z
    slt r1.x, r1.x, -r1.x
    max r1.y, r0.x, r0.z
    sge r1.y, r1.y, -r1.y
    ...
    mad r0.w, r0.w, c227.x, c227.y
    frc r0.w, r0.w
    mad r0.w, r0.w, c227.z, c227.w
    sincos r1.y, r0.w
    slt r0.w, -r1.y, r1.y
    slt r1.x, r1.y, -r1.y
    add r0.w, r0.w, -r1.x
    ...
    mad r1.x, r1.x, c227.x, c227.y
    frc r1.x, r1.x
    mad r1.x, r1.x, c227.z, c227.w
    sincos r2.y, r1.x
    slt r1.x, -r2.y, r2.y
    slt r1.y, r2.y, -r2.y
    add r1.x, -r1.y, r1.x
    ...
    slt r1.z, c187.x, -c187.x
    mad r1.x, r1.z, r1.y, r1.x
    add r1.yz, c191.xxyw, v1.xxyw
    add r2.xy, c191.zwzw, v2
    add r2.zw, c192.xyxy, v3.xyxy
    mova a0.x, r1.x
    mul r1.xy, r1.yzzw, c221[a0.x].x
    mad r1.xy, c221[a0.x].y, r2, r1
    mad r1.xy, c221[a0.x].z, r2.zwzw, r1
    add r1.zw, c192, v4.xyxy
    mad o1.xy, c221[a0.x].w, r1.zwzw, r1
    mul r1.xyz, r0.w, v10
