...
//
    ...
    frc r7.xy, c27
    cmp r7.zw, -r7.xyxy, c6.x, c6.y
    add r7.xy, -r7, c27
    cmp r7.zw, c27.xyxy, r1.x, r7
    add r7.xy, r7.zwzw, r7
    add r8, r7.x, -c6
    add r7, r7.y, -c6
    cmp r9.xy, -r8_abs.x, v0, c6.x
    ...
    cmp_pp r14.xyz, r3.w, r14, c6.x
    mad_pp r12.xyz, r1.x, r14, r12
    max r3.w, v4.z, c6.x
    add r4.w, r3.w, -v4.w
    cmp r14.z, r4.w, c6.x, r3.w
    mov r14.xyw, v4
    texldp_pp r14, r14, s13
    max r3.w, v5.z, c6.x
    add r4.w, r3.w, -v5.w
    cmp r15.z, r4.w, c6.x, r3.w
    mov r15.xyw, v5
...
// approximately 300 instruction slots used (8 texture, 292 arithmetic)
