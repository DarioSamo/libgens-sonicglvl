...
//
    ...
    add_pp r2.yzw, -r2, c1.y
    nrm_pp r6.xyz, v3
    dp3_pp r3.w, r6, -r5
    mul_pp r7.xyz, r3.w, c43
    cmp_pp r7.xyz, r3.w, r7, c1.x
    mul_pp r7.xyz, r2.w, r7
    dp3_pp r3.w, r6, -r4
    mul_pp r8.xyz, r3.w, c39
    cmp_pp r8.xyz, r3.w, r8, c1.x
    ...
    max r3.w, v4.z, c1.x
    add r4.w, r3.w, -v4.w
    cmp r8.z, r4.w, c1.x, r3.w
    mov r8.xyw, v4
    texldp_pp r8, r8, s13
    max r3.w, v5.z, c1.x
    add r4.w, r3.w, -v5.w
    cmp r9.z, r4.w, c1.x, r3.w
    mov r9.xyw, v5
    texldp_pp r9, r9, s7
    min_pp r3.w, r9.x, r8.x
    lrp_pp r4.w, v6.z, c1.y, r9.x
    lrp_pp r5.w, v6.z, c1.y, r3.w
    rcp r3.w, v4.w
    mul r8.xy, r3.w, v4
    mad r8.xy, r8, c2.y, c2.z
    abs_sat r8.xy, r8
    add_sat r8.xy, r8, -c65.x
    mul r8.xy, r8, c65.y
    max r3.w, r8.x, r8.y
    lrp_pp r6.w, r3.w, c1.y, r5.w
    lrp_pp r5.w, r3.w, c1.y, r4.w
    mul_pp r3.w, r6.w, c77.w
    dp3_pp r4.w, r6, -c10
    mul r8.xyz, r4.w, c36
    mul_pp r8.xyz, r3.w, r8
    cmp_pp r8.xyz, r4.w, r8, c1.x
    add_pp r7.xyz, r7, r8
    ...
    frc r4.w, c26.x
    cmp r5.w, -r4.w, c1.x, c1.y
    add r4.w, -r4.w, c26.x
    cmp r2.x, c26.x, r2.x, r5.w
    add r2.x, r2.x, r4.w
    add r8, r2.x, -c1
    cmp r9.xy, -r8_abs.x, v0, c1.x
    ...
    dp3_pp r2.x, r9, r9
    rsq_pp r2.x, r2.x
    mad_pp r5.xyz, r9, r2.x, -r5
    nrm_pp r10.xyz, r5
    dp3_sat_pp r4.w, r10, r6
    mov_pp r5.xy, c0
    mul_pp r5.xy, r5, c20.yzzw
    max_pp r6.w, r5.x, c1.y
    min r5.x, r6.w, c0.z
    pow r6.w, r4.w, r5.x
...
// approximately 241 instruction slots used (4 texture, 237 arithmetic)
