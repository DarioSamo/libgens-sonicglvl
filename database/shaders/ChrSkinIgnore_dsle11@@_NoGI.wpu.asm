...
//
    ...
    dp3_pp r0.w, r8, r6
    add_sat_pp r2.x, -r0.w, c0.z
    add_pp r0.w, r0.w, r0.w
    mad_pp r2.yzw, r0.w, r6.xxyz, -r8.xxyz
    pow_pp r0.w, r2.x, c150.z
    mul r0.w, r0.w, c150.y
    mad_pp r0.w, r0.w, r1.x, c150.x
    mad_pp r6.xyz, r2.yzww, c0.x, c0.x
    mul_pp r2.xyz, r2.yzww, r2.yzww
    mad r1.xyz, r6.y, r1.yzww, c79
    mul r1.xyz, r1, r2.y
    mad r5.xyz, r6.x, r5, c77
    mad r3.xyz, r6.z, r3.xzww, c81
    mad_pp r1.xyz, r2.x, r5, r1
...
// approximately 228 instruction slots used (6 texture, 222 arithmetic)
