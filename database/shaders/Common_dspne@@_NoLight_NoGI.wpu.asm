...
//
    ...
    add r0.z, r5.z, c3.y
    rcp r0.z, r0.z
    mad r1.xw, r5.yyzx, r0.z, c3.y
    mad_pp r5.x, r1.w, c0.w, r5.w
    mul_pp r5.y, r1.x, c2.x
    texld_pp r5, r5, s5
    ...
    mad_pp r3.xyz, r4.wyzw, c2.x, c2.x
...
// approximately 199 instruction slots used (7 texture, 192 arithmetic)
