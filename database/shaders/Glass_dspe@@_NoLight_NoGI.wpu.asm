...
//
    ...
    frc r2.xzw, c26
    cmp r4.xyz, -r2.xzww, c3.x, c3.y
    add r2.xzw, -r2, c26
    cmp r3.xzw, c26, r3.x, r4.xyyz
    add r2.xzw, r2, r3
    add r4, r2.w, -c3
    ...
    mov r1.xyz, c79
    add r1.xyz, -r1, c80
    mad_pp r3.xyz, r6.wyzw, c0.x, c0.x
