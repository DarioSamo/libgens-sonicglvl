...
//
    ...
    mad_pp r12.xyz, r7, r5.w, -r3.yzww
    dp3_pp r3.y, r8.wyzw, -r3.yzww
    nrm_pp r13.xyz, r12
    dp3_sat_pp r3.z, r13, r8
    pow r4.y, r3.z, r9.x
    ...
    pow r3.z, r0.z, r9.x
    mul_pp r5.yzw, r3.z, r9
    mad_pp r5.yzw, r1.x, r5, r10.xxyz
    dp3 r0.z, r7.yzww, r8.yzww
    add r0.w, r0.z, r0.z
    mov_sat_pp r0.z, r0.z
    add_pp r0.z, -r0.z, c4.x
    mad r7, r0.w, r8, -r7
    mad r9, r7.wyzw, c2.xxyz, c2.zzzw
    mul r10, r7, c2.yxxz
    cmp r7, r7.z, r9, r10
    add r0.w, r7.z, c4.x
    rcp r0.w, r0.w
    mad r3.zw, r7.xyyx, r0.w, c4.x
    mad_pp r7.x, r3.w, c3.x, r7.w
    mul_pp r7.y, r3.z, c1.w
    texld_pp r7, r7, s5
    mul r9.xyz, r7, c63.x
    ...
    dp3_pp r3.z, r8.wyzw, -r6
    dp3_pp r3.w, r8.wyzw, -c10
...
// approximately 241 instruction slots used (5 texture, 236 arithmetic)
