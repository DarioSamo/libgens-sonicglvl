...
//
    ...
    cmp_pp r1.x, -c61.x, r5.z, r1.x
    mul_pp r0.x, r0.x, r1.x
    mul_pp r5.xyz, c58.w, c58
    mul r5.xyz, r0.x, r5
    dp3_pp r1.x, r1.yzww, -r4
    mov_sat_pp r2.w, r1.x
    mov_sat_pp r1.x, -r1.x
    mul r6.xyz, r1.x, r5
    mul r5.xyz, r2.w, r5
    dp3_pp r1.x, r1.yzww, -c10
    mov_sat_pp r3.w, r1.x
    mov_sat_pp r1.x, -r1.x
    mad_pp r6.xyz, r2, r1.x, r6
    mad_pp r2.xyz, r2, r3.w, r5
    mul r3.xyz, r3.w, r3
    mad_pp r0.yzw, r2.xxyz, c16.xxyz, r0
    mul_pp r2.xyz, r6, c16
    texld_pp r5, v0, s0
    mul_pp r2.xyz, r2, r5
    mul r2.xyz, r2, c150
    mad_pp r0.yzw, r0, r5.xxyz, r2.xxyz
