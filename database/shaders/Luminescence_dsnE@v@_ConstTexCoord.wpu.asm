...
//
    ...
    max r1.z, v3.z, c1.w
    add r1.w, r1.z, -v3.w
    cmp r9.z, r1.w, c1.w, r1.z
    mov r9.xyw, v3
    texldp_pp r9, r9, s13
    lrp_pp r1.z, v4.z, c0.w, r9.x
...
// approximately 247 instruction slots used (7 texture, 240 arithmetic)
