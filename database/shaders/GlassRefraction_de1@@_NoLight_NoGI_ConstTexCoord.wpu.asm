...
//
    ...
    lrp_pp r1.x, v5.z, c1.y, r3.x
    lrp_pp r1.y, v5.z, c1.y, r2.x
    rcp r1.z, v3.w
    mul r1.zw, r1.z, v3.xyxy
    mad r1.zw, r1, c0.x, c0.z
    abs_sat r1.zw, r1
    add_sat r1.zw, r1, -c65.x
    mul r1.zw, r1, c65.y
    max r2.x, r1.z, r1.w
    lrp_pp r3.x, r2.x, c1.y, r1.y
    lrp_pp r3.y, r2.x, c1.y, r1.x
    mul r1.x, r3.x, c77.w
    nrm_pp r4.xyz, v2
    dp3_pp r1.y, r4, -c10
    mul r3.xzw, r1.y, c36.xyyz
    mul_pp r3.xzw, r1.x, r3
    cmp_pp r1.yzw, r1.y, r3.xxzw, c1.z
    mul_pp r3.xzw, c58.w, c58.xyyz
    dp3_pp r2.x, r4, -r0.yzww
    mul_pp r3.xzw, r2.x, r3
    cmp_pp r3.xzw, r2.x, r3, c1.z
    ...
    mad r2.xz, r3.xyyw, c0.xyyw, r5.xyyw
    add_pp r2.xz, r5.zyww, r2
    mul r2.w, c150.x, c150.x
    mul r3, r4.y, c91
    mad r3, r4.x, c90, r3
    mad r3, r4.z, c92, r3
    mad r4.w, r3.z, -r3.z, c1.y
    mad r2.w, r2.w, -r4.w, c1.y
    cmp r4.w, r2.w, c1.y, c1.z
    mul r2.w, r2.w, r4.w
    mul r4.w, r4.w, c150.x
    rsq r2.w, r2.w
    rcp r2.w, r2.w
    mad r2.w, r4.w, -r3.z, r2.w
    mul_pp r5.xy, r3, r2.w
    mad_pp r2.xz, r5.xyyw, c2.w, r2
    mad r2.xz, r2, c3.xyyw, c3.x
    texld_pp r5, r2.xzzw, s11
    texld_pp r6, v0, s0
    mad r1.yzw, r1, r6.xxyz, -r5.xxyz
    mul_pp r2.x, r6.w, c16.w
    mad_pp r2.z, c16.w, -r6.w, r2.y
    mad_pp r1.yzw, r2.x, r1, r5.xxyz
    add_pp r5.xyz, c22, -v1
    dp3_pp r2.x, r5, r5
    rsq_pp r2.x, r2.x
    mad_pp r0.yzw, r5.xxyz, r2.x, -r0
    nrm_pp r6.xyz, r0.yzww
    dp3_sat_pp r0.y, r6, r4
    mov_pp r6.xy, c2
    mul_pp r0.zw, r6.xyxy, c20.xyyz
    max_pp r2.w, r0.z, c1.y
    min r0.z, r2.w, c2.z
    pow r2.w, r0.y, r0.z
