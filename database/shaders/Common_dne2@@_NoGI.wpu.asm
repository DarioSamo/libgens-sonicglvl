...
//
    ...
    max r1.w, v4.z, c2.x
    add r3.x, r1.w, -v4.w
    cmp r3.z, r3.x, c2.x, r1.w
    mov r3.xyw, v4
    texldp_pp r3, r3, s13
    max r1.w, v5.z, c2.x
    add r3.y, r1.w, -v5.w
    cmp r4.z, r3.y, c2.x, r1.w
    mov r4.xyw, v5
    texldp_pp r4, r4, s7
    min_pp r1.w, r4.x, r3.x
    lrp_pp r3.x, v6.z, c2.y, r4.x
    lrp_pp r3.y, v6.z, c2.y, r1.w
    rcp r1.w, v4.w
    mul r3.zw, r1.w, v4.xyxy
    mad r3.zw, r3, c0.y, c0.z
    abs_sat r3.zw, r3
    add_sat r3.zw, r3, -c65.x
    mul r3.zw, r3, c65.y
    max r1.w, r3.z, r3.w
    lrp_pp r4.x, r1.w, c2.y, r3.y
    lrp_pp r4.y, r1.w, c2.y, r3.x
    mul r1.w, r4.x, c77.w
    ...
    mad_pp r1.xyz, r2.yzww, c0.x, c0.x
    mov r3.xyz, c79
    add r3.xyz, -r3, c80
    mad r3.xyz, r1.y, r3, c79
    mul_pp r4.xzw, r2.yyzw, r2.yyzw
    mul r3.xyz, r3, r4.z
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    ...
    mad_pp r1.xyz, r4.w, r1, r3
    mul_pp r3.xyz, r1, c17
    mul r3.xyz, r3, c70.w
    mad r1.xyz, r1, c17, -r3
    mad_pp r1.xyz, r4.y, r1, r3
    add_pp r0.xyz, r0, r1
    ...
    lrp_pp r1.xyz, r0.w, r3, c2.y
    add_pp r3.xyz, c22, -v2
    nrm r5.xyz, r3
    dp3 r0.w, -r5, r2.yzww
    add r0.w, r0.w, r0.w
    mad_pp r2.xyz, r2.yzww, -r0.w, -r5
    texld_pp r2, r2, s5
    mul r3.xyz, r2, c63.x
