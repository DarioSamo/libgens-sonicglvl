...
//
    ...
    add r1.yz, -r1, c26.xwxw
    cmp r2.xy, c26.wxzw, r2.x, r2.yzzw
    ...
    dp3 r1.z, v3, v3
    rsq r1.z, r1.z
    mul r3.xzw, r1.z, v3.xyyz
    mad_pp r2.xyz, r1.y, r3.xzww, r2
    mad r1.yzw, v3.xxyz, r1.z, -r2.xxyz
    mad r1.yzw, v9.x, r1, r2.xxyz
