...
//
    ...
    dp3 r0.z, -r2.xzww, r10
    add r0.z, r0.z, r0.z
    mad_pp r2.xzw, r10.xyyz, -r0.z, -r2
    texld_pp r8, r2.xzww, s5
    mul r2.xzw, r8.xyyz, c63.x
    mad_pp r2.xzw, r2, r8.w, r8.xyyz
    mul_pp r2.xzw, r7.x, r2
    mul r0.z, c64.z, c64.x
    mov r8.xz, c64
    mad r0.w, r8.x, -r8.z, r8.z
    mad_pp r0.z, r1.x, r0.w, r0.z
    mul_pp r2.xzw, r0.z, r2
    mad_pp r2.xzw, r7.yyzw, c18.xyyz, r2
