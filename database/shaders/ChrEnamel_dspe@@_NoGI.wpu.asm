...
//
    ...
    mad_pp r10.xyz, r9, r4.w, -c10
    nrm_pp r12.xyz, r10
    dp3_sat_pp r2.y, r12, r11
    pow r3.z, r2.y, r5.w
    mul_pp r8.xyz, r3.z, r8
    mad_pp r7.xzw, r8.xyyz, r1.x, r7
    mul_pp r8.xyz, c59.w, c59
    mul_pp r8.xyz, r7.y, r8
    mad_pp r10.xyz, r9, r4.w, -r0.yzww
    dp3_pp r0.y, r11.wyzw, -r0.yzww
    mul_pp r9, r4.w, r9
    nrm_pp r12.xyz, r10
    dp3_sat_pp r0.z, r12, r11
    pow r2.y, r0.z, r5.w
    mul_pp r4.yzw, r2.y, r8.xxyz
    mad_pp r4.yzw, r0.x, r4, r7.xxzw
    mul_pp r4.yzw, r4, c18.xxyz
    mul r0.z, c64.z, c64.x
    mov r7.xz, c64
    mad r0.w, r7.x, -r7.z, r7.z
    mad_pp r0.z, r1.x, r0.w, r0.z
    dp3_pp r0.w, r9.yzww, r11.yzww
    add_pp r0.w, r0.w, r0.w
    mad r7, r0.w, r11, -r9
    mad r8, r7.wyzw, c4.xxyz, c4.zzzw
    mul r9, r7, c1.yzzw
    cmp_pp r7, r7.z, r8, r9
    add_pp r0.w, r7.z, c3.z
    rcp r0.w, r0.w
    mad_pp r2.yz, r7.xyxw, r0.w, c3.z
    mad_pp r7.x, r2.z, c2.x, r7.w
    mul_pp r7.y, r2.y, c3.x
    texld_pp r7, r7, s3
    mul r8.xyz, r7, c63.x
    mad_pp r7.xyz, r8, r7.w, r7
    mul_pp r7.xyz, r6.w, r7
    mul_pp r7.xyz, r0.z, r7
    mad_pp r4.yzw, r4, r6.xxyz, r7.xxyz
    mul_pp r4.yzw, r4, v2.w
    dp3_pp r0.z, r11.wyzw, -r5
    ...
    mov r1.xyz, c79
    add r1.xyz, -r1, c80
    mad_pp r2.xyz, r11.wyzw, c3.x, c3.x
    mul_pp r3.xzw, r11.wyyz, r11.wyyz
...
// approximately 244 instruction slots used (5 texture, 239 arithmetic)
