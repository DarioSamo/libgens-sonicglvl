...
//
    ...
    mad_pp r10.xy, r10, c0.y, c0.z
    mul_pp r7.xyz, r7, r10.y
    mad_pp r7.xyz, r10.x, r8, r7
    dp2add_pp r4.w, r10, -r10, c0.w
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    ...
    dp3_pp r4.w, r6, r6
    rsq_pp r4.w, r4.w
    mad_pp r8.xyz, r6, r4.w, -r5
    dp3_pp r5.x, r7, -r5
    nrm_pp r9.xyz, r8
    dp3_sat_pp r5.y, r9, r7
    texld_pp r8, v0, s2
    mul_pp r5.zw, r8.x, c20.xyyz
    mul_pp r5.zw, r5, c2.xyxy
    max_pp r6.w, r5.z, c0.w
    min r5.z, r6.w, c1.w
    pow r6.w, r5.y, r5.z
    mul_pp r8.yzw, r5.w, c43.xxyz
    ...
    mad_pp r9.xyz, r6, r4.w, -c10
    nrm_pp r10.xyz, r9
    dp3_sat_pp r2.y, r10, r7
    pow r3.z, r2.y, r5.z
    mul_pp r9.xyz, r5.w, c37
    mul_pp r9.xyz, r3.z, r9
    mad_pp r8.yzw, r9.xxyz, r1.x, r8
    mul_pp r9.xyz, c59.w, c59
    mul_pp r9.xyz, r5.w, r9
    mad_pp r10.xyz, r6, r4.w, -r0.yzww
    dp3_pp r0.y, r7, -r0.yzww
    mul r4.yzw, r4.w, r6.xxyz
    nrm_pp r6.xyz, r10
    dp3_sat_pp r0.z, r6, r7
    pow r2.y, r0.z, r5.z
    mul_pp r5.yzw, r2.y, r9.xxyz
    mad_pp r5.yzw, r0.x, r5, r8
    dp3 r0.z, -r4.yzww, r7
    add r0.z, r0.z, r0.z
    mad_pp r4.yzw, r7.xxyz, -r0.z, -r4
    texld_pp r6, r4.yzww, s5
    mul r4.yzw, r6.xxyz, c63.x
    mad_pp r4.yzw, r4, r6.w, r6.xxyz
