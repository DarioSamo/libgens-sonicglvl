...
//
    ...
    dp4 r0.w, r7, r7
    rsq r0.w, r0.w
    mul r2.yz, r0.w, r7.xxyw
    mad_pp r2.yz, r2, c2, c2.y
    texld_pp r7, r2.yzzw, s3
    mul r8.xyz, r7, c63.x
...
// approximately 239 instruction slots used (5 texture, 234 arithmetic)
