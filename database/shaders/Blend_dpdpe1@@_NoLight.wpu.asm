...
//
    ...
    max r1.w, v4.z, c4.x
    add r3.w, r1.w, -v4.w
    cmp r4.z, r3.w, c4.x, r1.w
    mov r4.xyw, v4
    texldp_pp r4, r4, s13
    max r1.w, v5.z, c4.x
    add r3.w, r1.w, -v5.w
    cmp r7.z, r3.w, c4.x, r1.w
    mov r7.xyw, v5
    texldp_pp r7, r7, s7
    min_pp r1.w, r7.x, r4.x
    lrp_pp r3.w, v6.z, c4.y, r7.x
    lrp_pp r4.x, v6.z, c4.y, r1.w
    rcp r1.w, v4.w
    mul r4.yz, r1.w, v4.xxyw
    mad r4.yz, r4, c0.x, c0.y
    abs_sat r4.yz, r4
    add_sat r4.yz, r4, -c65.x
    mul r4.yz, r4, c65.y
    max r1.w, r4.y, r4.z
    lrp_pp r5.w, r1.w, c4.y, r4.x
    lrp_pp r4.x, r1.w, c4.y, r3.w
    ...
    mad_pp r1.z, r1.w, r2.w, r1.z
    mul_pp r3.xyz, r1.z, r3
    mad_pp r2.xyz, r2, c18, r3
    mul_pp r2.xyz, r2, v3.w
    mul_pp r3.xyz, r7, r7
    dp3_pp r1.z, r3, c1
    mad_pp r3.xyz, r7, r7, -r1.z
