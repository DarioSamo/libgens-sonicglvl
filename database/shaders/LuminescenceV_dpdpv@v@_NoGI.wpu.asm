...
//
    ...
    lrp_pp r4.w, v7.w, r10.x, r9.x
    mul_pp r8.zw, r4.w, c20.xyyz
    mul_pp r8.zw, r8, c1.xyxy
    mul_pp r9.xyz, r8.w, c43
    max_pp r4.w, r8.z, c2.y
    min r5.w, r4.w, c1.z
    add_pp r10.xyz, c22, -v2
    dp3_pp r4.w, r10, r10
    rsq_pp r4.w, r4.w
    mad_pp r5.xyz, r10, r4.w, -r5
    nrm_pp r11.xyz, r5
    ...
    mad_pp r1.yzw, r10.xxyz, r4.w, -r1
    ...
    mad_pp r3.xyz, r10, r4.w, -c10
    mad_pp r0.yzw, r10.xxyz, r4.w, -r0
    ...
    lrp_pp r2.yzw, r0.w, r4.xxyz, c2.y
