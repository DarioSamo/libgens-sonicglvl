...
//
    ...
    dp3_pp r2.x, r0, r0
    rsq_pp r2.x, r2.x
    mad_pp r0.xyz, r0, r2.x, -c10
    nrm_pp r2.xyz, r0
    dp3_sat_pp r0.x, r2, r3
    mov r2.w, c2.w
    mul_pp r0.y, r2.w, c20.y
    exp r0.y, r0.y
    ...
    mad_pp r1.xyz, r0, v6.w, r1
    dsy_pp r0.xy, v0
    mul_pp r0.xy, r0, r0
    dsx_pp r0.zw, v0.xyxy
    mad_pp r0.xy, r0.zwzw, r0.zwzw, r0
    max_pp r2.x, r0.x, r0.y
    log_pp r0.x, r2.x
    mad r0.y, r0.x, -c0.x, c0.y
    cmp r0.x, r0.x, r0.y, c0.y
    cmp_pp r0, r0.x, r1, c1_abs.yyyw
    texld_pp r1, v6.yxzw, s9
    mad_pp oC0.xyz, r0, r1.w, r1
    mov_pp oC0.w, r0.w

// approximately 117 instruction slots used (9 texture, 108 arithmetic)
