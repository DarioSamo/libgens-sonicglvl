...
//
    ...
    nrm_pp r16.xyz, r13
    dp3_sat_pp r1.w, r16.yzxw, r10.yzww
    ...
    nrm_pp r19.xyz, r18
    dp3_sat_pp r1.z, r19.yzxw, r10.yzww
    ...
    rsq_pp r3.z, r3.z
    rcp_pp r3.z, r3.z
    mad_pp r18.xyz, r3.z, r10.wyzw, r22
    mad_pp r21.xyz, r3.y, r10.wyzw, r21
    dp3_sat_pp r3.y, r20, r21
    pow_pp r4.w, r3.y, r1.z
    mul_pp r1.z, r1.w, r4.w
    mul_pp r20.xyz, r1.z, c150
    mad_pp r12.xyz, r12, c18, r20
    dp3_pp r1.z, r10.wyzw, r9
    add_pp r1.w, r1.z, r1.z
    mov_sat_pp r1.z, r1.z
    mad_pp r20, r1.w, r10, -r9.xyzx
    dp3_sat_pp r1.w, r18, r9
    add_pp r1.w, -r1.w, c0.z
    mul_pp r9, r20.wyzw, c4.xxyz
    mad_pp r21, r20, c4.yxxz, c4.zzzw
    cmp_pp r9, r20.z, r9, r21
    add_pp r3.y, r9.z, c0.z
    rcp r3.y, r3.y
    mad_pp r3.yz, r9.xyxw, r3.y, c0.z
    ...
    dp3_sat_pp r1.x, r19, r18
    pow_pp r2.w, r1.x, r3.w
    pow_pp r1.x, r0.w, r3.w
    mul_pp r0.w, r1.x, r1.y
    mad_pp r1.xyz, r0.w, c37, r2
    mul_pp r0.w, r2.w, c20.z
    mad_pp r1.xyz, r0.w, r13, r1
...
// approximately 252 instruction slots used (6 texture, 246 arithmetic)
