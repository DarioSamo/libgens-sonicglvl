...
//
    ...
    mad r12, r9, c1.yxxz, c1.zzzw
    cmp r9, r9.z, r11, r12
    add r4.w, r9.z, c0.w
    rcp r4.w, r4.w
    mad r9.xy, r9.yxzw, r4.w, c0.w
    mad_pp r11.x, r9.y, c2.x, r9.w
    mul_pp r11.y, r9.x, c0.x
    texld_pp r9, r11, s5
    mul r4.w, c64.z, c64.x
    mov r11.xz, c64
    mad r6.w, r11.x, -r11.z, r11.z
    mad_pp r4.w, r5.w, r6.w, r4.w
    texld r11, v0, s1
    mul r6.w, r11.w, c63.x
    mul r4.w, r4.w, r6.w
    mul_pp r9.xyz, r4.w, r9
    mad_pp r3.yzw, r3, c18.xxyz, r9.xxyz
    mul_pp r3.yzw, r11.xxyz, r3
    mul_pp r3.yzw, r3, v2.w
    dp3_sat_pp r4.w, r10.wyzw, -r7
    dp3_sat_pp r6.w, r10.wyzw, -c10
    mul r5.w, r5.w, r6.w
    mul_pp r5.xyz, r5, r5
