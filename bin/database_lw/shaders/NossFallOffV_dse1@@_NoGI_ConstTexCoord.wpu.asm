...
//
    ...
    dp4 r0.w, r5, r5
    rsq r0.w, r0.w
    mul r1.yw, r0.w, r5.xxzy
    mad_pp r1.yw, r1, c0.xxzw, c0.x
    texld_pp r5, r1.ywzw, s5
    texld r9, v0, s1
    mul r0.w, r9.w, c63.x
    mul r0.w, r0.w, c64.z
    mul_pp r5.xyz, r0.w, r5
    ...
    mul r0.w, r0.w, c77.w
    mad_pp r1.xyw, r0.w, c36.xyzz, r1
    ...
    mad_pp r0.xyz, r1.xyww, r0, r3.yzww
    mov_pp r0.w, c150.w
...
// approximately 146 instruction slots used (4 texture, 142 arithmetic)
