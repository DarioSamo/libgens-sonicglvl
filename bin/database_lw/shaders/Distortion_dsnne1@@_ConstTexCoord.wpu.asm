...
//
    ...
    texld r6, v1, s3
    texld r7, v1, s4
    lrp_pp r8.yzw, c2.x, r7.xxyw, r6.xxyw
    mul_pp r8.x, r8.w, r8.y
    mad_pp r6.xy, r8.xzzw, c2.y, c2.z
    mul_pp r5.xyz, r5, r6.y
    nrm_pp r7.xyz, v5
    mad_pp r5.xyz, r6.x, r7, r5
    dp2add_sat_pp r0.w, r6, r6, c2.w
    add r0.w, -r0.w, -c2.z
    rsq r0.w, r0.w
    rcp_pp r0.w, r0.w
    nrm_pp r6.xyz, v3
    ...
    mad_pp r1.y, r0.w, -c2.y, -c2.z
    mov r1.z, c2.z
    dp2add_pp r1.x, vPos.x, c24.z, r1.z
    mad_pp r1.xy, r4, c1.x, r1
