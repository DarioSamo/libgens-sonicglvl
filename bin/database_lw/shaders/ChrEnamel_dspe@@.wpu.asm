...
//
    ...
    add_pp r11.xyz, r9.wyzw, r9.wyzw
    nrm_pp r12.xyz, r11
    dp3_sat_pp r4.w, r12, r10
    ...
    mad_pp r9, r4.w, r10, -r9
    mul_pp r11, r9.wyzw, c2.xxyz
    mad_pp r12, r9, c2.yxxz, c2.zzzw
    cmp_pp r9, r9.z, r11, r12
    add_pp r4.w, r9.z, c0.w
    rcp r4.w, r4.w
    mad_pp r9.xy, r9.yxzw, r4.w, c0.w
    mad_pp r11.x, r9.y, c1.x, r9.w
    ...
    mov r11.xz, c64
    mad r5.w, r11.x, -r11.z, r11.z
    mad_pp r4.w, c77.w, r5.w, r4.w
    mul_pp r9.xyz, r4.w, r9
    mad_pp r3.yzw, r3, r5.xxyz, r9.xxyz
