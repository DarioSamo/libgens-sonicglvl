...
//
    ...
    dp3 r0.x, r0, c23
    mov_pp r2.zw, c2
    mul_pp r0.yz, r2.xzww, c20
    max_pp r2.z, r0.y, c6.y
    min_pp r0.y, r2.z, c1.w
    mul_pp r2.z, r0.y, c3.x
    exp_pp r2.z, r2.z
    mul_pp r2.z, r2.z, c3.y
    pow_pp r3.x, r1.w, r2.z
    mul_pp r0.z, r0.z, r3.x
    mul_pp r3.xyz, r0.z, c37
    mul_pp r4.xyz, r0.y, c18
    pow r1.w, r0_abs.x, r0.y
    mul_pp r0.xyz, r3, r4
