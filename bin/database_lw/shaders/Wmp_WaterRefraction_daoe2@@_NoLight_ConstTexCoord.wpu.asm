...
//
    ...
    rsq_pp r0.y, r0.y
    mul r5.xyz, r0.y, r4
    mad_pp r4.xyz, r4, r0.y, -c10
    nrm_pp r6.xyz, r4
    dp3_sat_pp r0.y, r6, r1
    dp3 r3.z, -r5, r1
    add r3.z, r3.z, r3.z
    mad_pp r4.xyz, r1, -r3.z, -r5
    dp3_sat_pp r1.x, r1, r5
    add_pp r1.x, -r1.x, c3.y
    mad_pp r5.xy, r0.zwzw, c151, r4
    mov_pp r5.z, -r4.z
    texld_pp r4, r5, s1
    ...
    pow_pp r3.z, r0.y, r1.y
    mul_pp r0.y, r2.w, r3.z
