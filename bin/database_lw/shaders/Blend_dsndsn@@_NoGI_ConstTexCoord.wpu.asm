...
//
    ...
    mad_pp r7.xyw, r6.xyzz, r0.w, -r0.xyzz
    dp3_sat_pp r0.x, r5, -r0
    mad_pp r0.xyz, r0.x, r1, r3
    nrm_pp r3.xyz, r7.xyww
    ...
    mul r4.xyz, r1.w, c51
    mad_pp r7.xyw, r6.xyzz, r0.w, -r3.xyzz
    dp3_sat_pp r1.w, r5, -r3
    ...
    mul_pp r0.w, r7.z, c77.w
    mul_pp r0.w, r1.w, r0.w
    mad_pp r1.xyz, r0.w, c37, r1
    mul_pp r1.xyz, r1, c18
    texld_pp r3, v0, s2
    texld_pp r4, v1, s3
    lrp_pp r6.xyz, v7.w, r3, r4
    mul_pp r1.xyz, r1, r6
    mul_pp r1.xyz, r1, v3.w
    mad_pp r3.xyz, r5, c0.w, c0.w
    mov r4.xyz, c80
...
// approximately 145 instruction slots used (7 texture, 138 arithmetic)
