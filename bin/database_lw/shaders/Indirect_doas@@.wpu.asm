...
//
    ...
    pow_pp r3.w, r2.z, r0.w
    mul_pp r2.z, r3.w, c20.z
    mad_pp r4.xyz, r2.z, r11, r4
    ...
    mul_pp r2.z, r10.w, c20.z
    mul_pp r2.z, r3.w, r2.z
    mad_pp r4.xyz, r2.z, c37, r4
    mul_pp r12.xyz, r1.w, c59
    mul r13.xyz, r1.w, c58
    add_pp r14.xyz, r8, r8
    dp3_sat_pp r1.w, r9, r8
    nrm_pp r8.xyz, r14
    dp3_sat_pp r2.z, r8, r9
    pow_pp r3.w, r2.z, r0.w
    mul_pp r0.w, r3.w, c20.z
    mad_pp r4.xyz, r0.w, r12, r4
    mul_pp r4.xyz, r4, c18
    mul_pp r0.xyz, r0, r4
    mul_pp r0.xyz, r0, v3.w
    dp3_sat_pp r0.w, r9, -r6
    dp3_sat_pp r2.z, r9, -c10
    mul r2.z, r2.z, r10.w
    mul_pp r4.xyz, r10, r10
    mul_pp r6.xyz, r7, r0.w
    mad_pp r5.xyz, r2.w, r5, r6
    mad_pp r3.xyz, r2.x, r3, r5
    mad_pp r2.xyw, r2.y, r11.xyzz, r3.xyzz
    mad_pp r2.xyz, r2.z, c36, r2.xyww
    mad_pp r2.xyz, r1.w, r13, r2
