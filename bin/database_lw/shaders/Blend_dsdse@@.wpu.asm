...
//
    ...
    add_pp r13.xyz, r9.wyzw, r9.wyzw
    nrm_pp r14.xyz, r13
    dp3_sat_pp r0.y, r14, r10
    pow_pp r1.w, r0.y, r0.w
    mul_pp r0.y, r1.w, c20.z
    mad_pp r0.yzw, r0.y, r11.xxyz, r3
    dp3_pp r1.w, r10.yzww, r9.yzww
    add r3.y, r1.w, r1.w
    mov_sat_pp r1.w, r1.w
    mad r9, r3.y, r10, -r9
    mul r11, r9.wyzw, c1.xxyz
    mad r13, r9, c1.yxxz, c1.zzzw
    cmp r9, r9.z, r11, r13
    add r3.y, r9.z, c0.z
    rcp r3.y, r3.y
    mad r3.yz, r9.xyxw, r3.y, c0.z
    mad_pp r9.x, r3.z, c2.x, r9.w
    mul_pp r9.y, r3.y, c0.w
    texld_pp r9, r9, s5
    texld_pp r11, v0, s2
    texld_pp r13, v1, s3
    lrp r14, v5.w, r11, r13
    mul r3.y, r14.w, c63.x
    mul r3.z, c64.z, c64.x
    mov r11.xz, c64
    mad r3.w, r11.x, -r11.z, r11.z
    mad_pp r3.z, r5.w, r3.w, r3.z
    mul r3.y, r3.z, r3.y
    mul_pp r3.yzw, r3.y, r9.xxyz
    mad_pp r0.yzw, r0, c18.xxyz, r3
    mul_pp r0.yzw, r14.xxyz, r0
    mul_pp r0.yzw, r0, v3.w
    dp3_sat_pp r3.y, r10.wyzw, -r7
    dp3_sat_pp r3.z, r10.wyzw, -c10
    mul r3.z, r3.z, r5.w
    mul_pp r5.xyz, r5, r5
    mul_pp r7.xyz, r8, r3.y
    mad_pp r6.xyz, r2.w, r6, r7
    mad_pp r3.xyw, r3.x, r4.xyzz, r6.xyzz
    mad_pp r1.xyz, r0.x, r1, r3.xyww
    mad_pp r1.xyz, r3.z, c36, r1
