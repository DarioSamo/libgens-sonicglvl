...
//
    ...
    mad_pp r3.w, r0.w, -r0.w, c2.w
    mul_pp r4.x, c150.x, c150.x
    mad_pp r3.w, r4.x, -r3.w, c2.w
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    mad r0.w, c150.x, r0.w, -r3.w
    mad_pp r1, r1, r0.w, -r2
    mul_pp r2, r1.wyzw, c2.yywz
    mad_pp r4, r1, c1.xyyz, c1.zzzw
    ...
    texld_pp r1, r2, s6
    mul_pp r1.xyz, r3, r1
    mul_pp r2, r7.wyzw, c2.yywz
    mad_pp r4, r7, c1.xyyz, c1.zzzw
    cmp_pp r2, r7.z, r2, r4
    add_pp r0.w, r2.z, c2.w
    rcp r0.w, r0.w
    mad_pp r2.xy, r2.yxzw, r0.w, c2.w
    mad_pp r4.x, r2.y, c0.w, r2.w
    mul_pp r4.y, r2.x, c0.z
    texld_pp r2, r4, s5
    mul_pp r2.xyz, r3, r2
