...
//
    ...
    mul_pp r11, r7.wyzw, c2.xxyz
    mad_pp r12, r7, c2.yxxz, c2.zzzw
    cmp_pp r7, r7.z, r11, r12
    add_pp r0.w, r7.z, c0.w
    rcp r0.w, r0.w
    mad_pp r1.zw, r7.xyyx, r0.w, c0.w
    mad_pp r7.x, r1.w, c1.x, r7.w
    mul_pp r7.y, r1.z, c0.x
    texld_pp r7, r7, s3
    mul_pp r7.xyz, r7, c63.x
    texld_pp r11, v0, s1
    mul_pp r7.xyz, r7, r11.w
    mul r0.w, c64.z, c64.x
    mov r12.xz, c64
    mad r1.z, r12.x, -r12.z, r12.z
    mad_pp r0.w, c77.w, r1.z, r0.w
    mul_pp r7.xyz, r0.w, r7
    mad_pp r3.xyz, r3, r11, r7
...
// approximately 143 instruction slots used (4 texture, 139 arithmetic)
