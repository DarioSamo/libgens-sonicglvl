...
//
    ...
    add r11, c22.xyzx, -v2.xyzx
    dp3 r0.w, r11.yzww, r11.yzww
    rsq r0.w, r0.w
    ...
    dp3_pp r0.w, r7.yzww, r4.yzww
    mov_sat_pp r1.w, r0.w
    add_pp r0.w, r0.w, r0.w
    mad_pp r6, r0.w, r7, -r4
    mad_pp r1.xyz, r1.w, r5, r1
    mad_pp r5.xyz, r7.wyzw, c0.x, c0.x
    mul_pp r7.xyz, r7.wyzw, r7.wyzw
    mov r11.xyz, c80
    mad r11.xyz, r11, r5.y, c79
    mul r11.xyz, r7.y, r11
    mov r12.xyz, c77
    mad r5.xyw, c78.xyzz, r5.x, r12.xyzz
    mov r12.xyz, c82
    mad r12.xyz, r12, r5.z, c81
    mad_pp r5.xyz, r7.x, r5.xyww, r11
    mad_pp r5.xyz, r7.z, r12, r5
    ...
    mul_pp r2, r8, r1.y
    mad_pp r2, r1.x, r10, r2
    dp2add_sat_pp r0.w, r1, r1, c1.z
    add r0.w, -r0.w, c1.w
    rsq r0.w, r0.w
    rcp_pp r0.w, r0.w
    mad r1, r0.w, r9, r2
    dp3_pp r0.w, r4.yzww, r1.yzww
    mul_pp r2, r4.wyzw, c150.x
    mad_pp r3.w, r0.w, -r0.w, c1.w
    mul_pp r4.x, c150.x, c150.x
    mad_pp r3.w, r4.x, -r3.w, c1.w
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    mad r0.w, c150.x, r0.w, -r3.w
    mad_pp r1, r1, r0.w, -r2
    mul_pp r2, r1.wyzw, c1.yywz
    mad_pp r4, r1, c2.xyyz, c2.zzzw
    cmp_pp r1, r1.z, r2, r4
    add_pp r0.w, r1.z, c1.w
    rcp r0.w, r0.w
    mad_pp r1.xy, r1.yxzw, r0.w, c1.w
    mad_pp r2.x, r1.y, c0.w, r1.w
    mul_pp r2.y, r1.x, c0.x
    texld_pp r1, r2, s6
    mul_pp r1.xyz, r3, r1
    mul_pp r2, r6.wyzw, c1.yywz
    mad_pp r4, r6, c2.xyyz, c2.zzzw
    cmp_pp r2, r6.z, r2, r4
    add_pp r0.w, r2.z, c1.w
    rcp r0.w, r0.w
    mad_pp r2.xy, r2.yxzw, r0.w, c1.w
    mad_pp r4.x, r2.y, c0.w, r2.w
...
// approximately 220 instruction slots used (8 texture, 212 arithmetic)
