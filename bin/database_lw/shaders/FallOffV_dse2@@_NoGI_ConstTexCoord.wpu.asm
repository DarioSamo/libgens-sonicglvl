...
//
    ...
    dp3_pp r0.w, r10, r9
    mov_pp r11.w, -r11.z
    texld_pp r11, r11.xyww, s5
    mul r3.yz, c64.xzww, c64.xxyw
    mov r12, c64
    mad r9.xy, r12, -r12.zwzw, r12.zwzw
    mad_pp r3.yz, c77.w, r9.xxyw, r3
    texld r12, v0, s1
    mul r3.w, r12.w, c63.x
    mul r3.y, r3.y, r3.w
    mul_pp r9.xyz, r3.y, r11
    mad_pp r1.yzw, r1, c18.xxyz, r9.xxyz
    mul_pp r1.yzw, r12.xxyz, r1
    ...
    mad_pp r2.xyz, r1.x, r2, r3.xyww
    dp3_sat_pp r1.x, r10, -c10
    mul r1.x, r1.x, c77.w
    mad_pp r2.xyz, r1.x, c36, r2
    mad_pp r3.xyw, r10.xyzz, c0.x, c0.x
    mul_pp r4.xyz, r10, r10
    mov r6.xyz, c80
    mad r6.xyz, r6, r3.y, c79
    mul r6.xyz, r4.y, r6
    mad r5.xyz, c78, r3.x, r5
    mov r7.xyz, c82
    mad r3.xyw, r7.xyzz, r3.w, c81.xyzz
    mad_pp r4.xyw, r4.x, r5.xyzz, r6.xyzz
    mad_pp r3.xyw, r4.z, r3, r4
    mad_pp r2.xyz, r3.xyww, c17, r2
