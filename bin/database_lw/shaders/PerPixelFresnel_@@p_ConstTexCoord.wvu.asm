...
//
    ...
    if b15
      ...
      mad r3, v10.x, c30[a0.y], r3
      mad r3, v10.z, c30[a0.z], r3
      mad r2, r1.x, c30[a0.w], r3
      dp3 r1.y, r2, v9
      mov r0.w, c0.x
      dp4 r1.z, r2, r0
      mul r2, v10.y, c28[a0.x]
      mad r2, v10.x, c28[a0.y], r2
      mad r2, v10.z, c28[a0.z], r2
      mad r2, r1.x, c28[a0.w], r2
      dp3 r1.w, r2, v9
      dp4 r2.x, r2, r0
      mul r3, v10.y, c29[a0.x]
      mad r3, v10.x, c29[a0.y], r3
      mad r3, v10.z, c29[a0.z], r3
