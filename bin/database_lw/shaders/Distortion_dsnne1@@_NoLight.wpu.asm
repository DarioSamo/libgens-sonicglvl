...
//
    ...
    texld r2, v1, s3
    texld r3, v1, s4
    lrp_pp r4.yzw, c1.x, r3.xxyw, r2.xxyw
    mul_pp r4.x, r4.w, r4.y
    mad_pp r2.xy, r4.xzzw, c1.y, c1.z
    ...
    mov r3.x, c0.x
    mul_pp r2.y, r3.x, c20.y
    exp_pp r2.y, r2.y
    mul_pp r2.y, r2.y, c0.y
    ...
    mul r0.w, r0.w, r4.w
    mad_pp r1.xyz, r0.w, c36, r3.xzww
    dp4 r0.w, r5, r5
    rsq r0.w, r0.w
    mul r3.xy, r0.w, r5
    mad_pp r3.xy, r3, c0.zwzw, c0.z
    texld_pp r3, r3, s5
