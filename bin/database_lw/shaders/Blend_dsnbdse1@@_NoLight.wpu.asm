...
//
    ...
    mov r5.xz, c64
    mad r3.z, r5.x, -r5.z, r5.z
    texld_pp r5, v0.zwzw, s10
    mad_pp r2.w, r5.w, r3.z, r2.w
    mul r1.x, r1.x, r2.w
    mul_pp r2.xyz, r1.x, r2
    add r6.xyz, c22, -v2
    dp3 r1.x, r6, r6
    rsq r1.x, r1.x
    mul_pp r7.xyz, r1.x, r6
    mad_pp r6.xyz, r6, r1.x, -c10
    rcp r1.x, r1.x
    mad_sat_pp r1.x, -r1.x, c60.z, c60.w
    nrm_pp r8.xyz, r6
    dp3_sat_pp r2.w, r8, r1.yzww
    add_pp r6.xyz, r7, r7
    dp3_sat_pp r3.z, r1.yzww, r7
    nrm_pp r7.xyz, r6
    dp3_sat_pp r3.w, r7, r1.yzww
    ...
    pow_pp r4.w, r3.w, r1.z
    pow_pp r3.w, r2.w, r1.z
    mul_pp r1.z, r4.w, c20.z
    mul_pp r6.xyz, r1.x, c59
    mul r7.xyz, r1.x, c58
    mul_pp r7.xyz, r3.z, r7
    mad_pp r1.xyw, r1.y, c36.xyzz, r7.xyzz
    ...
    lrp_pp r5, r0.y, r4, r3
    mad_pp r0.xyz, r1.xyww, r5, r2
