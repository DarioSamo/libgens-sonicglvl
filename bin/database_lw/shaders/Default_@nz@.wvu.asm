...
//
    ...
    mov r1.w, c0.z
    nrm r3.xyz, v6
    mul r1.xyz, r3, c246.x
    add r1, r0, -r1
    mul r3, r1.y, c229
    mad r3, r1.x, c228, r3
    mad r3, r1.z, c230, r3
    mad r1, r1.w, c231, r3
    mul r3.xy, r1.y, c225.zwzw
    mad r1.xy, r1.x, c224.zwzw, r3
    mad r1.xy, r1.z, c226.zwzw, r1
    mad r1.xy, r1.w, c227.zwzw, r1
    rcp r1.y, r1.y
    mul r1.x, r1.y, r1.x
    abs r1.y, c246.x
    sge r1.y, -r1.y, r1.y
    ...
    mad r4, r3.w, c227, r4
    mov o0.xyw, r4
    mad r0.w, r1.x, -r4.w, r4.z
    mul r1.x, r1.x, r4.w
    mad o0.z, r1.y, r0.w, r1.x
    add r0.w, -r3.z, -c246.x
    mov o3, r0
