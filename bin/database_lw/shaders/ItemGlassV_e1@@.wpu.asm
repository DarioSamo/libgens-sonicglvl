...
//
    ...
    mad_pp r2.yz, r10.w, r11.xxyw, r2
    mov r11.z, c1.z
    add_pp r1.w, r11.z, c151.w
    add_sat_pp r1.w, -r0.z, r1.w
    add_pp r0.z, r0.z, c0.x
    mul_sat_pp r0.xz, r0, c0.y
    mul_pp r11.xyz, r0.z, c58
    pow_pp r0.z, r1.w, c151.z
    mad_pp r0.z, c151.y, r0.z, c151.x
    mad_pp oC0.w, r0.z, r2.z, r0.w
    ...
    mad_pp r1.xyz, r6, r10.w, r1
    mad_pp r0.xyw, r0.y, r11.xyzz, r1.xyzz
    mad_pp r0.xyw, r10.xyzz, r10.xyzz, r0
