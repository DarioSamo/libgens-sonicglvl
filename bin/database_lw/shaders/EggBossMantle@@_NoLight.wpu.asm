...
//
    ...
    add_pp r5.xyz, r4, r4
    dp3_sat_pp r3.w, r3, r4
    nrm_pp r4.xyz, r5
    dp3_sat_pp r4.x, r4, r3
    pow_pp r5.x, r4.x, r2.w
    mul_pp r2.w, r5.x, c20.z
    ...
    mul r5.xyz, r6, r7.y
    mov r6.xyz, c78
    mad r4.xyw, r6.xyzz, r4.x, c77.xyzz
    mov r6.xyz, c82
    mad r6.xyz, r6, r4.z, c81
    mad_pp r4.xyz, r7.x, r4.xyww, r5
...
// approximately 138 instruction slots used (7 texture, 131 arithmetic)
