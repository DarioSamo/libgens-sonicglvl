...
//
    ...
    cmp r4.xy, -r13_abs.x, v0, c3.x
    cmp r4.xy, -r13_abs.y, v0.zwzw, r4
    cmp r4.xy, -r13_abs.z, v1, r4
    cmp r4.xy, -r13_abs.w, v1.zwzw, r4
    texld_pp r4, r4, s2
    mad r4.xy, r4.wyzw, c0.x, c0.y
    mad r2.yz, r4.xxyw, c151.xxyw, r2
    texld_pp r13, r2.yzzw, s0
    ...
    mov r14.xz, c64
    mad r3.w, r14.x, -r14.z, r14.z
    mad_pp r2.z, c77.w, r3.w, r2.z
    mul r2.y, r2.z, r2.y
    dp3 r2.z, -r9, r10
    add r2.z, r2.z, r2.z
    mad_pp r14.xyz, r10, -r2.z, -r9
    dp3_sat_pp r2.z, r10, r9
    mad_pp r9.xy, r4, c151, r14
    mov_pp r9.z, -r14.z
    texld_pp r9, r9, s1
    ...
    mad_pp r1.xyz, r2.z, r12, r1
    add_pp r0.x, -r2.z, c3.y
    mad_pp r2.xyz, r10, c0.z, c0.z
    mov r3.xyz, c80
