...
//
    ...
    add r6.w, r3.z, r6.w
    cmp r6.w, -r6.w, c2.y, c2.w
    cmp r6.w, -r3.z, r6.w, c2.w
    add r10.xy, -r2.ywzw, r9
    cmp r10.xy, -r11.x, r10, r9
    add r11.xz, r2.yyww, r9.zyww
    cmp r10.zw, -r11.y, r11.xyxz, r9
    ...
    add r4.xyz, r4, r5
    mul r4.xyz, r2.z, r4
    mul r5, r9.xyxx, c2.wwyy
    texldl r5, r5, s0
    mad r0.w, r5.y, c0.x, r5.x
    cmp r5.x, -r7.z, r0.w, r7.x
    mul r6, r9.zwxx, c2.wwyy
    texldl r6, r6, s0
    mad r0.w, r6.y, c0.x, r6.x
    cmp r5.y, -r7.w, r0.w, r7.y
    add r6.xy, -r2.x, r5
    mad r6.xy, r4.w, -c0.w, r6_abs
    cmp r6.xy, r6, c2.w, c2.y
    add r6.xy, r6, r7.zwzw
    add r6.zw, -r2.xyyw, r9.xyxy
    cmp r8.xy, -r6.x, r6.zwzw, r9
    add r6.zw, r2.xyyw, r9
    cmp r8.zw, -r6.y, r6, r9
    ...
    add r0.w, r3.z, r0.w
    cmp r0.w, -r0.w, -c2.y, -c2.w
    cmp r0.w, -r3.z, r0.w, c2.z
    cmp r6, -r3.z, r7, r6
    mul r7, r6.xyxx, c2.wwyy
    texldl r7, r7, s0
    mad r3.z, r7.y, c0.x, r7.x
    cmp r7.z, -r5.z, r3.z, r5.x
    mul r8, r6.zwxx, c2.wwyy
    texldl r9, r8, s0
    mad r3.z, r9.y, c0.x, r9.x
    cmp r7.w, -r5.w, r3.z, r5.y
    add r3.zw, -r2.x, r7
    mad r3.zw, r4.w, -c0.w, r3_abs
    cmp r3.zw, r3, c2.w, c2.y
    add r3.zw, r3, r5
    ...
    cmp r9.zw, -r3.w, r2.xyyw, r6
    cmp r9.xy, -r3.z, r5, r6
    cmp r2.y, -r3.w, -c2.y, -c2.w
    cmp r2.y, -r3.z, -c2.y, r2.y
    cmp r5, r2.y, r9, r6
    cmp r2.yw, r0.w, r5.xxzy, r6.xxzy
    mov r7.xy, r5.zwzw
    cmp r5, r0.w, r7, r8
...
// approximately 999 instruction slots used (148 texture, 851 arithmetic)
