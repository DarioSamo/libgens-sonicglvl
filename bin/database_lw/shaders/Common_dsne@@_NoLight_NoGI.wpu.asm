...
//
    ...
    mov r3.yz, c20
    mul_pp r3.y, r3.y, c0.x
    exp_pp r3.y, r3.y
    mul_pp r3.y, r3.y, c0.y
    pow_pp r4.x, r3.x, r3.y
    mul_pp r3.x, r3.z, c77.w
    ...
    mad r2, r3.w, r1, -r2
    mul r5, r2.wyzw, c2.xxyz
    mad r6, r2, c2.yxxz, c2.zzzw
    cmp r2, r2.z, r5, r6
    add r0.w, r2.z, -c1.z
    rcp r0.w, r0.w
    mad r2.xy, r2.yxzw, r0.w, -c1.z
    mad_pp r5.x, r2.y, c0.z, r2.w
    mul_pp r5.y, r2.x, c1.x
    texld_pp r2, r5, s5
    ...
    mad_pp r3.xyz, r1.wyzw, c1.x, c1.x
    mov r5.xyz, c80
