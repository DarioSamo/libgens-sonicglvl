...
//
    ...
    dp3_pp r1.y, r10, -r7
    mad_pp r1.y, r1.y, c0.x, c0.x
    mul_pp r1.xy, r1, r1
    mul_pp r7.xyz, r8, r1.y
    mad_pp r6.xyz, r2.w, r6, r7
    mad_pp r4.xyz, r3.x, r4, r6
    mad_pp r1.xyw, r1.x, r2.xyzz, r4.xyzz
    dp3_pp r2.x, r10, -c10
    mad_pp r2.x, r2.x, c0.x, c0.x
    mul_pp r2.x, r2.x, r2.x
    mul_pp r2.xyz, r2.x, c36
    mad_pp r1.xyw, r2.xyzz, c77.w, r1
    dp3_pp r2.x, r10, r9
    mad_pp r2.y, r2.x, c0.x, c0.x
...
// approximately 193 instruction slots used (5 texture, 188 arithmetic)
