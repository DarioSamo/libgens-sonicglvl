...
//
    ...
    add_pp r11, c22.xyzx, -v2.xyzx
    dp3_pp r0.w, r11.yzww, r11.yzww
    rsq_pp r0.w, r0.w
    ...
    mad_pp r2.x, r0.w, -r0.w, c0.w
    mul_pp r2.y, c150.x, c150.x
    mad_pp r2.x, r2.y, -r2.x, c0.w
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    mad r0.w, c150.x, r0.w, -r2.x
    mul_pp r2, r4.wyzw, c150.x
    mad_pp r1, r1, r0.w, -r2
    mul_pp r2, r1.wyzw, c0.yywz
    mad_pp r6, r1, c2.xyyz, c2.zzzw
    cmp_pp r1, r1.z, r2, r6
    add_pp r0.w, r1.z, c0.w
    rcp r0.w, r0.w
    mad_pp r1.xy, r1.yxzw, r0.w, c0.w
    mad_pp r2.x, r1.y, c1.w, r1.w
    mul_pp r2.y, r1.x, c1.z
    texld_pp r1, r2, s6
    mul_pp r1.xyz, r5, r1
    dp3_pp r0.w, r4.yzww, r7.yzww
    add_pp r0.w, r0.w, r0.w
    mad_pp r2, r0.w, r7, -r4
    mul_pp r4, r2.wyzw, c0.yywz
    mad_pp r6, r2, c2.xyyz, c2.zzzw
    cmp_pp r2, r2.z, r4, r6
    add_pp r0.w, r2.z, c0.w
    rcp r0.w, r0.w
    mad_pp r2.xy, r2.yxzw, r0.w, c0.w
    mad_pp r3.x, r2.y, c1.w, r2.w
