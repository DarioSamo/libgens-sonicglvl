...
//
    ...
    mad_pp r5.xy, r6.xzzw, c0.y, c0.z
    nrm_pp r6.xyz, v6
    mul_pp r6.xyz, r5.y, r6
    nrm_pp r7.xyz, v5
    mad_pp r6.xyz, r5.x, r7, r6
    dp2add_sat_pp r0.w, r5, r5, c2.x
    add r0.w, -r0.w, c2.y
    rsq r0.w, r0.w
    rcp_pp r0.w, r0.w
    nrm_pp r5.xyz, v3
    ...
    mad_sat_pp r1.w, -r3.w, c44.z, c44.w
    mul r8.xyz, r1.w, c43
    ...
    mul r6.xyz, r5.y, r6
    mov r7.xyz, c78
    mad r4.xyw, r7.xyzz, r4.x, c77.xyzz
    mov r7.xyz, c82
    mad r7.xyz, r7, r4.z, c81
    mad_pp r4.xyz, r5.x, r4.xyww, r6
    mad_pp r4.xyz, r5.z, r7, r4
    add_pp r3.xyz, r3, r4
...
// approximately 214 instruction slots used (7 texture, 207 arithmetic)
