...
//
    ...
    max_pp r8.w, r7.x, c1.x
    min r7.x, r8.w, c2.z
    pow r8.w, r6.w, r7.x
    mul_pp r8.xyz, r8.w, r8
    mul_pp r8.xyz, r4.w, r8
    mul_pp r11.xyz, r7.y, c39
    ...
    pow r3.z, r0.z, r7.x
    mul_pp r7.xyz, r3.z, r7.yzww
    mad_pp r7.xyz, r1.x, r7, r8
    dp3 r0.z, -r5.yzww, r10
    add r0.z, r0.z, r0.z
    mad_pp r8.xyz, r10, -r0.z, -r5.yzww
    dp3_sat_pp r0.z, r10, r5.yzww
    add_pp r0.z, -r0.z, c1.x
    texld_pp r8, r8, s5
    mul r5.yzw, r8.xxyz, c63.x
    mad_pp r5.yzw, r5, r8.w, r8.xxyz
    texld_pp r8, v0, s2
    mul_pp r5.yzw, r5, r8.w
    mul r0.w, c64.z, c64.x
    mov r9.xz, c64
    mad r3.z, r9.x, -r9.z, r9.z
    mad_pp r0.w, r1.y, r3.z, r0.w
    mul_pp r5.yzw, r0.w, r5
    mad_pp r5.yzw, r7.xxyz, c18.xxyz, r5
