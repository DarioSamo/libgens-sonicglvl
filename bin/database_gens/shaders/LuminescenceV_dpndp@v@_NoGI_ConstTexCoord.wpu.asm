...
//
    ...
    texld_pp r8, v0, s2
    texld_pp r9, v0, s3
    lrp_pp r3.z, v8.w, r9.x, r8.x
    mul_pp r3.zw, r3.z, c20.xyyz
    ...
    texld_pp r1, v0, s0
    texld_pp r2, v0, s1
    lrp_pp r3, v8.w, r2, r1
    add_pp r1.xyz, r3, c0.z
...
// approximately 251 instruction slots used (7 texture, 244 arithmetic)
