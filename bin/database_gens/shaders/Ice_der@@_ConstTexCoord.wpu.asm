...
//
    ...
    mad_pp r2.y, r2.x, -r2.x, c5.x
    mad_pp r2.y, r2.y, -c4.x, c4.y
    rsq_pp r2.y, r2.y
    rcp_pp r2.y, r2.y
...
// approximately 249 instruction slots used (6 texture, 243 arithmetic)
