...
//
    ...
    dp3_pp r4.w, r3, r3
    rsq_pp r4.w, r4.w
    mad_pp r4.xyz, r3, r4.w, -r4
    nrm_pp r9.xyz, r4
    dp3_sat_pp r4.x, r9, r1
    frc r9.xyz, c26
    cmp r10.xyz, -r9, c3.x, c3.y
    add r9.xyz, -r9, c26
    cmp r10.xyz, c26, r2.x, r10
    add r9.xyz, r9, r10
    add r10, r9.z, -c3
    cmp r4.yz, -r10_abs.x, v0.xxyw, c3.x
    cmp r4.yz, -r10_abs.y, v0.xzww, r4
    cmp r4.yz, -r10_abs.z, v1.xxyw, r4
    cmp r4.yz, -r10_abs.w, v1.xzww, r4
    texld_pp r10, r4.yzzw, s2
    mul_pp r4.yz, r10.x, c20
    ...
    mad_pp r6.xyz, r3, r4.w, -r6
    nrm_pp r11.xyz, r6
    dp3_sat_pp r1.w, r11, r1
    pow r2.x, r1.w, r4.y
    mul_pp r6.xyz, r4.z, c39
    mul_pp r6.xyz, r2.x, r6
    mad_pp r6.xyz, r2.z, r6, r10
    mad_pp r7.xyz, r3, r4.w, -r7
    nrm_pp r10.xyz, r7
    dp3_sat_pp r1.w, r10, r1
    pow r2.x, r1.w, r4.y
    mul_pp r7.xyz, r4.z, c47
    mul_pp r7.xyz, r2.x, r7
    mad_pp r2.xzw, r2.w, r7.xyyz, r6.xyyz
    mad_pp r6.xyz, r3, r4.w, -r8
    nrm_pp r7.xyz, r6
    dp3_sat_pp r1.w, r7, r1
    pow r5.w, r1.w, r4.y
    mul_pp r6.xyz, r4.z, c51
    mul_pp r6.xyz, r5.w, r6
    mad_pp r2.xzw, r3.w, r6.xyyz, r2
    mad_pp r6.xyz, r3, r4.w, -c10
    mad_pp r3.xyz, r3, r4.w, -r5
    nrm_pp r5.xyz, r3
