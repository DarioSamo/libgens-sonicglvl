...
//
    ...
    mul_pp r1.xyz, r7, r7
    mad_pp r2.xyz, r7, c0.w, c0.w
    mov r4.xyz, c79
    add r3.xzw, -r4.xyyz, c80.xyyz
    mad r4.xyz, r2.y, r3.xzww, c79
    mul r4.xyz, r1.y, r4
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    ...
    texld_pp r1, v0, s0
    mad_pp r0.xyw, r0, r1.xyzz, r8.xyzz
    mul_pp r1.w, r1.w, c16.w
    dp3_pp r2.z, r6, r7
    add_sat_pp r3.y, -r2.z, c0.z
    add_pp r2.z, r2.z, r2.z
    mad_pp r4.xyz, r2.z, r7, -r6
    pow_pp r2.z, r3.y, c150.z
    mul r2.z, r2.z, c150.y
    mad_pp r0.z, r2.z, r0.z, c150.x
    mad_pp r6.xyz, r4, c0.w, c0.w
    mul_pp r4.xyz, r4, r4
    mad r3.xyz, r6.y, r3.xzww, c79
    mul r3.xyz, r3, r4.y
    mad r5.xyz, r6.x, r5, c77
    mad r2.xyz, r6.z, r2.xyww, c81
