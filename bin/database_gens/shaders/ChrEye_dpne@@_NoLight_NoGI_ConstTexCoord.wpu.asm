...
//
    ...
    lrp_pp r1.x, v4.z, c1.z, r2.x
    lrp_pp r1.y, v4.z, c1.z, r3.x
    rcp r1.z, v8.w
    ...
    cmp_pp r3.xzw, r4.x, r3, c0.x
    mad_pp r1.yzw, r0.x, r3.xxzw, r1
    mov r4.xyz, c79
    add r3.xzw, -r4.xyyz, c80.xyyz
    mad_pp r4.xyz, r2.wyzw, c1.w, c1.w
    ...
    add_pp r3.yzw, c22.xxyz, -v6.xxyz
    dp3_pp r4.x, r3.yzww, r3.yzww
    rsq_pp r4.x, r4.x
    mad_pp r0.yzw, r3, r4.x, -r0
    nrm_pp r5.xyz, r0.yzww
    dp3_sat_pp r0.y, r5.yzxw, r2.yzww
    texld_pp r6, v0, s1
    mov r7.xy, c2
    mul_pp r7, r7.xyxy, c20.yzyz
    mul_pp r6, r6.xxyy, r7
    max_pp r0.zw, r6.xyxz, c1.z
    min r4.yz, r0.xzww, c0.w
    pow r5.w, r0.y, r4.y
    ...
    mad_pp r9.xyz, r3.yzww, r4.x, -c10
    mul_pp r3.yzw, r3, r4.x
    nrm_pp r10.xyz, r9
    dp3_sat_pp r4.x, r10.yzxw, r2.yzww
    pow r5.w, r4.x, r4.y
    mul_pp r8.xyz, r5.w, r8
    mad_pp r7.xyz, r8, r1.x, r7
    mul_pp r6.xyz, r6.y, c150
    mul_pp r8.xyz, r6.w, c37
    dp3_pp r4.x, v5, v5
    rsq_pp r4.x, r4.x
    mad_pp r9.xyz, v5, r4.x, r3.yzww
    nrm_pp r11.xyz, r9
    texld r9, v0, s2
    mad_pp r9, r9, c1.x, c1.y
    dp2add_pp r4.x, r9, -r9, c1.z
    rsq_pp r4.x, r4.x
    rcp_pp r4.x, r4.x
    nrm_pp r12.xyz, v1
    nrm_pp r13.xyz, v2
    mul_pp r14.xyz, r9.y, r13
    mul_pp r13.xyz, r9.w, r13
    mad_pp r13.xyz, r9.z, r12, r13
    mad_pp r12.xyz, r9.x, r12, r14
    dp2add_pp r4.w, r9.zwzw, -r9.zwzw, c1.z
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    mad_pp r9.xyz, r4.w, r2.wyzw, r13
    mad_pp r12.xyz, r4.x, r2.wyzw, r12
    dp3_sat_pp r4.x, r11, r12
    pow r5.w, r4.x, r4.y
    mul_pp r4.xyw, r5.w, r6.xyzz
    mad_pp r4.xyw, r7.xyzz, c18.xyzz, r4
    dp3_pp r5.w, r3.zwyw, r2.yzww
    add_pp r5.w, r5.w, r5.w
    mad r2, r5.w, r2, -r3.yzwy
    dp3_sat_pp r3.y, r9, r3.yzww
    add_pp r3.y, -r3.y, c1.z
    mad r6, r2.wyzw, c4.xxyz, c4.zzzw
    mul r7, r2, c4.yxxz
    cmp_pp r2, r2.z, r6, r7
    add_pp r2.z, r2.z, c1.z
    rcp r2.z, r2.z
    mad_pp r2.xy, r2.yxzw, r2.z, c1.z
    mad_pp r6.x, r2.y, c2.z, r2.w
    mul_pp r6.y, r2.x, c1.w
    texld_pp r2, r6, s3
    mul r6.xyz, r2, c63.x
    mad_pp r2.xyz, r6, r2.w, r2
    mul_pp r2.xyz, r2, v7.w
    mad_pp r2.xyz, r2, r3.x, r4.xyww
    mul_pp r2.xyz, r2, v3.w
    texld_pp r6, v0, s0
    mad_pp r1.yzw, r1, r6.xxyz, r2.xxyz
    dp3_sat_pp r2.x, r5, r9
    dp3_sat_pp r2.y, r10, r9
    pow r3.x, r2.y, r4.z
    pow r3.z, r2.x, r4.z
    mul_pp r0.yzw, r0, r3.z
    mul_pp r0.xyz, r0.yzww, r0.x
    mul_pp r2.xyz, r3.x, r8
