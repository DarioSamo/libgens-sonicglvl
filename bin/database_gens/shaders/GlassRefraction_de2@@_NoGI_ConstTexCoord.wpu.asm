...
//
    ...
    add_pp r4.w, -r4.w, c0.y
    nrm r6.xyz, v2
    dp3_pp r5.w, r6, -r5
    mul_pp r7.xyz, r5.w, c43
    cmp_pp r7.xyz, r5.w, r7, c0.z
    mul_pp r7.xyz, r4.w, r7
    dp3_pp r5.w, r6, -r4
    mul_pp r8.xyz, r5.w, c39
    cmp_pp r8.xyz, r5.w, r8, c0.z
    ...
    max r5.w, v3.z, c0.z
    add r6.w, r5.w, -v3.w
    cmp r8.z, r6.w, c0.z, r5.w
    mov r8.xyw, v3
    texldp_pp r8, r8, s13
    max r5.w, v4.z, c0.z
    add r6.w, r5.w, -v4.w
    cmp r9.z, r6.w, c0.z, r5.w
    mov r9.xyw, v4
    texldp_pp r9, r9, s7
    min_pp r5.w, r9.x, r8.x
    lrp_pp r6.w, v5.z, c0.y, r9.x
    lrp_pp r7.w, v5.z, c0.y, r5.w
    rcp r5.w, v3.w
    mul r8.xy, r5.w, v3
    mad r8.xy, r8, c1.x, c1.z
    abs_sat r8.xy, r8
    add_sat r8.xy, r8, -c65.x
    mul r8.xy, r8, c65.y
    max r5.w, r8.x, r8.y
    lrp_pp r8.x, r5.w, c0.y, r7.w
    lrp_pp r7.w, r5.w, c0.y, r6.w
    mul r5.w, r8.x, c77.w
    dp3_pp r6.w, r6, -c10
    mul r8.xyz, r6.w, c36
    mul_pp r8.xyz, r5.w, r8
    cmp_pp r8.xyz, r6.w, r8, c0.z
    add_pp r7.xyz, r7, r8
    ...
    mad r2.zw, r8.xyxy, c1.xyxy, r9.xyxy
    add_pp r2.zw, r9, r2
    mul r6.w, c150.x, c150.x
    mul_pp r8.xyz, r6.y, c91
    mad_pp r8.xyz, r6.x, c90, r8
    mad_pp r8.xyz, r6.z, c92, r8
    mad r7.w, r8.z, -r8.z, c0.y
    mad r6.w, r6.w, -r7.w, c0.y
    cmp r7.w, r6.w, c0.y, c0.z
    mul r6.w, r6.w, r7.w
    mul r7.w, r7.w, c150.x
    rsq r6.w, r6.w
    rcp r6.w, r6.w
    mad r6.w, r7.w, -r8.z, r6.w
    mul_pp r8.xy, r8, r6.w
    mad_pp r2.zw, r8.xyxy, c2.w, r2
    mad r2.zw, r2, c3.xyxy, c3.x
    texld_pp r8, r2.zwzw, s11
    texld_pp r9, v0, s0
    mad r7.xyz, r7, r9, -r8
    mul_pp r2.z, r9.w, c16.w
    mad_pp r2.w, c16.w, -r9.w, r2.y
    mad_pp r7.xyz, r2.z, r7, r8
    add_pp r8.xyz, c22, -v1
    dp3_pp r2.z, r8, r8
    rsq_pp r2.z, r2.z
    mad_pp r5.xyz, r8, r2.z, -r5
    nrm_pp r9.xyz, r5
    dp3_sat_pp r5.x, r9, r6
    mov_pp r9.xy, c2
    mul_pp r5.yz, r9.xxyw, c20
    max_pp r6.w, r5.y, c0.y
    min r5.y, r6.w, c2.z
    pow r6.w, r5.x, r5.y
...
// approximately 267 instruction slots used (5 texture, 262 arithmetic)
