...
//
    ...
    max r0.w, v4.z, c3.x
    add r1.x, r0.w, -v4.w
    cmp r1.z, r1.x, c3.x, r0.w
    mov r1.xyw, v4
    texldp_pp r1, r1, s13
    max r0.w, v5.z, c3.x
    add r1.y, r0.w, -v5.w
    cmp r3.z, r1.y, c3.x, r0.w
    mov r3.xyw, v5
    texldp_pp r3, r3, s7
    min_pp r0.w, r3.x, r1.x
    lrp_pp r1.x, v6.z, c3.y, r0.w
    rcp r0.w, v4.w
    mul r1.yz, r0.w, v4.xxyw
    mad r1.yz, r1, c0.x, c0.z
    abs_sat r1.yz, r1
    add_sat r1.yz, r1, -c65.x
    mul r1.yz, r1, c65.y
    max r0.w, r1.y, r1.z
    lrp_pp r2.w, r0.w, c3.y, r1.x
    ...
    mad r3.xyw, r3.x, r4.yzzw, c77.xyzz
