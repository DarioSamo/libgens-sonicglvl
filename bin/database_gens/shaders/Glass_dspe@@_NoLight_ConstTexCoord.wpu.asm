...
//
    ...
    add_pp r0.w, -r0.w, c1.x
    mad r5, r1.w, r6, -r5
    mad r7, r5.wyzw, c3.xxyz, c3.zzzw
    mul r8, r5, c3.yxxz
    cmp r5, r5.z, r7, r8
    add r1.w, r5.z, c1.x
    rcp r1.w, r1.w
    mad r4.yz, r5.xyxw, r1.w, c1.x
    mad_pp r5.x, r4.z, c4.x, r5.w
    mul_pp r5.y, r4.y, c2.w
    texld_pp r5, r5, s5
...
// approximately 142 instruction slots used (6 texture, 136 arithmetic)
