...
//
    ...
    texld_pp r3, v0, s0
    lrp_pp r4, r0.w, r3, c1.z
    mad_pp r0.xyz, r7, r4, r0
    mul_pp r3.w, r4.w, c16.w
    dp3_pp r1.y, r2, r6
    add_sat_pp r1.z, -r1.y, c1.z
    add_pp r1.y, r1.y, r1.y
    mad_pp r2.xyz, r1.y, r6, -r2
    pow_pp r2.w, r1.z, c150.z
    mul r1.y, r2.w, c150.y
    mad_pp r1.x, r1.y, r1.x, c150.x
    mad_pp r1.yzw, r2.xxyz, c1.x, c1.x
    mul_pp r2.xyz, r2, r2
    mad r4.xyz, r1.z, r8, c79
    mul r4.xyz, r2.y, r4
