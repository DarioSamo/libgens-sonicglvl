...
//
    ...
    texld_pp r6, v0, s1
    mul_pp r6.xy, r6.w, c20.yzzw
    mul_pp r6.xy, r6, c2
    mul_pp r7.xyz, r6.y, c43
    max_pp r4.w, r6.x, c0.z
    min r5.w, r4.w, c2.z
    ...
    texld_pp r1, v0, s0
    lrp_pp r2, r0.z, r1, c0.z
    mad_pp r0.xyz, r0.xyww, r2, r4.yzww
