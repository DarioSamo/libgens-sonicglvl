...
//
    ...
    add r5.xyz, r5, r6
    add r6, r5.z, -c2
    cmp r5.zw, -r6_abs.x, v0.xyxy, c2.x
    ...
    mul_pp r5.zw, r5, c1.xyxy
    mul_pp r6.yzw, r5.w, c43.xxyz
    max_pp r4.w, r5.z, c2.y
    min r5.z, r4.w, c1.z
    frc r4.w, c27.x
    cmp r7.x, -r4.w, c2.x, c2.y
    add r4.w, -r4.w, c27.x
    ...
    dp2add_pp r2.x, r7, -r7, c2.y
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    nrm_pp r7.xyz, v3
    mad r7.xyz, r2.x, r7, r8
    ...
    cmp_pp r3.xzw, r3.x, r8.xyyz, c2.x
