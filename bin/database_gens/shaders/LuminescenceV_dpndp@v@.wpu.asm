...
//
    ...
    texld_pp r9, r9, s2
    add r10, r4.w, -c3
    cmp r4.zw, -r10_abs.x, v0.xyxy, c3.x
    cmp r4.zw, -r10_abs.y, v0, r4
    cmp r4.zw, -r10_abs.z, v1.xyxy, r4
    cmp r4.zw, -r10_abs.w, v1, r4
    texld_pp r10, r4.zwzw, s3
    lrp_pp r3.x, v8.w, r10.x, r9.x
    mul_pp r4.zw, r3.x, c20.xyyz
    mul_pp r4.zw, r4, c2.xyxy
    mul_pp r9.xyz, r4.w, c43
    add_pp r10.xyz, c22, -v2
    dp3_pp r3.x, r10, r10
    rsq_pp r3.x, r3.x
    mad_pp r1.yzw, r10.xxyz, r3.x, -r1
    nrm_pp r11.xyz, r1.yzww
    dp3_sat_pp r1.y, r11, r2
    max_pp r1.z, r4.z, c3.y
    min r4.z, r1.z, c1.w
    pow r5.w, r1.y, r4.z
    mul_pp r1.yzw, r5.w, r9.xxyz
    ...
    pow r5.x, r0.w, r4.z
    mul_pp r5.xyz, r5.x, r9
    mad_pp r1.yzw, r2.w, r5.xxyz, r1
    mul_pp r5.xyz, r4.w, c47
    mad_pp r6.xyz, r10, r3.x, -r6
    nrm_pp r9.xyz, r6
    dp3_sat_pp r0.w, r9, r2
    pow r2.w, r0.w, r4.z
    mul_pp r5.xyz, r2.w, r5
    mad_pp r1.yzw, r3.z, r5.xxyz, r1
    mad_pp r5.xyz, r10, r3.x, -r7
    nrm_pp r6.xyz, r5
    dp3_sat_pp r0.w, r6, r2
    pow r2.w, r0.w, r4.z
    mul_pp r5.xyz, r4.w, c51
    mul_pp r5.xyz, r2.w, r5
    mad_pp r1.yzw, r3.w, r5.xxyz, r1
    mad_pp r5.xyz, r10, r3.x, -c10
    mad_pp r3.xzw, r10.xyyz, r3.x, -r8.xyyz
    ...
    dp3_sat_pp r0.w, r6, r2
    pow r2.x, r0.w, r4.z
    mul_pp r3.xzw, r4.w, c37.xyyz
    mul_pp r2.xyz, r2.x, r3.xzww
