...
//
    ...
    mad_pp r2.xy, r4.xzzw, c1.x, c1.y
    ...
    max r0.z, v3.z, c1.w
    add r0.w, r0.z, -v3.w
    cmp r2.z, r0.w, c1.w, r0.z
    mov r2.xyw, v3
    texldp_pp r2, r2, s13
    max r0.z, v4.z, c1.w
    add r0.w, r0.z, -v4.w
    cmp r3.z, r0.w, c1.w, r0.z
    mov r3.xyw, v4
    texldp_pp r3, r3, s7
    min_pp r0.z, r3.x, r2.x
    lrp_pp r0.w, v5.z, c1.z, r3.x
    lrp_pp r2.x, v5.z, c1.z, r0.z
    rcp r0.z, v3.w
    mul r2.yz, r0.z, v3.xxyw
    mad r2.yz, r2, c1.x, c1.y
    abs_sat r2.yz, r2
    add_sat r2.yz, r2, -c65.x
    mul r2.yz, r2, c65.y
    max r0.z, r2.y, r2.z
    lrp_pp r3.x, r0.z, c1.z, r2.x
    lrp_pp r2.x, r0.z, c1.z, r0.w
    texld_pp r4, v0.zwzw, s10
    mul_pp r0.z, r3.x, r4.w
    mul_pp r1.xyz, r0.z, r1
    cmp_pp r1.xyz, r1.w, r1, c1.w
    mul_pp r2.yzw, c58.w, c58.xxyz
    mul_pp r2.yzw, r0.y, r2
    cmp_pp r0.yzw, r0.y, r2, c1.w
