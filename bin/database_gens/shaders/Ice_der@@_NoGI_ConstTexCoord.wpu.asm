...
//
    ...
    rsq_pp r8.x, r8.x
    mad_pp r4.yzw, r7.xxyz, r8.x, -r4
    nrm_pp r9.xyz, r4.yzww
    dp3_sat_pp r4.y, r9, r5
    mov_pp r4.zw, c0
    mul_pp r4.zw, r4, c20.xyyz
    max_pp r8.y, r4.z, c3.z
    min r4.z, r8.y, c1.x
    pow r8.y, r4.y, r4.z
    mul_pp r9.xyz, r4.w, c43
    mul_pp r8.yzw, r8.y, r9.xxyz
    mul_pp r8.yzw, r4.x, r8
    mul_pp r9.xyz, r4.w, c39
    mad_pp r3.yzw, r7.xxyz, r8.x, -r3
    nrm_pp r10.xyz, r3.yzww
    dp3_sat_pp r3.y, r10, r5
    pow r9.w, r3.y, r4.z
    mul_pp r3.yzw, r9.w, r9.xxyz
    mad_pp r3.xyz, r3.x, r3.yzww, r8.yzww
    mul_pp r8.yzw, r4.w, c47.xxyz
    mad_pp r2.yzw, r7.xxyz, r8.x, -r2
    nrm_pp r9.xyz, r2.yzww
    dp3_sat_pp r2.y, r9, r5
    pow r3.w, r2.y, r4.z
    mul_pp r2.yzw, r3.w, r8
    mad_pp r2.xyz, r2.x, r2.yzww, r3
    mul_pp r3.xyz, r4.w, c51
    mad_pp r1.yzw, r7.xxyz, r8.x, -r1
    ...
    mad_pp r0.w, r6.w, r2.x, r0.w
    dp3_pp r2.x, r3.yzww, r5.yzww
    mad_pp r2.y, r2.x, -r2.x, c3.z
    mad_pp r2.y, r2.y, -c1.y, c1.z
    rsq_pp r2.y, r2.y
    rcp_pp r2.y, r2.y
    mad r2.y, r2.x, c1.w, -r2.y
    add_pp r2.x, r2.x, r2.x
    mad r4, r2.x, r5, -r3
    mul_pp r3, r3.wyzw, c1.w
    mad r2, r5.wyzw, r2.y, -r3
    mad r3, r2.wyzw, c4.xxyz, c4.zzzw
    mul r5, r2, c4.yxxz
    cmp_pp r2, r2.z, r3, r5
    add_pp r2.z, r2.z, c3.z
    rcp r2.z, r2.z
    mad_pp r2.xy, r2.yxzw, r2.z, c3.z
    mad_pp r3.x, r2.y, c2.x, r2.w
    mul_pp r3.y, r2.x, c3.x
    texld_pp r2, r3, s6
    mul r3.xyz, r2, c63.x
    mad_pp r2.xyz, r3, r2.w, r2
    mad r3, r4.wyzw, c4.xxyz, c4.zzzw
    mul r5, r4, c4.yxxz
    cmp_pp r3, r4.z, r3, r5
