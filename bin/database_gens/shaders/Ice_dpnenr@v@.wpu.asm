...
//
    ...
    texld_pp r13, r13, s0
    mul_pp r10.xyz, r10, r13
    mul_pp r10.w, r13.w, c16.w
    mul_pp r10, r10, v9
    cmp r13.xy, -r12_abs.x, v0, c6.x
    cmp r12.xy, -r12_abs.y, v0.zwzw, r13
    cmp r12.xy, -r12_abs.z, v1, r12
    cmp r12.xy, -r12_abs.w, v1.zwzw, r12
    texld_pp r12, r12, s2
    mul_pp r12.yz, r12.x, c20
    mul_pp r12.yz, r12, c4.xxyw
    mul_pp r13.xyz, r12.z, c43
    add_pp r14, c22.xyzx, -v2.xyzx
    dp3_pp r2.x, r14.yzww, r14.yzww
    rsq_pp r2.x, r2.x
    mad_pp r4.xyz, r14, r2.x, -r4
    nrm_pp r15.xyz, r4
    dp3_sat_pp r4.x, r15, r6
    max_pp r4.y, r12.y, c6.y
    min r11.w, r4.y, c1.w
    pow r12.y, r4.x, r11.w
    mul_pp r4.xyz, r12.y, r13
    mul_pp r4.xyz, r2.z, r4
    mul_pp r13.xyz, r12.z, c39
    mad_pp r3.xyz, r14, r2.x, -r3
    nrm_pp r15.xyz, r3
    dp3_sat_pp r2.z, r15, r6
    pow r3.x, r2.z, r11.w
    mul_pp r3.xyz, r3.x, r13
    mad_pp r3.xyz, r2.y, r3, r4
    mul_pp r4.xyz, r12.z, c47
    mad_pp r1.yzw, r14.xxyz, r2.x, -r1
    nrm_pp r13.xyz, r1.yzww
    dp3_sat_pp r1.y, r13, r6
    pow r2.y, r1.y, r11.w
    mul_pp r1.yzw, r2.y, r4.xxyz
    mad_pp r1.xyz, r1.x, r1.yzww, r3
    mul_pp r3.xyz, r12.z, c51
    mad_pp r4.xyz, r14, r2.x, -r11
    nrm_pp r11.xyz, r4
    dp3_sat_pp r1.w, r11, r6
    pow r2.y, r1.w, r11.w
    mul_pp r3.xyz, r2.y, r3
    mad_pp r1.xyz, r2.w, r3, r1
    mul_pp r2.yzw, r12.z, c37.xxyz
    mad_pp r3.xyz, r14, r2.x, -c10
    nrm_pp r4.xyz, r3
    dp3_sat_pp r1.w, r4, r6
    pow r3.x, r1.w, r11.w
    mul_pp r2.yzw, r2, r3.x
    mad_pp r1.xyz, r2.yzww, r3.w, r1
    mad_pp r0.yzw, r14.xxyz, r2.x, -r0
    mul_pp r2, r2.x, r14
    nrm_pp r3.xyz, r0.yzww
    dp3_sat_pp r0.y, r3, r6
    pow r1.w, r0.y, r11.w
    mul_pp r0.yzw, c59.w, c59.xxyz
    mul_pp r0.yzw, r12.z, r0
    mul_pp r0.yzw, r1.w, r0
    mad_pp r0.xyz, r0.x, r0.yzww, r1
    mul_pp r0.xyz, r0, c18
    mad_pp r0.xyz, r0, v3.w, r10
    cmp r1.xy, -r5_abs.x, v0, c6.x
    ...
    mul_pp r4, r2.wyzw, c5.x
    mad r1, r1, r0.w, -r4
    mad r4, r1.wyzw, c3.xxyz, c3.zzzw
    mul r5, r1, c5.yzzw
    ...
    dp3_pp r1.w, r2.yzww, r6.yzww
    add_pp r1.w, r1.w, r1.w
    mad r2, r1.w, r6, -r2
    mad r3, r2.wyzw, c3.xxyz, c3.zzzw
    mul r4, r2, c5.yzzw
    cmp_pp r2, r2.z, r3, r4
    add_pp r1.w, r2.z, c6.y
    rcp r1.w, r1.w
    mad_pp r2.xy, r2.yxzw, r1.w, c6.y
...
// approximately 309 instruction slots used (9 texture, 300 arithmetic)
