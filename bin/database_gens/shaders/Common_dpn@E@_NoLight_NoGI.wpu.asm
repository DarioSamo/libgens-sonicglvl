...
//
    ...
    dp3_sat_pp r2.x, r3, r1.yzww
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    add r2.x, -r2.x, c2.y
    mul r3.xyz, r2.x, c88
    nrm_pp r7.xyz, r4
    dp3_sat_pp r1.y, r7, r1.yzww
    pow r2.x, r1.y, r0.z
    mul_pp r1.yzw, r2.x, r6.xxyz
    ...
    lrp_pp r5.xyz, r0.w, r1, c2.y
    mad_pp r0.xyz, r2.yzww, r5, r0
    mad_pp r4.xyz, r0, v9, r3
    mul_pp r0, r4, c89
    min_pp r1, r0, c1.w
