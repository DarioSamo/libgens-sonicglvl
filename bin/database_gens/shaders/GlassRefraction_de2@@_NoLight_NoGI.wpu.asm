...
//
    ...
    mul_pp r5.xyz, r4.y, c91
    mad_pp r5.xyz, r4.x, c90, r5
    mad_pp r5.xyz, r4.z, c92, r5
    mad r4.w, r5.z, -r5.z, c2.y
    mad r2.w, r2.w, -r4.w, c2.y
    cmp r4.w, r2.w, c2.y, c2.x
    mul r2.w, r2.w, r4.w
    ...
    mad_pp r2.xz, r5.xyyw, c3.w, r2
    mad r2.xz, r2, c4.xyyw, c4.x
    texld_pp r5, r2.xzzw, s11
    mad r1.yzw, r1, r3.xxyz, -r5.xxyz
