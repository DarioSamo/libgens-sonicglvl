...
//
    ...
    add r0.w, r8.z, c3.y
    rcp r0.w, r0.w
    mad r2.zw, r8.xyyx, r0.w, c3.y
    mad_pp r8.x, r2.w, c0.w, r8.w
    mul_pp r8.y, r2.z, c2.x
    texld_pp r8, r8, s5
...
// approximately 272 instruction slots used (7 texture, 265 arithmetic)
