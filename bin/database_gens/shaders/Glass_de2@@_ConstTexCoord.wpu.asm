...
//
    ...
    mov r2.xyw, v3
    texldp_pp r2, r2, s13
    lrp_pp r3.y, v4.z, c1.x, r2.x
    lrp_pp r2.x, r3.x, c1.x, r3.y
    ...
    mad_pp r1.x, r2.y, r1.y, r1.x
    add_pp r1.yzw, c22.xxyz, -v1.xxyz
    nrm r2.xyz, r1.yzww
    dp3 r1.y, -r2, r4
    add r1.y, r1.y, r1.y
...
// approximately 158 instruction slots used (4 texture, 154 arithmetic)
