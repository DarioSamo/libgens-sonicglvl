...
//
    ...
    add r0.w, r0.w, -c40.z
    dp3_pp r1.z, r0, -r4
    mul_pp r4.xyz, r1.z, c39
    cmp_pp r4.xyz, r1.z, r4, c2.x
    ...
    max r1.z, v4.z, c2.x
    add r1.w, r1.z, -v4.w
    cmp r5.z, r1.w, c2.x, r1.z
    mov r5.xyw, v4
    texldp_pp r5, r5, s13
    lrp_pp r1.z, v5.z, c2.y, r5.x
    lrp_pp r3.w, r2.w, c2.y, r1.z
    texld_pp r5, v0.zwzw, s10
    mul_pp r1.z, r3.w, r5.w
    mul_pp r4.xyz, r1.z, r4
    cmp_pp r4.xyz, r0.w, r4, c2.x
    add_pp r2.xyz, r2, r4
