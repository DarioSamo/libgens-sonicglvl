...
//
    ...
    max r1.w, v4.z, c2.x
    add r2.z, r1.w, -v4.w
    cmp r3.z, r2.z, c2.x, r1.w
    mov r3.xyw, v4
    texldp_pp r3, r3, s13
    max r1.w, v5.z, c2.x
    add r2.z, r1.w, -v5.w
    cmp r5.z, r2.z, c2.x, r1.w
    mov r5.xyw, v5
    texldp_pp r5, r5, s7
    min_pp r1.w, r5.x, r3.x
    lrp_pp r2.z, v6.z, c2.y, r5.x
    lrp_pp r2.w, v6.z, c2.y, r1.w
    rcp r1.w, v4.w
    mul r3.xy, r1.w, v4
    ...
    mul r3.xy, r3, c65.y
    max r1.w, r3.x, r3.y
    lrp_pp r3.x, r1.w, c2.y, r2.w
    lrp_pp r3.y, r1.w, c2.y, r2.z
    mul r1.w, r3.x, c77.w
    dp3_pp r2.z, r4.wyzw, -c10
    mul r3.xzw, r2.z, c36.xyyz
    mul_pp r3.xzw, r1.w, r3
    cmp_pp r3.xzw, r2.z, r3, c2.x
    add_pp r1.xyz, r1, r3.xzww
    ...
    add r1.x, r4.z, c2.y
    rcp r1.x, r1.x
    mad r1.xy, r4.yxzw, r1.x, c2.y
    mad_pp r4.x, r1.y, c0.x, r4.w
