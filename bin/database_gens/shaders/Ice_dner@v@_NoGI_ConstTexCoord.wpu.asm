...
//
    ...
    add_pp r5.w, -r5.w, c3.z
    dp3_pp r7.w, r4.wyzw, -r7
    mul_pp r8.xyz, r7.w, c51
    cmp_pp r8.xyz, r7.w, r8, c0.x
    mad_pp r5.xyz, r5.w, r8, r5
    max r7.w, v3.z, c0.x
    add r8.x, r7.w, -v3.w
    cmp r8.z, r8.x, c0.x, r7.w
    mov r8.xyw, v3
    texldp_pp r8, r8, s13
    max r7.w, v4.z, c0.x
    add r8.y, r7.w, -v4.w
    cmp r9.z, r8.y, c0.x, r7.w
    mov r9.xyw, v4
    texldp_pp r9, r9, s7
    min_pp r7.w, r9.x, r8.x
    lrp_pp r8.x, v5.z, c3.z, r7.w
    rcp r7.w, v3.w
    mul r8.yz, r7.w, v3.xxyw
    mad r8.yz, r8, c3.x, c3.y
    abs_sat r8.yz, r8
    add_sat r8.yz, r8, -c65.x
    mul r8.yz, r8, c65.y
    max r7.w, r8.y, r8.z
    lrp_pp r9.x, r7.w, c3.z, r8.x
    mul r7.w, r9.x, c77.w
    dp3_pp r8.x, r4.wyzw, -c10
    mul r8.yzw, r8.x, c36.xxyz
    mul_pp r8.yzw, r7.w, r8
    cmp_pp r8.xyz, r8.x, r8.yzww, c0.x
    add_pp r5.xyz, r5, r8
    mul_pp r8.xyz, c58.w, c58
    dp3_pp r8.w, r4.wyzw, -r0.yzww
    mul_pp r8.xyz, r8.w, r8
    cmp_pp r8.xyz, r8.w, r8, c0.x
    mad_pp r5.xyz, r0.x, r8, r5
    mov r8.xyz, c79
    add r8.xyz, -r8, c80
    mad_pp r9.xyz, r4.wyzw, c3.w, c3.w
    mad r8.xyz, r9.y, r8, c79
    mul_pp r10.xyz, r4.wyzw, r4.wyzw
    mul r8.xyz, r8, r10.y
    mov r11.xyz, c77
    add r11.xyz, -r11, c78
    ...
    mad_pp r1.x, r0.w, -r0.w, c3.z
    mad_pp r1.x, r1.x, -c1.z, c1.w
    rsq_pp r1.x, r1.x
    rcp_pp r1.x, r1.x
    mad r0.w, r0.w, c4.x, -r1.x
    mul_pp r1, r5.wyzw, c4.x
    mad r1, r6, r0.w, -r1
    ...
    rcp r0.w, r0.w
    mad_pp r1.xy, r1.yxzw, r0.w, c3.z
...
// approximately 275 instruction slots used (6 texture, 269 arithmetic)
