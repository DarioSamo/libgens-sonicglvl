...
//
    ...
    mad r2.zw, r1.xyyz, c150.xyxy, r2
    ...
    mad r5.xy, r1.yzzw, c150, r5
    texld_pp r5, r5, s0
    mul_pp r4.xyz, r4, r5
    mul_pp r1.w, r5.w, c16.w
    mul_pp r1.w, r1.w, v9.w
    mul_pp r5.w, r1.w, c21.x
    cmp r6.xy, -r2_abs.x, v0, c2.x
    ...
    dp3_pp r1.w, r6, r6
    rsq_pp r1.w, r1.w
    mad_pp r0.yzw, r6.xxyz, r1.w, -r0
    mad_pp r6.xyz, r6, r1.w, -c10
    nrm_pp r7.xyz, r6
    dp3_sat_pp r1.w, r7, r3.xzww
    nrm_pp r6.xyz, r0.yzww
    dp3_sat_pp r0.y, r6, r3.xzww
    max_pp r0.z, r1.y, c2.y
