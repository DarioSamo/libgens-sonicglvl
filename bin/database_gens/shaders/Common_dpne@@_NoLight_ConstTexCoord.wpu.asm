...
//
    ...
    max r0.z, v3.z, c1.w
    add r0.w, r0.z, -v3.w
    cmp r5.z, r0.w, c1.w, r0.z
    mov r5.xyw, v3
    texldp_pp r5, r5, s13
    lrp_pp r0.z, v4.z, c0.w, r5.x
    lrp_pp r5.x, r3.z, c0.w, r0.z
    texld_pp r7, v0.zwzw, s10
    mul r0.z, r5.x, r7.w
    mad_pp r5.yzw, r2.xxyz, r3.x, -c10.xxyz
    mul r2, r2, r3.x
    nrm_pp r8.xyz, r5.yzww
    dp3_sat_pp r0.w, r8, r1
    pow r5.y, r0.w, r3.y
    mul_pp r3.xyz, r5.y, r6
    mad_pp r3.xyz, r3, r0.z, r4.yzww
