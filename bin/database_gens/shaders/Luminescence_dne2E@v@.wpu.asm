...
//
    ...
    dp2add_pp r3.w, r7, -r7, c3.y
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    nrm_pp r7.xyz, v3
    mad r7.xyz, r3.w, r7, r8
    add_pp r8.xyz, c22, -v2
    dp3_pp r3.w, r8, r8
    rsq_pp r3.w, r3.w
    mad_pp r9.xyz, r8, r3.w, -r5
    dp3_pp r4.w, r7, -r5
    nrm_pp r5.xyz, r9
    dp3_sat_pp r5.x, r5, r7
    mov_pp r9.xy, c2
    mul_pp r5.yz, r9.xxyw, c20
    max_pp r7.w, r5.y, c3.y
    min r5.y, r7.w, c1.w
    pow r7.w, r5.x, r5.y
    mul_pp r9.xyz, r5.z, c43
    mul_pp r9.xyz, r7.w, r9
    mul_pp r9.xyz, r2.w, r9
    mad_pp r10.xyz, r8, r3.w, -r4
    dp3_pp r4.x, r7, -r4
    nrm_pp r11.xyz, r10
    ...
    max r1.z, v4.z, c3.x
    add r1.w, r1.z, -v4.w
    cmp r10.z, r1.w, c3.x, r1.z
    mov r10.xyw, v4
    texldp_pp r10, r10, s13
    lrp_pp r1.z, v5.z, c3.y, r10.x
    ...
    pow r3.y, r1.w, r5.y
    mul_pp r11.xyz, r5.z, c37
    mul_pp r11.xyz, r3.y, r11
    mad_pp r9.xyz, r11, r1.z, r9
    mul_pp r11.xyz, c59.w, c59
    mul_pp r5.xzw, r5.z, r11.xyyz
    mad_pp r11.xyz, r8, r3.w, -r0.yzww
    dp3_pp r0.y, r7, -r0.yzww
    mul r3.yzw, r3.w, r8.xxyz
    nrm_pp r8.xyz, r11
    dp3_sat_pp r0.z, r8, r7
    pow r1.w, r0.z, r5.y
    mul_pp r5.xyz, r1.w, r5.xzww
    mad_pp r5.xyz, r0.x, r5, r9
    dp3 r0.z, -r3.yzww, r7
    add r0.z, r0.z, r0.z
    mad_pp r3.yzw, r7.xxyz, -r0.z, -r3
    dp3_pp r0.z, r7, -c10
    texld_pp r7, r3.yzww, s5
    ...
    mad_pp r3.yzw, r5.xxyz, c18.xxyz, r3
