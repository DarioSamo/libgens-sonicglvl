...
//
    ...
    mad_pp r1.yzw, r4.xwyz, c1.x, c1.x
    mov r5.xyz, c79
    add r2.yzw, -r5.xxyz, c80.xxyz
    mad r2.yzw, r1.z, r2, c79.xxyz
    mul_pp r3.xzw, r4.wyyz, r4.wyyz
    mul r2.yzw, r2, r3.z
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    mad r5.xyz, r1.y, r5, c77
    mad_pp r2.yzw, r3.x, r5.xxyz, r2
    mov r5.xyz, c81
    add r5.xyz, -r5, c82
    mad r1.yzw, r1.w, r5.xxyz, c81.xxyz
    mad_pp r1.yzw, r3.w, r1, r2
