...
//
    ...
    texld_pp r9, v0, s3
    texld_pp r10, v0, s5
    lrp_pp r11, r10.x, r9, r8
    mul_pp r8.xy, r11.w, c20.yzzw
    mul_pp r8.xy, r8, c3
    ...
    dp3_sat_pp r0.z, r6, r7
    pow r2.z, r0.z, r7.w
    mul_pp r4.yzw, r8.y, c37.xxyz
    mul_pp r4.yzw, r2.z, r4
    mad_pp r4.yzw, r4, r1.x, r8.xxzw
    ...
    dp4 r0.w, r6, r6
    rsq r0.w, r0.w
    mul r2.yz, r0.w, r6.xxyw
    mad_pp r2.yz, r2, c3.xzww, c3.z
    texld_pp r6, r2.yzzw, s6
    mul r8.xyz, r6, c63.x
    mad_pp r6.xyz, r8, r6.w, r6
    mul_pp r6.xyz, r11.w, r6
    mul_pp r6.xyz, r0.z, r6
    mad_pp r4.yzw, r4, c18.xxyz, r6.xxyz
    mul_pp r4.yzw, r11.xxyz, r4
...
// approximately 260 instruction slots used (9 texture, 251 arithmetic)
