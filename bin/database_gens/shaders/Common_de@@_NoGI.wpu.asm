...
//
    ...
    mul_pp r3.xzw, r4.wyyz, r4.wyyz
    mul r1.xyz, r1, r3.z
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    mad r5.xyz, r2.y, r5, c77
    mad_pp r1.xyz, r3.x, r5, r1
    mov r5.xyz, c81
    add r5.xyz, -r5, c82
...
// approximately 188 instruction slots used (4 texture, 184 arithmetic)
