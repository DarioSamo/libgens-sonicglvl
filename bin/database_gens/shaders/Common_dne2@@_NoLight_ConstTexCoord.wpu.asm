...
//
    ...
    mov r1.xyw, v3
    texldp_pp r1, r1, s13
    lrp_pp r2.y, v4.z, c0.w, r1.x
    lrp_pp r1.x, r2.x, c0.w, r2.y
    texld_pp r2, v0.zwzw, s10
    mul r1.y, r1.x, r2.w
    nrm_pp r3.xyz, v6
    texld_pp r4, v0, s3
    mul_pp r4.x, r4.w, r4.x
    mad_pp r1.zw, r4.xyxy, c0.y, c0.z
    mul_pp r3.xyz, r3, r1.w
    nrm_pp r4.xyz, v5
    mad_pp r3.xyz, r1.z, r4, r3
    dp2add_pp r1.z, r1.zwzw, -r1.zwzw, c0.w
    rsq_pp r1.z, r1.z
    rcp_pp r1.z, r1.z
    nrm_pp r4.xyz, v2
    ...
    dp3 r0.w, -r2, r3
    add r0.w, r0.w, r0.w
    mad_pp r1.xzw, r3.xyyz, -r0.w, -r2.xyyz
    texld_pp r2, r1.xzww, s5
