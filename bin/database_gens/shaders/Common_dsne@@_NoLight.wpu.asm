...
//
    ...
    mov_pp r4.xy, c1
    mul_pp r2.zw, r4.xyxy, c20.xyyz
    max_pp r0.w, r2.z, c3.y
    min r2.z, r0.w, c0.w
    pow r4.x, r0.z, r2.z
    mul_pp r4.yzw, c59.w, c59.xxyz
    mul_pp r4.yzw, r2.w, r4
    mul_pp r5.xyz, r2.w, c37
    ...
    lrp_pp r5.x, r4.w, c3.y, r0.z
    texld_pp r6, v0.zwzw, s10
    mul r0.z, r5.x, r6.w
    mad_pp r2.yzw, r2, r0.z, r4.xxyz
    ...
    add r4, r3.y, -c3
    add r3, r3.x, -c3
    cmp r5.yz, -r4_abs.x, v0.xxyw, c3.x
    cmp r4.xy, -r4_abs.y, v0.zwzw, r5.yzzw
