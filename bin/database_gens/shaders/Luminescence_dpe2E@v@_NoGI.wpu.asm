...
//
    ...
    mad_pp r12.xyz, r9, r5.w, -r2.yzww
    ...
    pow r2.z, r0.z, r7.y
    mul_pp r7.yzw, r2.z, r11.xxyz
    mad_pp r7.yzw, r0.x, r7, r8.xxyz
    dp3 r0.z, -r9, r10
    add r0.z, r0.z, r0.z
    mad_pp r8.xyz, r10, -r0.z, -r9
    texld_pp r8, r8, s5
    mul r9.xyz, r8, c63.x
    ...
    mul_pp r3.xzw, r10.xyyz, r10.xyyz
