...
//
    ...
    pow r3.z, r0.z, r6.w
    mul_pp r7.yzw, r3.z, r7
    mad_pp r7.yzw, r1.x, r7, r8.xxyz
...
// approximately 234 instruction slots used (6 texture, 228 arithmetic)
