...
//
    ...
    dp2add_pp r2.x, r9, -r9, c2.y
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    nrm_pp r10.xyz, v8
    mul_pp r9.yzw, r9.y, r10.xxyz
    nrm_pp r11.xyz, v7
    mad_pp r9.xyz, r9.x, r11, r9.yzww
    nrm_pp r12.xyz, v3
    mad_pp r9.xyz, r2.x, r12, r9
    cmp r13.xy, -r8_abs.x, v0, c2.x
    cmp r8.xy, -r8_abs.y, v0.zwzw, r13
    cmp r8.xy, -r8_abs.z, v1, r8
    cmp r8.xy, -r8_abs.w, v1.zwzw, r8
    texld_pp r8, r8, s4
    mul_pp r8.x, r8.w, r8.x
    mad_pp r8.xy, r8, c0.y, c0.z
    mul_pp r10.xyz, r10, r8.y
    mad_pp r10.xyz, r8.x, r11, r10
    dp2add_pp r2.x, r8, -r8, c2.y
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    mad_pp r8.xyz, r2.x, r12, r10
    add_pp r8.xyz, r8, r9
    nrm r9.xyz, r8
    ...
    dp3 r0.z, -r8, r9
    add r0.z, r0.z, r0.z
    mad_pp r6.yzw, r9.xxyz, -r0.z, -r8.xxyz
...
// approximately 302 instruction slots used (7 texture, 295 arithmetic)
