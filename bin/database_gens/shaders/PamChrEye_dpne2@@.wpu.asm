...
//
    ...
    dp3 r3.z, -r2.yzww, r5
    add r3.z, r3.z, r3.z
    mad_pp r4.yzw, r5.xxyz, -r3.z, -r2
    dp3_sat_pp r2.y, r15, r2.yzww
    add_pp r2.y, -r2.y, c0.z
    texld_pp r14, r4.yzww, s3
...
// approximately 332 instruction slots used (7 texture, 325 arithmetic)
