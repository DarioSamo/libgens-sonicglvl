...
//
    ...
    add r1.w, r4.z, c3.y
    rcp r1.w, r1.w
    mad r3.zw, r4.xyyx, r1.w, c3.y
    mad_pp r4.x, r3.w, c1.w, r4.w
    mul_pp r4.y, r3.z, c0.x
    texld_pp r4, r4, s5
    mul r5.xyz, r4, c63.x
...
// approximately 172 instruction slots used (5 texture, 167 arithmetic)
