...
//
    ...
    max r1.x, v3.z, c3.y
    add r1.y, r1.x, -v3.w
    cmp r2.z, r1.y, c3.y, r1.x
    mov r2.xyw, v3
    texldp_pp r2, r2, s13
    max r1.x, v4.z, c3.y
    add r1.y, r1.x, -v4.w
    cmp r3.z, r1.y, c3.y, r1.x
    mov r3.xyw, v4
    texldp_pp r3, r3, s7
    min_pp r1.x, r3.x, r2.x
    lrp_pp r1.y, v5.z, c3.z, r3.x
    lrp_pp r2.x, v5.z, c3.z, r1.x
    rcp r1.x, v3.w
    mul r1.xw, r1.x, v3.xyzy
    mad r1.xw, r1, -c3.w, -c3.z
    abs_sat r1.xw, r1
    add_sat r1.xw, r1, -c65.x
    mul r1.xw, r1, c65.y
    max r2.y, r1.x, r1.w
    lrp_pp r1.x, r2.y, c3.z, r2.x
    lrp_pp r3.x, r2.y, c3.z, r1.y
    mul r1.x, r1.x, c77.w
    ...
    add_pp r4.w, -r4.w, c3.z
    texld_pp r6, v0, s2
    mul_pp r6.yz, r6.x, c20
    mul_pp r6.yz, r6, c0.xzww
    mul_pp r7.xyz, r6.z, c43
    max_pp r5.w, r6.y, c3.z
    min r6.y, r5.w, c1.x
    ...
    cmp_pp r3.yzw, r3.y, r4.xxyz, c3.y
    mad_pp r2.yzw, r1.w, r3, r2
    mul_pp r3.yzw, r2.x, c51.xxyz
    cmp_pp r3.yzw, r2.x, r3, c3.y
