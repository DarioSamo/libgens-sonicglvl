...
//
    ...
    nrm_pp r5.xyz, v6
    mad_pp r4.xyz, r3.y, r5, r4
    dp2add_pp r3.y, r3.yzzw, -r3.yzzw, c3.y
    rsq_pp r3.y, r3.y
    rcp_pp r3.y, r3.y
    nrm_pp r5.xyz, v3
    mad_pp r3.yzw, r3.y, r5.xxyz, r4.xxyz
    ...
    dp3_pp r7.w, r3.yzww, -c10
    mul r8.xyz, r7.w, c36
    mul_pp r8.xyz, r1.x, r8
    cmp_pp r8.xyz, r7.w, r8, c3.x
    add_pp r4.xyz, r4, r8
    dp3_pp r7.w, r3.yzww, -r1.yzww
    mul_pp r8.xyz, c58.w, c58
    mul_pp r8.xyz, r7.w, r8
    cmp_pp r8.xyz, r7.w, r8, c3.x
    mad_pp r4.xyz, r0.w, r8, r4
    add_pp r0.xyz, r0, r4
    mul_pp r0.xyz, r0, c16
    frc r4.xy, c26.xwzw
    cmp r8.xy, -r4, c3.x, c3.y
    add r4.xy, -r4, c26.xwzw
    cmp r8.xy, c26.xwzw, r3.x, r8
    add r4.xy, r4, r8
    add r8, r4.y, -c3
    add r9, r4.x, -c3
    cmp r4.xy, -r8_abs.x, v0, c3.x
    cmp r4.xy, -r8_abs.y, v0.zwzw, r4
    cmp r4.xy, -r8_abs.z, v1, r4
    cmp r4.xy, -r8_abs.w, v1.zwzw, r4
    texld_pp r8, r4, s2
    mul_pp r4.xy, r8.x, c20.yzzw
    mul_pp r4.xy, r4, c2
    mul_pp r8.xyz, r4.y, c43
    add_pp r10.xyz, c22, -v2
    dp3_pp r3.x, r10, r10
    rsq_pp r3.x, r3.x
    mad_pp r2.yzw, r10.xxyz, r3.x, -r2
    nrm_pp r11.xyz, r2.yzww
    dp3_sat_pp r2.y, r11, r3.yzww
    max_pp r2.z, r4.x, c3.y
    min r4.x, r2.z, c1.w
    pow r7.w, r2.y, r4.x
    mul_pp r2.yzw, r7.w, r8.xxyz
    mul_pp r2.xyz, r2.yzww, r2.x
    mul_pp r8.xyz, r4.y, c39
    mad_pp r5.xyz, r10, r3.x, -r5
    nrm_pp r11.xyz, r5
    dp3_sat_pp r2.w, r11, r3.yzww
    pow r5.x, r2.w, r4.x
    mul_pp r5.xyz, r5.x, r8
    mad_pp r2.xyz, r4.w, r5, r2
    mul_pp r5.xyz, r4.y, c47
    mad_pp r6.xyz, r10, r3.x, -r6
    nrm_pp r8.xyz, r6
    dp3_sat_pp r2.w, r8, r3.yzww
    pow r6.x, r2.w, r4.x
    mul_pp r5.xyz, r5, r6.x
    mad_pp r2.xyz, r5.w, r5, r2
    mul_pp r5.xyz, r4.y, c51
    mad_pp r6.xyz, r10, r3.x, -r7
    nrm_pp r7.xyz, r6
    dp3_sat_pp r2.w, r7, r3.yzww
    pow r5.w, r2.w, r4.x
    mul_pp r5.xyz, r5.w, r5
    mad_pp r2.xyz, r6.w, r5, r2
    mul_pp r5.xyz, r4.y, c37
    mad_pp r6.xyz, r10, r3.x, -c10
    nrm_pp r7.xyz, r6
    dp3_sat_pp r2.w, r7, r3.yzww
    pow r5.w, r2.w, r4.x
    mul_pp r5.xyz, r5.w, r5
    ...
    mad_pp r1.xyz, r10, r3.x, -r1.yzww
    mul_pp r5.xyz, r3.x, r10
    dp3_sat_pp r1.w, r5, r3.yzww
    rsq_pp r1.w, r1.w
    rcp_pp r1.w, r1.w
    add r1.w, -r1.w, c3.y
    mul r5.xyz, r1.w, c88
    nrm_pp r6.xyz, r1
    dp3_sat_pp r1.x, r6, r3.yzww
    pow r2.w, r1.x, r4.x
    mul_pp r1.xyz, r2.w, r4.yzww
    mad_pp r1.xyz, r0.w, r1, r2
    mul_pp r1.xyz, r1, c18
    mul_pp r1.xyz, r1, v3.w
    cmp r2.xy, -r9_abs.x, v0, c3.x
