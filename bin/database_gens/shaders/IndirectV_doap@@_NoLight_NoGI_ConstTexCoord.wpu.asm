...
//
    ...
    texld_pp r3, v0, s3
    mad r0.zw, r3.xywx, c0.x, c0.y
    mul_pp r0.zw, r0, c150.xyxy
    texld r3, v0, s5
    mul_pp r0.zw, r0, r3.x
    mul_pp r0.zw, r0, v6.w
    mad r0.zw, r0, c0.x, v0.xyxy
    texld_pp r3, r0.zwzw, s1
    texld_pp r4, r0.zwzw, s0
    mul_pp r0.zw, r3.x, c20.xyyz
    mul_pp r0.zw, r0, c1
    max_pp r2.x, r0.z, -c0.y
    min r0.z, r2.x, c2.x
    pow r2.x, r0.y, r0.z
    pow r3.x, r2.w, r0.z
