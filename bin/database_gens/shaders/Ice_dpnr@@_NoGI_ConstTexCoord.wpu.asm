...
//
    ...
    max r6.w, v3.z, c1.x
    add r7.w, r6.w, -v3.w
    cmp r8.z, r7.w, c1.x, r6.w
    mov r8.xyw, v3
    texldp_pp r8, r8, s13
    max r6.w, v4.z, c1.x
    add r7.w, r6.w, -v4.w
    cmp r9.z, r7.w, c1.x, r6.w
    mov r9.xyw, v4
    texldp_pp r9, r9, s7
    min_pp r6.w, r9.x, r8.x
    lrp_pp r7.w, v5.z, c0.z, r6.w
    rcp r6.w, v3.w
    mul r8.xy, r6.w, v3
    ...
    mul r8.xy, r8, c65.y
    max r6.w, r8.x, r8.y
    lrp_pp r8.x, r6.w, c0.z, r7.w
    mul_pp r6.w, r8.x, c77.w
    dp3_pp r7.w, r4, -c10
    mul r8.xyz, r7.w, c36
    mul_pp r8.xyz, r6.w, r8
    cmp_pp r8.xyz, r7.w, r8, c1.x
    add_pp r6.xyz, r6, r8
    ...
    mul_pp r3.zw, r3, c4.xyxy
    max_pp r9.y, r3.z, c0.z
    min r3.z, r9.y, c1.w
    pow r9.y, r3.y, r3.z
    ...
    mad_pp r0.w, r0.w, -c0.w, -c0.y
    dp3_pp r3.x, r2.yzww, r5.yzww
    mul_pp r2, r2, c3.x
    mad_pp r3.y, r3.x, -r3.x, c0.z
    mad_pp r3.y, r3.y, -c4.z, c4.w
    rsq_pp r3.y, r3.y
    rcp_pp r3.y, r3.y
    ...
    rcp r2.z, r2.z
    mad_pp r2.xy, r2.yxzw, r2.z, c0.z
