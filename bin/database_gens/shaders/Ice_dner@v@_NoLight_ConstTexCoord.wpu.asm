...
//
    ...
    mul_pp r6, r5.wyzw, c5.z
    mad r4, r4, r0.w, -r6
    mad r6, r4.wyzw, c2.xxyz, c2.zzzw
    mul r7, r4, c4.zyyw
    cmp_pp r4, r4.z, r6, r7
    add_pp r0.w, r4.z, c4.z
    rcp r0.w, r0.w
    mad_pp r1.xy, r4.yxzw, r0.w, c4.z
    mad_pp r4.x, r1.y, c3.x, r4.w
    mul_pp r4.y, r1.x, c5.w
    texld_pp r4, r4, s6
    mul r1.xyz, r4, c63.x
