...
//
    ...
    dp3_pp r2.w, r5.yzww, r6.yzww
    add_pp r3.x, r2.w, r2.w
    add_sat_pp r2.w, -r2.w, c0.z
    pow_pp r3.z, r2.w, c150.z
    mul r2.w, r3.z, c150.y
    mad_pp r4, r3.x, r6, -r5
    mad_pp r5, r4.wyzw, c4.xxyz, c4.zzzw
    mul_pp r7, r4, c4.yxxz
    cmp_pp r5, r4.z, r5, r7
    add_pp r3.x, r5.z, c0.z
    rcp r3.x, r3.x
    mad_pp r3.xz, r5.yyxw, r3.x, c0.z
    mad_pp r5.x, r3.z, c3.z, r5.w
    mul_pp r5.y, r3.x, c0.w
    texld_pp r5, r5, s4
    ...
    dp3_pp r0.w, r6.wyzw, -c10
    add_pp r0.w, r0.w, c1.w
    mul_sat_pp r0.yw, r0, c2.x
    mul_pp r3.xzw, r0.w, c36.xyyz
    ...
    mad_pp r5.xyz, r6.wyzw, c0.w, c0.w
    mov r6.xyz, c79
    add r6.xyz, -r6, c80
    ...
    mad_pp r5.xyw, r3.x, r5, r7.xyzz
    mov r7.xyz, c81
    add r7.xyz, -r7, c82
    mad r9.xyz, r5.z, r7, c81
    mad_pp r3.xzw, r3.w, r9.xyyz, r5.xyyw
...
// approximately 289 instruction slots used (6 texture, 283 arithmetic)
