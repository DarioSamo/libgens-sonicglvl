...
//
    ...
    add_pp r5.y, -r5.y, c0.z
    add_pp r7.xyz, c22, -v1
    dp3_pp r5.w, r7, r7
    rsq_pp r5.w, r5.w
    mul_pp r8.xyz, r5.w, r7
    mad_pp r6.xyz, r6, -r5.z, r8
    nrm_pp r9.xyz, r6
    nrm_pp r6.xyz, v2
    dp3_sat_pp r5.z, r9, r6
    mov_pp r9.zw, c1
    ...
    mul_pp r9.xzw, r5.y, r9
    mul_pp r10.xyz, r9.y, c39
    mad_pp r4.yzw, r4, -r5.x, r8.xxyz
    nrm_pp r5.xyz, r4.yzww
    dp3_sat_pp r4.y, r5, r6
    pow r5.x, r4.y, r7.w
    mul_pp r4.yzw, r5.x, r10.xxyz
    mad_pp r4.xyz, r4.x, r4.yzww, r9.xzww
    mul_pp r5.xyz, r9.y, c47
    mad_pp r3.xzw, r3, -r2.w, r8.xyyz
    nrm_pp r10.xyz, r3.xzww
    dp3_sat_pp r2.w, r10, r6
    pow r3.x, r2.w, r7.w
    mul_pp r3.xzw, r3.x, r5.xyyz
    mad_pp r3.xzw, r1.w, r3, r4.xyyz
    mul_pp r4.xyz, r9.y, c51
    mad_pp r2.xyz, r2, -r1.z, r8
    nrm_pp r5.xyz, r2
    ...
    mad_pp r3.xzw, r7.xyyz, r5.w, -c10.xyyz
    mad_pp r0.yzw, r7.xxyz, r5.w, -r0
    ...
    mad r3.xzw, r2.y, r1.yyzw, c79.xyyz
    mul_pp r4.xyz, r6, r6
    mul r3.xzw, r3, r4.y
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    ...
    texld_pp r4, v0, s0
    lrp_pp r7, r0.w, r4, c0.z
    mul_pp r2.xyz, r2, r7
    mul_pp r4.w, r7.w, c16.w
    mul r7, r6.y, c91
    mad r7, r6.x, c90, r7
    mad r7, r6.z, c92, r7
    dp4 r2.w, r7, r7
    ...
    mad_pp r2.xzw, r2.x, r6.xyyz, -r8.xyyz
    pow_pp r3.y, r2.y, c150.z
    mul r2.y, r3.y, c150.y
    mad_pp r1.x, r2.y, r1.x, c150.x
    mad_pp r6.xyz, r2.xzww, c0.x, c0.x
    mul_pp r2.xyz, r2.xzww, r2.xzww
    mad r1.yzw, r6.y, r1, c79.xxyz
    mul r1.yzw, r1, r2.y
    mad r5.xyz, r6.x, r5, c77
    mad r3.xyz, r6.z, r3.xzww, c81
    mad_pp r1.yzw, r2.x, r5.xxyz, r1
    mad_pp r1.yzw, r2.z, r3.xxyz, r1
    mul_pp r1.yzw, r0.w, r1
    mad_pp r0.xyz, r1.yzww, r1.x, r0
    texld r1, v0, s2
    add_pp r1.xyz, r1, c151
    mul_pp r1.xyz, r1, c17
    mad_pp r4.xyz, r1, c151.w, r0
    mul_pp r0, r4, v6
