...
//
    ...
    frc r6.xy, c27
    cmp r6.zw, -r6.xyxy, c6.x, c6.y
    add r6.xy, -r6, c27
    cmp r6.zw, c27.xyxy, r1.x, r6
    add r6.xy, r6.zwzw, r6
    add r7, r6.x, -c6
    add r6, r6.y, -c6
    cmp r8.xy, -r7_abs.x, v0, c6.x
    ...
    mul_pp r5, r4.wyzw, c5.x
    mad r2, r2, r0.w, -r5
    mad r5, r2.wyzw, c4.xxyz, c4.zzzw
    mul r6, r2, c5.yzzw
    cmp_pp r2, r2.z, r5, r6
    add_pp r0.w, r2.z, c6.y
    rcp r0.w, r0.w
    mad_pp r2.xy, r2.yxzw, r0.w, c6.y
