...
//
    ...
    lrp_pp r1.x, v5.z, -c0.y, r2.x
    lrp_pp r1.y, v5.z, -c0.y, r3.x
    rcp r1.z, v3.w
    ...
    texld_pp r3, v0, s3
    mad r3.xy, r3.wxzw, c0.x, c0.y
    mul_pp r3.xy, r3, c150
    mad r3.xy, r3, c0.x, v0
    texld_pp r4, r3, s0
    texld_pp r3, r3, s1
    mul_pp r3.xy, r3.x, c20.yzzw
    mul_pp r3.xy, r3, c1.zwzw
