...
//
    ...
    mov r0.xyw, v3
    texldp_pp r0, r0, s13
    lrp_pp r1.y, v4.z, c2.x, r0.x
    lrp_pp r0.x, r1.x, c2.x, r1.y
    ...
    mov_pp r3.x, c2.x
    add r0.w, r3.x, -c61.x
    cmp_pp r0.w, r0.w, c2.x, r2.y
    add r2.y, -c60.z, c60.w
    rcp r2.y, r2.y
    mul_sat r2.x, r2.y, r2.x
    add_pp r2.x, -r2.x, c2.x
    ...
    mul_pp r2.w, r2.w, v5.w
    mul_pp r3.w, r2.w, c21.x
    ...
    mul_pp r1.yzw, r4.y, r1
    mul_pp r4.xyz, r4.x, r5
    mul_pp r4.xyz, r0.w, r4
    mad_pp r1.yzw, r1, r1.x, r4.xxyz
    mul_pp r1.yzw, r1, c18.xxyz
    mul_pp r1.yzw, r1, v2.w
    mad_pp r0.xyz, r0, v5, r1.yzww
