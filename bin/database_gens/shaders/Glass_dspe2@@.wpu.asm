...
//
    ...
    add r8.xyz, r8, r9
    add r9, r8.z, -c3
    cmp r8.zw, -r9_abs.x, v0.xyxy, c3.x
    ...
    mul_pp r8.zw, r8, c2.xyxy
    mul_pp r9.yzw, r8.w, c43.xxyz
    max_pp r2.x, r8.z, c3.y
    min r3.w, r2.x, c1.w
