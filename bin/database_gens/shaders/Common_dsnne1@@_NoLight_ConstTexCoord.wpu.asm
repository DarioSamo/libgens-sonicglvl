...
//
    ...
    max r0.z, v3.z, c1.w
    add r0.w, r0.z, -v3.w
    cmp r4.z, r0.w, c1.w, r0.z
    mov r4.xyw, v3
    texldp_pp r4, r4, s13
    lrp_pp r0.z, v4.z, c0.w, r4.x
    lrp_pp r2.w, r1.w, c0.w, r0.z
    texld_pp r4, v0.zwzw, s10
    mul r0.z, r2.w, r4.w
    mad_pp r1.xyz, r3, r0.z, r1
    mul r3, r2.y, c91
    mad r3, r2.x, c90, r3
    mad r3, r2.z, c92, r3
    dp3_pp r0.w, r2, -c10
