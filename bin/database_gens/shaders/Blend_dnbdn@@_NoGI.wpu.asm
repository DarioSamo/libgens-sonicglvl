...
//
    ...
    mad_pp r0.yzw, r0.w, r2, r3.xxyz
    mul_pp r2.yzw, r0, c17.xxyz
    mul r2.yzw, r2, c70.w
    mad r0.yzw, r0, c17.xxyz, -r2
    mad_pp r0.yzw, r3.w, r0, r2
