...
//
    ...
    max r2.z, v4.z, c2.x
    add r2.w, r2.z, -v4.w
    cmp r3.z, r2.w, c2.x, r2.z
    mov r3.xyw, v4
    texldp_pp r3, r3, s13
    lrp_pp r2.z, v5.z, c2.y, r3.x
...
// approximately 169 instruction slots used (4 texture, 165 arithmetic)
