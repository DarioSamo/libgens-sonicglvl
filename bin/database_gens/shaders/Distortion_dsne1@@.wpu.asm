...
//
    ...
    texld_pp r7, r3.zwzw, s4
    mul r5.xyz, r7, c63.x
    mad_pp r5.xyz, r5, r7.w, r7
    frc r3.zw, c26.xyxz
    cmp r6.zw, -r3, c4.x, c4.y
    add r3.zw, -r3, c26.xyxz
    cmp r6.zw, c26.xyxz, r2.x, r6
    add r3.zw, r3, r6
    add r7, r3.w, -c4
    add r9, r3.z, -c4
    cmp r3.zw, -r7_abs.x, v0.xyxy, c4.x
