...
//
    ...
    max_pp r11.y, r4.z, c2.z
    min r4.z, r11.y, c0.w
    pow r11.y, r4.y, r4.z
    mul_pp r12.yzw, r4.w, c43.xxyz
    mul_pp r11.yzw, r11.y, r12
    ...
    mul_pp r4, r6, r3.y
    mad_pp r4, r3.x, r8, r4
    dp2add_pp r0.w, r3, -r3, c2.z
    rsq_pp r0.w, r0.w
    rcp_pp r0.w, r0.w
    mad r3, r0.w, r9, r4
    dp3_pp r0.w, r2.yzww, r3.yzww
    mad_pp r4.x, r0.w, -r0.w, c2.z
    mad_pp r4.x, r4.x, -c3.z, c3.w
    rsq_pp r4.x, r4.x
    rcp_pp r4.x, r4.x
    mad r0.w, r0.w, c4.x, -r4.x
    mul_pp r4, r2.wyzw, c4.x
    mad r3, r3, r0.w, -r4
    ...
    rcp r0.w, r0.w
    mad_pp r3.xy, r3.yxzw, r0.w, c2.z
    mad_pp r4.x, r3.y, c1.x, r3.w
    mul_pp r4.y, r3.x, c2.w
    texld_pp r3, r4, s6
    mul r4.xyz, r3, c63.x
    mad_pp r3.xyz, r4, r3.w, r3
    mul_pp r3.xyz, r12.x, r3
    mul r0.w, c64.z, c64.x
    mov r4.xz, c64
    mad r3.w, r4.x, -r4.z, r4.z
    mad_pp r0.w, r7.w, r3.w, r0.w
    dp3_pp r3.w, r2.yzww, r5.yzww
    ...
    rcp r2.z, r2.z
    mad_pp r2.xy, r2.yxzw, r2.z, c2.z
    mad_pp r4.x, r2.y, c1.x, r2.w
    mul_pp r4.y, r2.x, c2.w
    texld_pp r2, r4, s5
    mul r4.xyz, r2, c63.x
...
// approximately 287 instruction slots used (8 texture, 279 arithmetic)
