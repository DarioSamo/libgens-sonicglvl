...
//
    ...
    max_pp r7.y, r4.z, c3.z
    min r4.z, r7.y, c0.w
    pow r7.y, r4.y, r4.z
    mul_pp r12.xyz, r4.w, c43
    mul_pp r12.xyz, r7.y, r12
    mul_pp r12.xyz, r4.x, r12
    ...
    mad_pp r3.xyz, r3.x, r3.yzww, r12
    ...
    mul_pp r2, r6, r1.y
    mad_pp r2, r1.x, r8, r2
    dp2add_pp r0.w, r1, -r1, c3.z
    rsq_pp r0.w, r0.w
    rcp_pp r0.w, r0.w
    mad r1, r0.w, r9, r2
    dp3_pp r0.w, r3.yzww, r1.yzww
    mad_pp r2.x, r0.w, -r0.w, c3.z
    mad_pp r2.x, r2.x, -c1.z, c1.w
    rsq_pp r2.x, r2.x
    rcp_pp r2.x, r2.x
    mad r0.w, r0.w, c4.x, -r2.x
    mul_pp r2, r3.wyzw, c4.x
    mad r1, r1, r0.w, -r2
