...
//
    ...
    dp3_sat_pp r0.y, r4.yzxw, r2.yzww
    texld_pp r5, v0, s1
    mov r0.zw, c2
    mul_pp r6, r0.zwzw, c20.yzyz
    mul_pp r5, r5.xxyy, r6
    max_pp r0.zw, r5.xyxz, c1.z
    min r5.xz, r0.zyww, c0.w
    pow r4.w, r0.y, r5.x
    ...
    nrm_pp r9.xyz, r8
    dp3_sat_pp r3.w, r9.yzxw, r2.yzww
    pow r4.w, r3.w, r5.x
    ...
    nrm_pp r11.xyz, r10
    texld r10, v0, s2
    mad_pp r10, r10, c1.x, c1.y
    dp2add_pp r3.w, r10, -r10, c1.z
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    nrm_pp r12.xyz, v1
    nrm_pp r13.xyz, v2
    ...
    dp2add_pp r4.w, r10.zwzw, -r10.zwzw, c1.z
    rsq_pp r4.w, r4.w
    rcp_pp r4.w, r4.w
    mad_pp r10.xyz, r4.w, r2.wyzw, r13
    mad_pp r12.xyz, r3.w, r2.wyzw, r12
    dp3_sat_pp r3.w, r11, r12
    pow r4.w, r3.w, r5.x
    mul_pp r5.xyw, r4.w, r7.xyzz
    add_pp r3.w, c151.x, -v6.y
    add_pp r3.w, r3.w, c0.y
    mul_sat_pp r3.w, r3.w, c0.z
    mad_pp r5.xyw, r6.xyzz, r3.w, r5
    dp3_pp r4.w, r3.yzxw, r2.yzww
    add_pp r4.w, r4.w, r4.w
    mad r2, r4.w, r2, -r3.xyzx
    ...
    mov r6.xz, c64
    mad r3.y, r6.x, -r6.z, r6.z
    mad_pp r2.w, r1.x, r3.y, r2.w
    mul_pp r2.xyz, r2.w, r2
    mad_pp r2.xyz, r2, r3.w, r5.xyww
    mul_pp r2.xyz, r2, v3.w
    texld_pp r6, v0, s6
    texld_pp r7, v0, s0
    lrp_pp r11, r3.w, r7, r6
