...
//
    ...
    dp2add_pp r5.w, r6.zwzw, -r6.zwzw, c4.y
    rsq_pp r5.w, r5.w
    rcp_pp r5.w, r5.w
    nrm_pp r8.xyz, v3
    mad_pp r7.xyz, r5.w, r8, r7
    ...
    nrm_pp r10.xyz, r9
    dp3_sat_pp r6.z, r10, r7
    mov_pp r9.xy, c2
    mul_pp r9.xy, r9, c20.yzzw
    max_pp r6.w, r9.x, c4.y
    min r7.w, r6.w, c1.w
    pow r8.w, r6.z, r7.w
    ...
    mad_pp r5.xyz, r1.w, r5, r9.xzww
    mad_pp r9.xzw, r8.xyyz, r5.w, -r3
    ...
    nrm_pp r4.xyz, r9.xzww
    dp3_sat_pp r1.w, r4, r7
    pow r4.x, r1.w, r7.w
    mul_pp r4.yzw, r9.y, c47.xxyz
    mul_pp r4.xyz, r4.x, r4.yzww
    mad_pp r4.xyz, r1.z, r4, r5
    mad_pp r5.xyz, r8, r5.w, -r2.yzww
    ...
    pow r3.x, r1.z, r7.w
    mul_pp r5.xyz, r9.y, c51
    mul_pp r3.xzw, r3.x, r5.xyyz
    mad_pp r1.yzw, r1.y, r3.xxzw, r4.xxyz
    mul_pp r3.xzw, r9.y, c37.xyyz
    mad_pp r4.xyz, r8, r5.w, -c10
    nrm_pp r5.xyz, r4
    ...
    mul_pp r3.xzw, r9.y, r3
    mad_pp r4.xyz, r8, r5.w, -r0.yzww
    dp3_pp r0.y, r7, -r0.yzww
    add_pp r0.y, r0.y, c0.w
    mul_pp r5.xyz, r5.w, r8
    nrm_pp r8.xyz, r4
    ...
    mul r3.xzw, r8.xyyz, c63.x
    mad_pp r3.xzw, r3, r8.w, r8.xyyz
    ...
    mad_pp r2.yzw, r3.xxzw, r1.x, r2
    mad r0.z, r1.x, c0.z, c0.z
    mul r3.xzw, c58.w, c58.xyyz
    mul_pp r3.xzw, r0.y, r3
    mad_pp r0.xyw, r0.x, r3.xzzw, r2.yzzw
    mul_pp r2.yzw, r7.xxyz, r7.xxyz
    mad_pp r3.xzw, r7.xyyz, c0.z, c0.z
    mov r4.xyz, c79
    add r4.xyz, -r4, c80
    mad r8.xyz, r3.z, r4, c79
    mul r8.xyz, r2.z, r8
    mov r9.xyz, c77
    add r9.xyz, -r9, c78
    mad r10.xyz, r3.x, r9, c77
    mad_pp r8.xyz, r2.y, r10, r8
    mov r10.xyz, c81
    add r10.xyz, -r10, c82
    mad r3.xzw, r3.w, r10.xyyz, c81.xyyz
    mad_pp r2.yzw, r2.w, r3.xxzw, r8.xxyz
    ...
    mad_pp r2.yzw, r2.z, r7.xxyz, -r5.xxyz
    mad_pp r3.xyz, r2.yzww, c0.z, c0.z
    mul_pp r2.yzw, r2, r2
    mad r5.xyz, r3.x, r9, c77
    mad r3.xyw, r3.y, r4.xyzz, c79.xyzz
    mad r4.xyz, r3.z, r10, c81
    mul r3.xyz, r2.z, r3.xyww
    mad_pp r3.xyz, r2.y, r5, r3
    mad_pp r2.yzw, r2.w, r4.xxyz, r3.xxyz
    frc r3.x, c27.x
    cmp r3.y, -r3.x, c4.x, c4.y
    add r3.x, -r3.x, c27.x
    cmp r2.x, c27.x, r2.x, r3.y
    add r2.x, r2.x, r3.x
    add r3, r2.x, -c4
...
// approximately 312 instruction slots used (7 texture, 305 arithmetic)
