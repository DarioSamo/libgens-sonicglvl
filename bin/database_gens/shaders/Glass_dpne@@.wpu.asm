...
//
    ...
    dp2add_pp r3.w, r5, -r5, c5.y
    rsq_pp r3.w, r3.w
    rcp_pp r3.w, r3.w
    nrm_pp r5, v3.xyzx
    mad r5, r3.w, r5, r6
    add_pp r6, c22.xyzx, -v2.xyzx
    dp3_pp r3.w, r6.yzww, r6.yzww
    rsq_pp r3.w, r3.w
    mad_pp r7.xyz, r6, r3.w, -r4
    dp3_pp r4.x, r5.wyzw, -r4
    nrm_pp r8.xyz, r7
    dp3_sat_pp r4.y, r8, r5
    mov_pp r7.xy, c2
    mul_pp r4.zw, r7.xyxy, c20.xyyz
    max_pp r7.x, r4.z, c5.y
    min r4.z, r7.x, c0.w
    pow r7.x, r4.y, r4.z
    mul_pp r7.yzw, r4.w, c43.xxyz
    mul_pp r7.xyz, r7.x, r7.yzww
    mul_pp r7.xyz, r2.w, r7
    mad_pp r8.xyz, r6, r3.w, -r3
    ...
    max r3.y, v4.z, c5.x
    add r3.z, r3.y, -v4.w
    cmp r8.z, r3.z, c5.x, r3.y
    mov r8.xyw, v4
    texldp_pp r8, r8, s13
    lrp_pp r3.y, v5.z, c5.y, r8.x
    lrp_pp r7.w, r4.y, c5.y, r3.y
    ...
    mad r6, r0.w, r5, -r6
    dp3_pp r0.w, r5.wyzw, -c10
    mad r5, r6.wyzw, c3.xxyz, c3.zzzw
    mul r9, r6, c3.yxxz
    cmp r5, r6.z, r5, r9
    add r3.z, r5.z, c5.y
    rcp r3.z, r3.z
    mad r3.zw, r5.xyyx, r3.z, c5.y
    ...
    cmp_pp r5.xyz, r4.x, r5, c5.x
    mul_pp r2.xyw, r2.w, r5.xyzz
    mul_pp r5.xyz, r3.x, c39
    cmp_pp r3.xzw, r3.x, r5.xyyz, c5.x
...
// approximately 282 instruction slots used (6 texture, 276 arithmetic)
