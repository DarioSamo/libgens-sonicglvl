...
//
    ...
    dp3_pp r5.w, r8.xzww, r8.xzww
    rsq_pp r5.w, r5.w
    mad_pp r10.xyz, r8.xzww, r5.w, -r6
    nrm_pp r11.xyz, r10
    nrm_pp r10.xyz, v3
    dp3_sat_pp r9.w, r11, r10
    pow r10.w, r9.w, r6.w
    mul_pp r9.xyz, r9, r10.w
    mul_pp r9.xyz, r4.w, r9
    mul_pp r11.xyz, r8.y, c39
    mad_pp r12.xyz, r8.xzww, r5.w, -r5
    dp3_pp r5.x, r10, -r5
    nrm_pp r13.xyz, r12
    ...
    mad_pp r12.xyz, r8.xzww, r5.w, -r4
    dp3_pp r4.x, r10, -r4
    nrm_pp r13.xyz, r12
    ...
    mad_pp r12.xyz, r8.xzww, r5.w, -r2.yzww
    ...
    mad_pp r12.xyz, r8.xzww, r5.w, -c10
    mad_pp r5.yzw, r8.xxzw, r5.w, -r0
    ...
    cmp_pp r2.yzw, r2.y, r6.xxyz, c3.x
    mad_pp r2.yzw, r1.z, r2, r4.xxyz
    mul r4.xyz, r0.w, c36
    ...
    mul_pp r2.yzw, r1, c70.xxyz
    mul r2.yzw, r2, c70.w
    mad r1.yzw, r1, c70.xxyz, -r2
    ...
    mad_pp r0.xyz, r0, r2.yzww, r5.yzww
    frc r1.x, c27.y
