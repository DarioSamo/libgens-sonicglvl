...
//
    ...
    cmp_pp r2.xyz, r2.x, r2.yzww, c2.y
    ...
    max r1.w, v3.z, c2.y
    add r2.x, r1.w, -v3.w
    cmp r2.z, r2.x, c2.y, r1.w
    mov r2.xyw, v3
    texldp_pp r2, r2, s13
    max r1.w, v4.z, c2.y
    add r2.y, r1.w, -v4.w
    cmp r4.z, r2.y, c2.y, r1.w
    mov r4.xyw, v4
    texldp_pp r4, r4, s7
    min_pp r1.w, r4.x, r2.x
    lrp_pp r2.x, v5.z, c2.z, r4.x
    lrp_pp r2.y, v5.z, c2.z, r1.w
    rcp r1.w, v3.w
    mul r2.zw, r1.w, v3.xyxy
    mad r2.zw, r2, -c2.w, -c2.z
    abs_sat r2.zw, r2
    add_sat r2.zw, r2, -c65.x
    mul r2.zw, r2, c65.y
    max r1.w, r2.z, r2.w
    lrp_pp r4.x, r1.w, c2.z, r2.y
    lrp_pp r4.y, r1.w, c2.z, r2.x
    mul r1.w, r4.x, c77.w
    ...
    cmp_pp r0.yzw, r0.y, r2.xxyz, c2.y
    mad_pp r0.xyz, r0.x, r0.yzww, r1
    mov r1.xyz, c79
    add r1.xyz, -r1, c80
    mad_pp r2.xyz, r3.wyzw, c2.x, c2.x
    ...
    add r0.w, r0.w, r0.w
    mad r2, r0.w, r3, -r2
    mad r3, r2.wyzw, c1.xxyz, c1.zzzw
    mul r4, r2, c1.yxxz
    cmp r2, r2.z, r3, r4
    add r0.w, r2.z, c2.z
    rcp r0.w, r0.w
    mad r1.xy, r2.yxzw, r0.w, c2.z
    mad_pp r2.x, r1.y, c0.z, r2.w
...
// approximately 178 instruction slots used (4 texture, 174 arithmetic)
