...
//
    ...
    max r1.y, v5.z, c5.x
    add r1.z, r1.y, -v5.w
    cmp r3.z, r1.z, c5.x, r1.y
    mov r3.xyw, v5
    texldp_pp r3, r3, s7
    min_pp r2.y, r3.x, r1.x
    lrp_pp r1.x, v6.z, c5.y, r3.x
    lrp_pp r1.y, v6.z, c5.y, r2.y
    rcp r1.z, v4.w
    ...
    mul r1.zw, r1, c65.y
    max r2.y, r1.z, r1.w
    lrp_pp r3.x, r2.y, c5.y, r1.y
    lrp_pp r3.y, r2.y, c5.y, r1.x
    ...
    texld_pp r8, r8, s2
    add r9, r7.w, -c5
    cmp r7.zw, -r9_abs.x, v0.xyxy, c5.x
    ...
    mul_pp r7.zw, r7, c4.xyxy
    mul_pp r8.xyz, r7.w, c43
    max_pp r5.w, r7.z, c5.y
    min r6.w, r5.w, c1.w
    ...
    add r0.z, r8.z, c5.y
    rcp r0.z, r0.z
    mad r0.zw, r8.xyyx, r0.z, c5.y
    mad_pp r8.x, r0.w, c4.w, r8.w
    mul_pp r8.y, r0.z, c4.z
    texld_pp r8, r8, s5
    mul r9.xyz, r8, c63.x
