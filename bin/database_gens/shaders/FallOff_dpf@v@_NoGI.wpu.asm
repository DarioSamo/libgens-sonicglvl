...
//
    ...
    add_pp r2.yzw, -r2, c0.y
    nrm_pp r6.xyz, v3
    dp3_pp r3.w, r6, -r5
    mul_pp r7.xyz, r3.w, c43
    cmp_pp r7.xyz, r3.w, r7, c0.x
    mul_pp r7.xyz, r2.w, r7
    dp3_pp r3.w, r6, -r4
    mul_pp r8.xyz, r3.w, c39
    cmp_pp r8.xyz, r3.w, r8, c0.x
    ...
    max r3.w, v4.z, c0.x
    add r4.w, r3.w, -v4.w
    cmp r8.z, r4.w, c0.x, r3.w
    mov r8.xyw, v4
    texldp_pp r8, r8, s13
    max r3.w, v5.z, c0.x
    add r4.w, r3.w, -v5.w
    cmp r9.z, r4.w, c0.x, r3.w
    mov r9.xyw, v5
    texldp_pp r9, r9, s7
    min_pp r3.w, r9.x, r8.x
    lrp_pp r4.w, v6.z, c0.y, r9.x
    lrp_pp r5.w, v6.z, c0.y, r3.w
    rcp r3.w, v4.w
    mul r8.xy, r3.w, v4
    mad r8.xy, r8, c3.y, c3.z
    abs_sat r8.xy, r8
    add_sat r8.xy, r8, -c65.x
    mul r8.xy, r8, c65.y
    max r3.w, r8.x, r8.y
    lrp_pp r6.w, r3.w, c0.y, r5.w
    lrp_pp r5.w, r3.w, c0.y, r4.w
    mul r3.w, r6.w, c77.w
    dp3_pp r4.w, r6, -c10
    mul r8.xyz, r4.w, c36
    mul_pp r8.xyz, r3.w, r8
    cmp_pp r8.xyz, r4.w, r8, c0.x
    add_pp r7.xyz, r7, r8
    ...
    mad_pp r3.xyz, r8.xzww, r2.x, -c10
    mad_pp r0.yzw, r8.xxzw, r2.x, -r0
    ...
    mad_pp r0.xyz, r7, v7, r0
    mul r0.w, c64.w, c64.y
    mov r1.yw, c64
    mad r1.x, r1.y, -r1.w, r1.w
    mad_pp r0.w, r3.w, r1.x, r0.w
    mul_pp r1.xy, r6.y, c91
    mad_pp r1.xy, r6.x, c90, r1
    mad_pp r1.xy, r6.z, c92, r1
