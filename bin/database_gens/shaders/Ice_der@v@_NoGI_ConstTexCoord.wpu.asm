...
//
    ...
    ps_3_0
    def c0, -2, 3, 500, 5
    def c1, 1024, 0.583607316, 1, 0.763941944
    def c2, 0.25, 4, 0, 0
    def c3, 0.5, 0, 1, -2
    def c4, -1, 1, 0, 0.5
    dcl_texcoord v0.xy
    ...
    mad_pp r1.y, r1.x, -r1.x, c3.z
    mad_pp r1.y, r1.y, -c1.y, c1.z
    rsq_pp r1.y, r1.y
    rcp_pp r1.y, r1.y
    ...
    add_pp r1.z, r1.z, c3.z
    rcp r1.z, r1.z
    mad_pp r1.xy, r1.yxzw, r1.z, c3.z
    mad_pp r3.x, r1.y, c2.x, r1.w
    mul_pp r3.y, r1.x, c3.x
    texld_pp r1, r3, s6
    mul r3.xyz, r1, c63.x
    mad_pp r1.xyz, r3, r1.w, r1
    mad r3, r2.wyzw, c4.xxyz, c4.zzzw
    mul r4, r2, c4.yxxz
    cmp_pp r2, r2.z, r3, r4
    add_pp r1.w, r2.z, c3.z
    rcp r1.w, r1.w
    mad_pp r2.xy, r2.yxzw, r1.w, c3.z
    mad_pp r3.x, r2.y, c2.x, r2.w
    mul_pp r3.y, r2.x, c3.x
    texld_pp r2, r3, s5
    mul r3.xyz, r2, c63.x
