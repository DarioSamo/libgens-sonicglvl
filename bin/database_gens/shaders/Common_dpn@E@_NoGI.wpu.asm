...
//
    ...
    max_pp r3.y, r9.x, c2.y
    min r4.w, r3.y, c1.z
    pow r5.w, r3.x, r4.w
    mul_pp r3.xyz, r5.w, r10
    ...
    mad_pp r0.xyz, r5, r4, r0
    mad_pp r2.xyz, r0, v9, r3
    mul_pp r0, r2, c89
    min_pp r1, r0, c1.w
...
// approximately 278 instruction slots used (5 texture, 273 arithmetic)
