...
//
    ...
    lrp_pp r0.x, v5.z, c4.x, r1.x
    lrp_pp r0.y, v5.z, c4.x, r2.x
    rcp r0.z, v3.w
    mul r0.zw, r0.z, v3.xyxy
    mad r0.zw, r0, c4.y, c4.z
    abs_sat r0.zw, r0
    add_sat r0.zw, r0, -c65.x
    mul r0.zw, r0, c65.y
    max r1.x, r0.z, r0.w
    lrp_pp r2.x, r1.x, c4.x, r0.y
    lrp_pp r2.y, r1.x, c4.x, r0.x
    ...
    mad_pp r2.z, r1.x, -c4.y, -c4.w
    mul_pp r1.x, r1.x, r1.x
    mul_pp r1.x, r1.x, r2.z
    pow_sat_pp r2.z, r1.x, c61.w
    mov r1.x, c4.x
    add r2.w, r1.x, -c61.x
    cmp_pp r2.z, r2.w, c4.x, r2.z
    ...
    max_pp r4.x, r3.x, c4.x
    mul_pp r3.xyz, r3.y, c37
    min r3.w, r4.x, c1.z
    add_pp r4, c22.xyzx, -v1.xyzx
    dp3_pp r5.y, r4.yzww, r4.yzww
    rsq_pp r5.y, r5.y
    mad_pp r6.xyz, r4, r5.y, -r1.yzww
    nrm_pp r7.xyz, r6
    nrm r6, v2.xyzx
    dp3_sat_pp r5.z, r7, r6
    pow r7.x, r5.z, r3.w
    mul_pp r2.xzw, r2, r7.x
    mul_pp r2.xzw, r1.x, r2
    mad_pp r7.xyz, r4, r5.y, -c10
    mul r4, r4, r5.y
    nrm_pp r8.xyz, r7
    ...
    add r3.z, r3.z, c4.x
    rcp r3.z, r3.z
    mad r3.xy, r3.yxzw, r3.z, c4.x
    mad_pp r4.x, r3.y, c3.x, r3.w
    mul_pp r4.y, r3.x, c1.w
    texld_pp r3, r4, s5
    mul r4.xyz, r3, c63.x
    ...
    dp3_pp r2.y, r6.wyzw, -c10
    dp3_pp r1.y, r6.wyzw, -r1.yzww
    mul r3.xyz, r2.y, c36
