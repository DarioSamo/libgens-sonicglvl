...
//
    ...
    max r1.w, v4.z, c0.y
    add r2.y, r1.w, -v4.w
    cmp r4.z, r2.y, c0.y, r1.w
    mov r4.xyw, v4
    texldp_pp r4, r4, s7
    min_pp r1.w, r4.x, r2.x
    lrp_pp r2.x, v5.z, c0.z, r4.x
    ...
    mul r2.zw, r2, c65.y
    max r1.w, r2.z, r2.w
    lrp_pp r3.w, r1.w, c0.z, r2.y
    lrp_pp r4.x, r1.w, c0.z, r2.x
    mul r1.w, r3.w, c77.w
    dp3_pp r2.x, r3, -c10
    ...
    mul_pp r4.yzw, r3.xxyz, r3.xxyz
    mul r1.xyz, r1, r4.z
    mov r5.xyz, c77
    add r5.xyz, -r5, c78
    mad r2.xyw, r2.x, r5.xyzz, c77.xyzz
    mad_pp r1.xyz, r4.y, r2.xyww, r1
    mov r5.xyz, c81
