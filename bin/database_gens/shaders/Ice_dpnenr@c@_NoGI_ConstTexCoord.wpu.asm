...
//
    ...
    mul_pp r9.xyz, r5.w, c43
    cmp_pp r9.xyz, r5.w, r9, c1.x
    mul_pp r9.xyz, r4.x, r9
    dp3_pp r5.w, r5, -r3.yzww
    mul_pp r10.xyz, r5.w, c39
    cmp_pp r10.xyz, r5.w, r10, c1.x
    ...
    cmp_pp r10.xyz, r5.w, r10, c1.x
    mad_pp r9.xyz, r1.x, r10, r9
    max r5.w, v3.z, c1.x
    add r6.w, r5.w, -v3.w
    cmp r10.z, r6.w, c1.x, r5.w
    mov r10.xyw, v3
    texldp_pp r10, r10, s13
    max r5.w, v4.z, c1.x
    add r6.w, r5.w, -v4.w
    cmp r11.z, r6.w, c1.x, r5.w
    mov r11.xyw, v4
    texldp_pp r11, r11, s7
    min_pp r5.w, r11.x, r10.x
    lrp_pp r6.w, v5.z, c0.z, r5.w
    rcp r5.w, v3.w
    mul r10.xy, r5.w, v3
    ...
    lrp_pp r7.w, r5.w, c0.z, r6.w
    mul r5.w, r7.w, c77.w
    dp3_pp r6.w, r5, -c10
    mul r10.xyz, r6.w, c36
    mul_pp r10.xyz, r5.w, r10
    cmp_pp r10.xyz, r6.w, r10, c1.x
    add_pp r9.xyz, r9, r10
    mul_pp r10.xyz, c58.w, c58
    dp3_pp r6.w, r5, -r0.yzww
    mul_pp r10.xyz, r6.w, r10
    cmp_pp r10.xyz, r6.w, r10, c1.x
    mad_pp r9.xyz, r0.x, r10, r9
    mov r10.xyz, c79
    add r10.xyz, -r10, c80
    mad_pp r11.xyz, r5, c0.w, c0.w
    mad r10.xyz, r11.y, r10, c79
    mul_pp r12.xyz, r5, r5
