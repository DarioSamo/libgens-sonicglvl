...
//
    ...
    cmp_pp r7.xyz, r4.w, r7, c4.x
    mul_pp r7.xyz, r3.w, r7
    dp3_pp r4.w, r6, -r4
    mul_pp r8.xyz, r4.w, c39
    cmp_pp r8.xyz, r4.w, r8, c4.x
    ...
    max r4.w, v4.z, c4.x
    add r5.w, r4.w, -v4.w
    cmp r8.z, r5.w, c4.x, r4.w
    mov r8.xyw, v4
    texldp_pp r8, r8, s13
    max r4.w, v5.z, c4.x
    add r5.w, r4.w, -v5.w
    cmp r9.z, r5.w, c4.x, r4.w
    mov r9.xyw, v5
    texldp_pp r9, r9, s7
    min_pp r4.w, r9.x, r8.x
    lrp_pp r5.w, v6.z, c4.y, r9.x
    lrp_pp r6.w, v6.z, c4.y, r4.w
    rcp r4.w, v4.w
    mul r8.xy, r4.w, v4
    ...
    mul r8.xy, r8, c65.y
    max r4.w, r8.x, r8.y
    lrp_pp r7.w, r4.w, c4.y, r6.w
    lrp_pp r6.w, r4.w, c4.y, r5.w
    mul r4.w, r7.w, c77.w
    dp3_pp r5.w, r6, -c10
    mul r8.xyz, r5.w, c36
    ...
    mul r10, r6.y, c91
    mad r10, r6.x, c90, r10
    mad r10, r6.z, c92, r10
    mad r5.w, r10.z, -r10.z, c4.y
    mad r2.x, r2.x, -r5.w, c4.y
    cmp r5.w, r2.x, c4.y, c4.x
    mul r2.x, r2.x, r5.w
    ...
    pow r4.x, r3.w, r5.y
    mul_pp r11.xyz, r5.z, c39
    mul_pp r4.xyz, r4.x, r11
    mad_pp r4.xyz, r2.w, r4, r9
    mad_pp r3.xyz, r8, r2.x, -r3
    nrm_pp r9.xyz, r3
    dp3_sat_pp r2.w, r9, r6
    pow r3.x, r2.w, r5.y
    mul_pp r3.yzw, r5.z, c47.xxyz
