...
//
    ...
    add r2.w, -r2.w, c27.z
    cmp r4.w, c27.z, r9.x, r4.w
    add r2.w, r2.w, r4.w
    add r6, r2.w, -c3
    cmp r9.yz, -r6_abs.x, v0.xxyw, c3.x
    cmp r6.xy, -r6_abs.y, v0.zwzw, r9.yzzw
    cmp r6.xy, -r6_abs.z, v1, r6
    cmp r6.xy, -r6_abs.w, v1.zwzw, r6
    texld_pp r6, r6, s6
    frc r10, c26
    cmp r11, -r10, c3.x, c3.y
    add r10, -r10, c26
    cmp r9, c26, r9.x, r11
    add r9, r9, r10
    add r10, r9.z, -c3
    cmp r6.yz, -r10_abs.x, v0.xxyw, c3.x
    cmp r6.yz, -r10_abs.y, v0.xzww, r6
    cmp r6.yz, -r10_abs.z, v1.xxyw, r6
    cmp r6.yz, -r10_abs.w, v1.xzww, r6
    texld_pp r10, r6.yzzw, s2
    add r11, r9.w, -c3
    cmp r6.yz, -r11_abs.x, v0.xxyw, c3.x
    cmp r6.yz, -r11_abs.y, v0.xzww, r6
    cmp r6.yz, -r11_abs.z, v1.xxyw, r6
    cmp r6.yz, -r11_abs.w, v1.xzww, r6
    texld_pp r11, r6.yzzw, s3
    lrp_pp r2.w, r6.x, r11.x, r10.x
    mul_pp r6.yz, r2.w, c20
    mul_pp r6.yz, r6, c2.xxyw
    mul_pp r10.xyz, r6.z, c43
    max_pp r2.w, r6.y, c3.y
    min r4.w, r2.w, c0.w
