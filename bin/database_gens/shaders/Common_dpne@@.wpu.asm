...
//
    ...
    mad_pp r2.xw, r8.xyzy, c2.y, c2.z
    nrm_pp r8, v7.xyzx
    mul_pp r8, r2.w, r8
    nrm_pp r9, v6.xyzx
    mad_pp r8, r2.x, r9, r8
    ...
    mad r8, r9.wyzw, c4.xxyz, c4.zzzw
    mul r10, r9, c4.yxxz
    cmp r8, r9.z, r8, r10
    add r0.w, r8.z, c3.y
    rcp r0.w, r0.w
    mad r3.zw, r8.xyyx, r0.w, c3.y
    mad_pp r8.x, r3.w, c1.z, r8.w
    mul_pp r8.y, r3.z, c2.x
    texld_pp r8, r8, s5
    mul r9.xyz, r8, c63.x
...
// approximately 276 instruction slots used (6 texture, 270 arithmetic)
